...
static void player_stats_generate_random_items (thing_stats *player_stats) 
{
...
void player_stats_generate_random (thing_stats *player_stats) 
{
...
void player_stats_init (thing_stats *player_stats) 
{
