...
uint16_t THING_SLIME1;
uint16_t THING_SLIME2;
uint16_t THING_SLIME3;
uint16_t THING_DEMON1;
uint16_t THING_BABY_CTHULU;
uint16_t THING_EYEBAWL;
...
uint16_t THING_ACTION_LEFT;
uint16_t THING_ACTION_RIGHT;
uint16_t THING_ACTION_UP;
uint16_t THING_ACTION_DOWN;
uint16_t THING_ACTION_TRIGGER_HERO;
uint16_t THING_ACTION_TRIGGER_WALL;
uint16_t THING_ACTION_TRIGGER_MONST;
uint16_t THING_ACTION_SLEEP;
...
uint16_t THING_FIREBALL1;
uint16_t THING_FIREBALL2;
uint16_t THING_PLASMABALL1;
