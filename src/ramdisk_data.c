...
extern unsigned char *data_things__bonepile3_session_start_ asm("data_things__bonepile3_session_start_");
extern unsigned char *data_things__bonepile3_session_end_ asm("data_things__bonepile3_session_end_");
static const unsigned char *const data_things__bonepile3_session_start =
    (const unsigned char *const) (char*)&data_things__bonepile3_session_start_;
static const unsigned char *const data_things__bonepile3_session_end   =
    (const unsigned char *const) (char*)&data_things__bonepile3_session_end_;
...
{
    /* filename */ "data/things/.bonepile3.session",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[13].data = data_gfx_poison_png_start;
    ramdisk_data[13].len = data_gfx_poison_png_end - data_gfx_poison_png_start;
    ramdisk_data[14].data = data_gfx_rat_png_start;
    ramdisk_data[14].len = data_gfx_rat_png_end - data_gfx_rat_png_start;
    ramdisk_data[15].data = data_gfx_sprites_small_png_start;
    ramdisk_data[15].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[16].data = data_gfx_title_png_start;
    ramdisk_data[16].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[17].data = data_gfx_title2_png_start;
    ramdisk_data[17].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[18].data = data_gfx_title3_png_start;
    ramdisk_data[18].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ramdisk_data[19].data = data_gfx_title_small_png_start;
    ramdisk_data[19].len = data_gfx_title_small_png_end - data_gfx_title_small_png_start;
    ramdisk_data[20].data = data_levels_1_start;
    ramdisk_data[20].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[21].data = data_levels_2_start;
    ramdisk_data[21].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[22].data = data_levels_3_start;
    ramdisk_data[22].len = data_levels_3_end - data_levels_3_start;
    ramdisk_data[23].data = data_levels_4_start;
    ramdisk_data[23].len = data_levels_4_end - data_levels_4_start;
    ramdisk_data[24].data = data_levels_5_start;
    ramdisk_data[24].len = data_levels_5_end - data_levels_5_start;
    ramdisk_data[25].data = data_levels_ben_start;
    ramdisk_data[25].len = data_levels_ben_end - data_levels_ben_start;
    ramdisk_data[26].data = data_levels_q_start;
    ramdisk_data[26].len = data_levels_q_end - data_levels_q_start;
    ramdisk_data[27].data = data_map_jigsaw_map_start;
    ramdisk_data[27].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[28].data = data_music_hiscore_wav_start;
    ramdisk_data[28].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[29].data = data_music_intro_wav_start;
    ramdisk_data[29].len = data_music_intro_wav_end - data_music_intro_wav_start;
    ramdisk_data[30].data = data_music_music_wav_start;
    ramdisk_data[30].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[31].data = data_sound_chomp_wav_start;
    ramdisk_data[31].len = data_sound_chomp_wav_end - data_sound_chomp_wav_start;
    ramdisk_data[32].data = data_sound_chomp2_wav_start;
    ramdisk_data[32].len = data_sound_chomp2_wav_end - data_sound_chomp2_wav_start;
    ramdisk_data[33].data = data_sound_click_wav_start;
    ramdisk_data[33].len = data_sound_click_wav_end - data_sound_click_wav_start;
    ramdisk_data[34].data = data_sound_doorbell_wav_start;
    ramdisk_data[34].len = data_sound_doorbell_wav_end - data_sound_doorbell_wav_start;
    ramdisk_data[35].data = data_sound_explosion_wav_start;
    ramdisk_data[35].len = data_sound_explosion_wav_end - data_sound_explosion_wav_start;
    ramdisk_data[36].data = data_sound_letter_wav_start;
    ramdisk_data[36].len = data_sound_letter_wav_end - data_sound_letter_wav_start;
    ramdisk_data[37].data = data_sound_level_end_wav_start;
    ramdisk_data[37].len = data_sound_level_end_wav_end - data_sound_level_end_wav_start;
    ramdisk_data[38].data = data_sound_paper_wav_start;
    ramdisk_data[38].len = data_sound_paper_wav_end - data_sound_paper_wav_start;
    ramdisk_data[39].data = data_sound_powerup_wav_start;
    ramdisk_data[39].len = data_sound_powerup_wav_end - data_sound_powerup_wav_start;
    ramdisk_data[40].data = data_sound_ratdeath_wav_start;
    ramdisk_data[40].len = data_sound_ratdeath_wav_end - data_sound_ratdeath_wav_start;
    ramdisk_data[41].data = data_sound_rocket_wav_start;
    ramdisk_data[41].len = data_sound_rocket_wav_end - data_sound_rocket_wav_start;
    ramdisk_data[42].data = data_sound_slime_wav_start;
    ramdisk_data[42].len = data_sound_slime_wav_end - data_sound_slime_wav_start;
    ramdisk_data[43].data = data_sound_spam_wav_start;
    ramdisk_data[43].len = data_sound_spam_wav_end - data_sound_spam_wav_start;
    ramdisk_data[44].data = data_sound_thief_wav_start;
    ramdisk_data[44].len = data_sound_thief_wav_end - data_sound_thief_wav_start;
    ramdisk_data[45].data = data_things__apple_session_start;
    ramdisk_data[45].len = data_things__apple_session_end - data_things__apple_session_start;
    ramdisk_data[46].data = data_things__arrow_session_start;
    ramdisk_data[46].len = data_things__arrow_session_end - data_things__arrow_session_start;
    ramdisk_data[47].data = data_things__axe1_session_start;
    ramdisk_data[47].len = data_things__axe1_session_end - data_things__axe1_session_start;
    ramdisk_data[48].data = data_things__axe2_session_start;
    ramdisk_data[48].len = data_things__axe2_session_end - data_things__axe2_session_start;
    ramdisk_data[49].data = data_things__banana_session_start;
    ramdisk_data[49].len = data_things__banana_session_end - data_things__banana_session_start;
    ramdisk_data[50].data = data_things__bonepile2_session_start;
    ramdisk_data[50].len = data_things__bonepile2_session_end - data_things__bonepile2_session_start;
    ramdisk_data[51].data = data_things__bonepile3_session_start;
    ramdisk_data[51].len = data_things__bonepile3_session_end - data_things__bonepile3_session_start;
    ramdisk_data[52].data = data_things__bow_session_start;
    ramdisk_data[52].len = data_things__bow_session_end - data_things__bow_session_start;
    ramdisk_data[53].data = data_things__bow1_session_start;
    ramdisk_data[53].len = data_things__bow1_session_end - data_things__bow1_session_start;
    ramdisk_data[54].data = data_things__bow1_anim_session_start;
    ramdisk_data[54].len = data_things__bow1_anim_session_end - data_things__bow1_anim_session_start;
    ramdisk_data[55].data = data_things__bread_session_start;
    ramdisk_data[55].len = data_things__bread_session_end - data_things__bread_session_start;
    ramdisk_data[56].data = data_things__cheese_session_start;
    ramdisk_data[56].len = data_things__cheese_session_end - data_things__cheese_session_start;
    ramdisk_data[57].data = data_things__cloudkill1_session_start;
    ramdisk_data[57].len = data_things__cloudkill1_session_end - data_things__cloudkill1_session_start;
    ramdisk_data[58].data = data_things__cloudkill3_session_start;
    ramdisk_data[58].len = data_things__cloudkill3_session_end - data_things__cloudkill3_session_start;
    ramdisk_data[59].data = data_things__cloudkill8_session_start;
    ramdisk_data[59].len = data_things__cloudkill8_session_end - data_things__cloudkill8_session_start;
    ramdisk_data[60].data = data_things__door_session_start;
    ramdisk_data[60].len = data_things__door_session_end - data_things__door_session_start;
    ramdisk_data[61].data = data_things__door1_session_start;
    ramdisk_data[61].len = data_things__door1_session_end - data_things__door1_session_start;
    ramdisk_data[62].data = data_things__door2_session_start;
    ramdisk_data[62].len = data_things__door2_session_end - data_things__door2_session_start;
    ramdisk_data[63].data = data_things__dwarf_session_start;
    ramdisk_data[63].len = data_things__dwarf_session_end - data_things__dwarf_session_start;
    ramdisk_data[64].data = data_things__elf_session_start;
    ramdisk_data[64].len = data_things__elf_session_end - data_things__elf_session_start;
    ramdisk_data[65].data = data_things__exit7_session_start;
    ramdisk_data[65].len = data_things__exit7_session_end - data_things__exit7_session_start;
    ramdisk_data[66].data = data_things__explosion_session_start;
    ramdisk_data[66].len = data_things__explosion_session_end - data_things__explosion_session_start;
    ramdisk_data[67].data = data_things__explosion1_session_start;
    ramdisk_data[67].len = data_things__explosion1_session_end - data_things__explosion1_session_start;
    ramdisk_data[68].data = data_things__explosion4_session_start;
    ramdisk_data[68].len = data_things__explosion4_session_end - data_things__explosion4_session_start;
    ramdisk_data[69].data = data_things__explosion7_session_start;
    ramdisk_data[69].len = data_things__explosion7_session_end - data_things__explosion7_session_start;
    ramdisk_data[70].data = data_things__explosion8_session_start;
    ramdisk_data[70].len = data_things__explosion8_session_end - data_things__explosion8_session_start;
    ramdisk_data[71].data = data_things__fireball_session_start;
    ramdisk_data[71].len = data_things__fireball_session_end - data_things__fireball_session_start;
    ramdisk_data[72].data = data_things__floor1_session_start;
    ramdisk_data[72].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[73].data = data_things__food_session_start;
    ramdisk_data[73].len = data_things__food_session_end - data_things__food_session_start;
    ramdisk_data[74].data = data_things__generator1_session_start;
    ramdisk_data[74].len = data_things__generator1_session_end - data_things__generator1_session_start;
    ramdisk_data[75].data = data_things__generator7_session_start;
    ramdisk_data[75].len = data_things__generator7_session_end - data_things__generator7_session_start;
    ramdisk_data[76].data = data_things__ghost1_session_start;
    ramdisk_data[76].len = data_things__ghost1_session_end - data_things__ghost1_session_start;
    ramdisk_data[77].data = data_things__ghost2_session_start;
    ramdisk_data[77].len = data_things__ghost2_session_end - data_things__ghost2_session_start;
    ramdisk_data[78].data = data_things__ghost3_session_start;
    ramdisk_data[78].len = data_things__ghost3_session_end - data_things__ghost3_session_start;
    ramdisk_data[79].data = data_things__monk_session_start;
    ramdisk_data[79].len = data_things__monk_session_end - data_things__monk_session_start;
    ramdisk_data[80].data = data_things__poison2_session_start;
    ramdisk_data[80].len = data_things__poison2_session_end - data_things__poison2_session_start;
    ramdisk_data[81].data = data_things__poison8_session_start;
    ramdisk_data[81].len = data_things__poison8_session_end - data_things__poison8_session_start;
    ramdisk_data[82].data = data_things__scythe1_session_start;
    ramdisk_data[82].len = data_things__scythe1_session_end - data_things__scythe1_session_start;
    ramdisk_data[83].data = data_things__sparks1_session_start;
    ramdisk_data[83].len = data_things__sparks1_session_end - data_things__sparks1_session_start;
    ramdisk_data[84].data = data_things__sword1_session_start;
    ramdisk_data[84].len = data_things__sword1_session_end - data_things__sword1_session_start;
    ramdisk_data[85].data = data_things__sword1_anim_session_start;
    ramdisk_data[85].len = data_things__sword1_anim_session_end - data_things__sword1_anim_session_start;
    ...
    ramdisk_data[87].data = data_things__sword2_anim_session_start;
    ramdisk_data[87].len = data_things__sword2_anim_session_end - data_things__sword2_anim_session_start;
    ramdisk_data[88].data = data_things__sword3_session_start;
    ramdisk_data[88].len = data_things__sword3_session_end - data_things__sword3_session_start;
    ramdisk_data[89].data = data_things__valkyrie_session_start;
    ramdisk_data[89].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[90].data = data_things__wa_session_start;
    ramdisk_data[90].len = data_things__wa_session_end - data_things__wa_session_start;
    ramdisk_data[91].data = data_things__wall6_session_start;
    ramdisk_data[91].len = data_things__wall6_session_end - data_things__wall6_session_start;
    ramdisk_data[92].data = data_things__wand1_anim_session_start;
    ramdisk_data[92].len = data_things__wand1_anim_session_end - data_things__wand1_anim_session_start;
    ramdisk_data[93].data = data_things__wand_fire_session_start;
    ramdisk_data[93].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[94].data = data_things__warrior_session_start;
    ramdisk_data[94].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[95].data = data_things__water_session_start;
    ramdisk_data[95].len = data_things__water_session_end - data_things__water_session_start;
    ramdisk_data[96].data = data_things__water_poison_session_start;
    ramdisk_data[96].len = data_things__water_poison_session_end - data_things__water_poison_session_start;
    ramdisk_data[97].data = data_things__weapon_swing_session_start;
    ramdisk_data[97].len = data_things__weapon_swing_session_end - data_things__weapon_swing_session_start;
    ramdisk_data[98].data = data_things__weapon_swing1_session_start;
    ramdisk_data[98].len = data_things__weapon_swing1_session_end - data_things__weapon_swing1_session_start;
    ramdisk_data[99].data = data_things__wizard_session_start;
    ramdisk_data[99].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ramdisk_data[100].data = data_things_amulet1_start;
    ramdisk_data[100].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[101].data = data_things_apple_start;
    ramdisk_data[101].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[102].data = data_things_apple_poison_start;
    ramdisk_data[102].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ...
    ramdisk_data[117].data = data_things_bread_start;
    ramdisk_data[117].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[118].data = data_things_cheese_start;
    ramdisk_data[118].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[119].data = data_things_chest1_start;
    ramdisk_data[119].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[120].data = data_things_cloudkill1_start;
    ramdisk_data[120].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[121].data = data_things_cloudkill2_start;
    ramdisk_data[121].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[122].data = data_things_cloudkill3_start;
    ramdisk_data[122].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[123].data = data_things_cloudkill4_start;
    ramdisk_data[123].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ...
    ramdisk_data[175].data = data_things_potion_cloudkill_start;
    ramdisk_data[175].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[176].data = data_things_potion_fire_start;
    ramdisk_data[176].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[177].data = data_things_potion_life_start;
    ramdisk_data[177].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[178].data = data_things_potion_monsticide_start;
    ramdisk_data[178].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[179].data = data_things_potion_shield_start;
    ramdisk_data[179].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[180].data = data_things_ring1_start;
    ramdisk_data[180].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[181].data = data_things_ring2_start;
    ramdisk_data[181].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[182].data = data_things_ring3_start;
    ramdisk_data[182].len = data_things_ring3_end - data_things_ring3_start;
    ...
    ramdisk_data[185].data = data_things_seedpod_start;
    ramdisk_data[185].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[186].data = data_things_spam_start;
    ramdisk_data[186].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[187].data = data_things_sparks1_start;
    ramdisk_data[187].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[188].data = data_things_sparks2_start;
    ramdisk_data[188].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[189].data = data_things_sparks3_start;
    ramdisk_data[189].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[190].data = data_things_sword1_start;
    ramdisk_data[190].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[191].data = data_things_sword1_anim_start;
    ramdisk_data[191].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[192].data = data_things_sword2_start;
    ramdisk_data[192].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[193].data = data_things_sword2_anim_start;
    ramdisk_data[193].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[194].data = data_things_sword3_start;
    ramdisk_data[194].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[195].data = data_things_sword3_anim_start;
    ramdisk_data[195].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ...
    ramdisk_data[260].data = data_ttf_readme_txt_start;
    ramdisk_data[260].len = data_ttf_readme_txt_end - data_ttf_readme_txt_start;
}
