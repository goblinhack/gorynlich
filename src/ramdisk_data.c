...
void ramdisk_init (void)
{
    ...
    ramdisk_data[51].data = data_things_amulet1_start;
    ramdisk_data[51].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[52].data = data_things_anim_eyes_start;
    ramdisk_data[52].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[53].data = data_things_anim_man_start;
    ramdisk_data[53].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[54].data = data_things_anim_treasure_chest_start;
    ramdisk_data[54].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ramdisk_data[55].data = data_things_apple_start;
    ramdisk_data[55].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[56].data = data_things_apple_poison_start;
    ramdisk_data[56].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[57].data = data_things_arrow_start;
    ramdisk_data[57].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[58].data = data_things_axe1_start;
    ramdisk_data[58].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[59].data = data_things_axe1_anim_start;
    ramdisk_data[59].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[60].data = data_things_axe2_start;
    ramdisk_data[60].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[61].data = data_things_axe2_anim_start;
    ramdisk_data[61].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[62].data = data_things_banana_start;
    ramdisk_data[62].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[63].data = data_things_blood1_start;
    ramdisk_data[63].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[64].data = data_things_blood2_start;
    ramdisk_data[64].len = data_things_blood2_end - data_things_blood2_start;
    ...
    ramdisk_data[73].data = data_things_brazier_start;
    ramdisk_data[73].len = data_things_brazier_end - data_things_brazier_start;
    ...
    ramdisk_data[120].data = data_things_hit_success_start;
    ramdisk_data[120].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[121].data = data_things_key_start;
    ramdisk_data[121].len = data_things_key_end - data_things_key_start;
    ramdisk_data[122].data = data_things_keys2_start;
    ramdisk_data[122].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[123].data = data_things_keys3_start;
    ramdisk_data[123].len = data_things_keys3_end - data_things_keys3_start;
    ...
    ramdisk_data[126].data = data_things_poison1_start;
    ramdisk_data[126].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[127].data = data_things_poison2_start;
    ramdisk_data[127].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[128].data = data_things_poison3_start;
    ramdisk_data[128].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[129].data = data_things_poison4_start;
    ramdisk_data[129].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[130].data = data_things_potion_cloudkill_start;
    ramdisk_data[130].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[131].data = data_things_potion_fire_start;
    ramdisk_data[131].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[132].data = data_things_potion_life_start;
    ramdisk_data[132].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[133].data = data_things_potion_monsticide_start;
    ramdisk_data[133].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[134].data = data_things_potion_shield_start;
    ramdisk_data[134].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[135].data = data_things_ring1_start;
    ramdisk_data[135].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[136].data = data_things_ring2_start;
    ramdisk_data[136].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[137].data = data_things_ring3_start;
    ramdisk_data[137].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[138].data = data_things_rock1_start;
    ramdisk_data[138].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[139].data = data_things_scythe1_start;
    ramdisk_data[139].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[140].data = data_things_scythe1_anim_start;
    ramdisk_data[140].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[141].data = data_things_spam_start;
    ramdisk_data[141].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[142].data = data_things_sword1_start;
    ramdisk_data[142].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[143].data = data_things_sword1_anim_start;
    ramdisk_data[143].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[144].data = data_things_sword2_start;
    ramdisk_data[144].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[145].data = data_things_sword2_anim_start;
    ramdisk_data[145].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[146].data = data_things_sword3_start;
    ramdisk_data[146].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[147].data = data_things_sword3_anim_start;
    ramdisk_data[147].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[148].data = data_things_torch_start;
    ramdisk_data[148].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[149].data = data_things_torches_start;
    ramdisk_data[149].len = data_things_torches_end - data_things_torches_start;
