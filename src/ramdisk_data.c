...
extern unsigned char *data_things__floor1_swp_start_ asm("data_things__floor1_swp_start_");
extern unsigned char *data_things__floor1_swp_end_ asm("data_things__floor1_swp_end_");
static const unsigned char *const data_things__floor1_swp_start =
    (const unsigned char *const) (char*)&data_things__floor1_swp_start_;
static const unsigned char *const data_things__floor1_swp_end   =
    (const unsigned char *const) (char*)&data_things__floor1_swp_end_;
...
{
    /* filename */ "data/things/.floor1.swp",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[68].data = data_things__floor1_swp_start;
    ramdisk_data[68].len = data_things__floor1_swp_end - data_things__floor1_swp_start;
    ...
    ramdisk_data[87].data = data_things__wand1_anim_session_start;
    ramdisk_data[87].len = data_things__wand1_anim_session_end - data_things__wand1_anim_session_start;
    ramdisk_data[88].data = data_things__wand_fire_session_start;
    ramdisk_data[88].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[89].data = data_things__warrior_session_start;
    ramdisk_data[89].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[90].data = data_things__water_session_start;
    ramdisk_data[90].len = data_things__water_session_end - data_things__water_session_start;
    ramdisk_data[91].data = data_things__water_poison_session_start;
    ramdisk_data[91].len = data_things__water_poison_session_end - data_things__water_poison_session_start;
    ramdisk_data[92].data = data_things__weapon_swing_session_start;
    ramdisk_data[92].len = data_things__weapon_swing_session_end - data_things__weapon_swing_session_start;
    ramdisk_data[93].data = data_things__weapon_swing1_session_start;
    ramdisk_data[93].len = data_things__weapon_swing1_session_end - data_things__weapon_swing1_session_start;
    ramdisk_data[94].data = data_things__wizard_session_start;
    ramdisk_data[94].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ramdisk_data[95].data = data_things_amulet1_start;
    ramdisk_data[95].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[96].data = data_things_apple_start;
    ramdisk_data[96].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[97].data = data_things_apple_poison_start;
    ramdisk_data[97].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[98].data = data_things_arrow_start;
    ramdisk_data[98].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[99].data = data_things_axe1_start;
    ramdisk_data[99].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[100].data = data_things_axe1_anim_start;
    ramdisk_data[100].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[101].data = data_things_axe2_start;
    ramdisk_data[101].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[102].data = data_things_axe2_anim_start;
    ramdisk_data[102].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[103].data = data_things_banana_start;
    ramdisk_data[103].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[104].data = data_things_bonepile1_start;
    ramdisk_data[104].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[105].data = data_things_bonepile2_start;
    ramdisk_data[105].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[106].data = data_things_bonepile3_start;
    ramdisk_data[106].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[107].data = data_things_bow1_start;
    ramdisk_data[107].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[108].data = data_things_bow1_anim_start;
    ramdisk_data[108].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[109].data = data_things_bow2_start;
    ramdisk_data[109].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[110].data = data_things_bow3_start;
    ramdisk_data[110].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[111].data = data_things_bow4_start;
    ramdisk_data[111].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[112].data = data_things_bread_start;
    ramdisk_data[112].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[113].data = data_things_cheese_start;
    ramdisk_data[113].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[114].data = data_things_chest1_start;
    ramdisk_data[114].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[115].data = data_things_cloudkill1_start;
    ramdisk_data[115].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[116].data = data_things_cloudkill2_start;
    ramdisk_data[116].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[117].data = data_things_cloudkill3_start;
    ramdisk_data[117].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[118].data = data_things_cloudkill4_start;
    ramdisk_data[118].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[119].data = data_things_cloudkill5_start;
    ramdisk_data[119].len = data_things_cloudkill5_end - data_things_cloudkill5_start;
    ramdisk_data[120].data = data_things_cloudkill6_start;
    ramdisk_data[120].len = data_things_cloudkill6_end - data_things_cloudkill6_start;
    ramdisk_data[121].data = data_things_cloudkill7_start;
    ramdisk_data[121].len = data_things_cloudkill7_end - data_things_cloudkill7_start;
    ramdisk_data[122].data = data_things_cloudkill8_start;
    ramdisk_data[122].len = data_things_cloudkill8_end - data_things_cloudkill8_start;
    ramdisk_data[123].data = data_things_coins1_start;
    ramdisk_data[123].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[124].data = data_things_death_start;
    ramdisk_data[124].len = data_things_death_end - data_things_death_start;
    ramdisk_data[125].data = data_things_demon_start;
    ramdisk_data[125].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[126].data = data_things_door1_start;
    ramdisk_data[126].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[127].data = data_things_door2_start;
    ramdisk_data[127].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[128].data = data_things_dwarf_start;
    ramdisk_data[128].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[129].data = data_things_elf_start;
    ramdisk_data[129].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[130].data = data_things_exit1_start;
    ramdisk_data[130].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[131].data = data_things_exit2_start;
    ramdisk_data[131].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[132].data = data_things_exit3_start;
    ramdisk_data[132].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[133].data = data_things_exit4_start;
    ramdisk_data[133].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[134].data = data_things_exit5_start;
    ramdisk_data[134].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[135].data = data_things_exit6_start;
    ramdisk_data[135].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[136].data = data_things_exit7_start;
    ramdisk_data[136].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[137].data = data_things_explosion1_start;
    ramdisk_data[137].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[138].data = data_things_explosion2_start;
    ramdisk_data[138].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[139].data = data_things_explosion3_start;
    ramdisk_data[139].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[140].data = data_things_explosion4_start;
    ramdisk_data[140].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[141].data = data_things_fireball_start;
    ramdisk_data[141].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[142].data = data_things_floor1_start;
    ramdisk_data[142].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[143].data = data_things_floor2_start;
    ramdisk_data[143].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[144].data = data_things_floor3_start;
    ramdisk_data[144].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[145].data = data_things_floor4_start;
    ramdisk_data[145].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[146].data = data_things_floor5_start;
    ramdisk_data[146].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[147].data = data_things_floor6_start;
    ramdisk_data[147].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[148].data = data_things_gem1_start;
    ramdisk_data[148].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[149].data = data_things_gem2_start;
    ramdisk_data[149].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[150].data = data_things_gem3_start;
    ramdisk_data[150].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[151].data = data_things_gem4_start;
    ramdisk_data[151].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[152].data = data_things_gem5_start;
    ramdisk_data[152].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[153].data = data_things_gem6_start;
    ramdisk_data[153].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[154].data = data_things_gem7_start;
    ramdisk_data[154].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[155].data = data_things_generator1_start;
    ramdisk_data[155].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[156].data = data_things_generator5_start;
    ramdisk_data[156].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[157].data = data_things_generator6_start;
    ramdisk_data[157].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[158].data = data_things_generator7_start;
    ramdisk_data[158].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[159].data = data_things_ghost1_start;
    ramdisk_data[159].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[160].data = data_things_ghost2_start;
    ramdisk_data[160].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[161].data = data_things_ghost3_start;
    ramdisk_data[161].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[162].data = data_things_key_start;
    ramdisk_data[162].len = data_things_key_end - data_things_key_start;
    ramdisk_data[163].data = data_things_keys2_start;
    ramdisk_data[163].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[164].data = data_things_keys3_start;
    ramdisk_data[164].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[165].data = data_things_lizard_start;
    ramdisk_data[165].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[166].data = data_things_monk_start;
    ramdisk_data[166].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[167].data = data_things_noentry_start;
    ramdisk_data[167].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[168].data = data_things_pipe_start;
    ramdisk_data[168].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[169].data = data_things_plant_start;
    ramdisk_data[169].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[170].data = data_things_poison1_start;
    ramdisk_data[170].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[171].data = data_things_poison2_start;
    ramdisk_data[171].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[172].data = data_things_poison3_start;
    ramdisk_data[172].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[173].data = data_things_poison4_start;
    ramdisk_data[173].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[174].data = data_things_poison5_start;
    ramdisk_data[174].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[175].data = data_things_poison6_start;
    ramdisk_data[175].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[176].data = data_things_poison7_start;
    ramdisk_data[176].len = data_things_poison7_end - data_things_poison7_start;
    ramdisk_data[177].data = data_things_poison8_start;
    ramdisk_data[177].len = data_things_poison8_end - data_things_poison8_start;
    ramdisk_data[178].data = data_things_potion_cloudkill_start;
    ramdisk_data[178].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[179].data = data_things_potion_fire_start;
    ramdisk_data[179].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[180].data = data_things_potion_life_start;
    ramdisk_data[180].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[181].data = data_things_potion_monsticide_start;
    ramdisk_data[181].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[182].data = data_things_potion_shield_start;
    ramdisk_data[182].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[183].data = data_things_ring1_start;
    ramdisk_data[183].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[184].data = data_things_ring2_start;
    ramdisk_data[184].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[185].data = data_things_ring3_start;
    ramdisk_data[185].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[186].data = data_things_scythe1_start;
    ramdisk_data[186].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[187].data = data_things_scythe1_anim_start;
    ramdisk_data[187].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[188].data = data_things_seedpod_start;
    ramdisk_data[188].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[189].data = data_things_spam_start;
    ramdisk_data[189].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[190].data = data_things_sparks1_start;
    ramdisk_data[190].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[191].data = data_things_sparks2_start;
    ramdisk_data[191].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[192].data = data_things_sparks3_start;
    ramdisk_data[192].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[193].data = data_things_sword1_start;
    ramdisk_data[193].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[194].data = data_things_sword1_anim_start;
    ramdisk_data[194].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[195].data = data_things_sword2_start;
    ramdisk_data[195].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[196].data = data_things_sword2_anim_start;
    ramdisk_data[196].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[197].data = data_things_sword3_start;
    ramdisk_data[197].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[198].data = data_things_sword3_anim_start;
    ramdisk_data[198].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[199].data = data_things_valkyrie_start;
    ramdisk_data[199].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[200].data = data_things_wall_start;
    ramdisk_data[200].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[201].data = data_things_wall2_start;
    ramdisk_data[201].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[202].data = data_things_wall3_start;
    ramdisk_data[202].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[203].data = data_things_wall4_start;
    ramdisk_data[203].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[204].data = data_things_wall5_start;
    ramdisk_data[204].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[205].data = data_things_wand1_anim_start;
    ramdisk_data[205].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ramdisk_data[206].data = data_things_wand_fire_start;
    ramdisk_data[206].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[207].data = data_things_warrior_start;
    ramdisk_data[207].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[208].data = data_things_water_start;
    ramdisk_data[208].len = data_things_water_end - data_things_water_start;
    ramdisk_data[209].data = data_things_water_poison_start;
    ramdisk_data[209].len = data_things_water_poison_end - data_things_water_poison_start;
    ramdisk_data[210].data = data_things_weapon_swing1_start;
    ramdisk_data[210].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[211].data = data_things_wizard_start;
    ramdisk_data[211].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[212].data = data_ttf_emulogic_gif_start;
    ramdisk_data[212].len = data_ttf_emulogic_gif_end - data_ttf_emulogic_gif_start;
    ramdisk_data[213].data = data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[213].len = data_ttf_emulogic_ttf_pointsize10_data_end - data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[214].data = data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[214].len = data_ttf_emulogic_ttf_pointsize10_tga_end - data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[215].data = data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[215].len = data_ttf_emulogic_ttf_pointsize11_data_end - data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[216].data = data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[216].len = data_ttf_emulogic_ttf_pointsize11_tga_end - data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[217].data = data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[217].len = data_ttf_emulogic_ttf_pointsize12_data_end - data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[218].data = data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[218].len = data_ttf_emulogic_ttf_pointsize12_tga_end - data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[219].data = data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[219].len = data_ttf_emulogic_ttf_pointsize14_data_end - data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[220].data = data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[220].len = data_ttf_emulogic_ttf_pointsize14_tga_end - data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[221].data = data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[221].len = data_ttf_emulogic_ttf_pointsize15_data_end - data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[222].data = data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[222].len = data_ttf_emulogic_ttf_pointsize15_tga_end - data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[223].data = data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[223].len = data_ttf_emulogic_ttf_pointsize16_data_end - data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[224].data = data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[224].len = data_ttf_emulogic_ttf_pointsize16_tga_end - data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[225].data = data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[225].len = data_ttf_emulogic_ttf_pointsize17_data_end - data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[226].data = data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[226].len = data_ttf_emulogic_ttf_pointsize17_tga_end - data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[227].data = data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[227].len = data_ttf_emulogic_ttf_pointsize18_data_end - data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[228].data = data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[228].len = data_ttf_emulogic_ttf_pointsize18_tga_end - data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[229].data = data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[229].len = data_ttf_emulogic_ttf_pointsize19_data_end - data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[230].data = data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[230].len = data_ttf_emulogic_ttf_pointsize19_tga_end - data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[231].data = data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[231].len = data_ttf_emulogic_ttf_pointsize20_data_end - data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[232].data = data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[232].len = data_ttf_emulogic_ttf_pointsize20_tga_end - data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[233].data = data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[233].len = data_ttf_emulogic_ttf_pointsize21_data_end - data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[234].data = data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[234].len = data_ttf_emulogic_ttf_pointsize21_tga_end - data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[235].data = data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[235].len = data_ttf_emulogic_ttf_pointsize22_data_end - data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[236].data = data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[236].len = data_ttf_emulogic_ttf_pointsize22_tga_end - data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[237].data = data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[237].len = data_ttf_emulogic_ttf_pointsize23_data_end - data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[238].data = data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[238].len = data_ttf_emulogic_ttf_pointsize23_tga_end - data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[239].data = data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[239].len = data_ttf_emulogic_ttf_pointsize24_data_end - data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[240].data = data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[240].len = data_ttf_emulogic_ttf_pointsize24_tga_end - data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[241].data = data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[241].len = data_ttf_emulogic_ttf_pointsize25_data_end - data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[242].data = data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[242].len = data_ttf_emulogic_ttf_pointsize25_tga_end - data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[243].data = data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[243].len = data_ttf_emulogic_ttf_pointsize26_data_end - data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[244].data = data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[244].len = data_ttf_emulogic_ttf_pointsize26_tga_end - data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[245].data = data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[245].len = data_ttf_emulogic_ttf_pointsize28_data_end - data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[246].data = data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[246].len = data_ttf_emulogic_ttf_pointsize28_tga_end - data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[247].data = data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[247].len = data_ttf_emulogic_ttf_pointsize30_data_end - data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[248].data = data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[248].len = data_ttf_emulogic_ttf_pointsize30_tga_end - data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[249].data = data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[249].len = data_ttf_emulogic_ttf_pointsize32_data_end - data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[250].data = data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[250].len = data_ttf_emulogic_ttf_pointsize32_tga_end - data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[251].data = data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[251].len = data_ttf_emulogic_ttf_pointsize36_data_end - data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[252].data = data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[252].len = data_ttf_emulogic_ttf_pointsize36_tga_end - data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[253].data = data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[253].len = data_ttf_emulogic_ttf_pointsize6_data_end - data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[254].data = data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[254].len = data_ttf_emulogic_ttf_pointsize6_tga_end - data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[255].data = data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[255].len = data_ttf_emulogic_ttf_pointsize7_data_end - data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[256].data = data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[256].len = data_ttf_emulogic_ttf_pointsize7_tga_end - data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[257].data = data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[257].len = data_ttf_emulogic_ttf_pointsize8_data_end - data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[258].data = data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[258].len = data_ttf_emulogic_ttf_pointsize8_tga_end - data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[259].data = data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[259].len = data_ttf_emulogic_ttf_pointsize9_data_end - data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[260].data = data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[260].len = data_ttf_emulogic_ttf_pointsize9_tga_end - data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[261].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[261].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[262].data = data_ttf_readme_txt_start;
    ramdisk_data[262].len = data_ttf_readme_txt_end - data_ttf_readme_txt_start;
}
