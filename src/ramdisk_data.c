...
void ramdisk_init (void)
{
    ...
    ramdisk_data[38].data = data_things__torch_session_start;
    ramdisk_data[38].len = data_things__torch_session_end - data_things__torch_session_start;
    ramdisk_data[39].data = data_things__wand_f_session_start;
    ramdisk_data[39].len = data_things__wand_f_session_end - data_things__wand_f_session_start;
    ramdisk_data[40].data = data_things__wand_fire_session_start;
    ramdisk_data[40].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[41].data = data_things_amulet1_start;
    ramdisk_data[41].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[42].data = data_things_apple_start;
    ramdisk_data[42].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[43].data = data_things_apple_poison_start;
    ramdisk_data[43].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[44].data = data_things_arrow_start;
    ramdisk_data[44].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[45].data = data_things_axe1_start;
    ramdisk_data[45].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[46].data = data_things_axe1_anim_start;
    ramdisk_data[46].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[47].data = data_things_axe2_start;
    ramdisk_data[47].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[48].data = data_things_axe2_anim_start;
    ramdisk_data[48].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[49].data = data_things_banana_start;
    ramdisk_data[49].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[50].data = data_things_bonepile1_start;
    ramdisk_data[50].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[51].data = data_things_bonepile2_start;
    ramdisk_data[51].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[52].data = data_things_bonepile3_start;
    ramdisk_data[52].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[53].data = data_things_bow1_start;
    ramdisk_data[53].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[54].data = data_things_bow1_anim_start;
    ramdisk_data[54].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[55].data = data_things_bow2_start;
    ramdisk_data[55].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[56].data = data_things_bow3_start;
    ramdisk_data[56].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[57].data = data_things_bow4_start;
    ramdisk_data[57].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[58].data = data_things_brazier_start;
    ramdisk_data[58].len = data_things_brazier_end - data_things_brazier_start;
    ramdisk_data[59].data = data_things_bread_start;
    ramdisk_data[59].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[60].data = data_things_cheese_start;
    ramdisk_data[60].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[61].data = data_things_chest1_start;
    ramdisk_data[61].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[62].data = data_things_cloudkill1_start;
    ramdisk_data[62].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[63].data = data_things_cloudkill2_start;
    ramdisk_data[63].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[64].data = data_things_cloudkill3_start;
    ramdisk_data[64].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[65].data = data_things_cloudkill4_start;
    ramdisk_data[65].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[66].data = data_things_coins1_start;
    ramdisk_data[66].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[67].data = data_things_death_start;
    ramdisk_data[67].len = data_things_death_end - data_things_death_start;
    ramdisk_data[68].data = data_things_demon_start;
    ramdisk_data[68].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[69].data = data_things_door1_start;
    ramdisk_data[69].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[70].data = data_things_door2_start;
    ramdisk_data[70].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[71].data = data_things_dwarf_start;
    ramdisk_data[71].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[72].data = data_things_elf_start;
    ramdisk_data[72].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[73].data = data_things_exit1_start;
    ramdisk_data[73].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[74].data = data_things_exit2_start;
    ramdisk_data[74].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[75].data = data_things_exit3_start;
    ramdisk_data[75].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[76].data = data_things_exit4_start;
    ramdisk_data[76].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[77].data = data_things_exit5_start;
    ramdisk_data[77].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[78].data = data_things_exit6_start;
    ramdisk_data[78].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[79].data = data_things_exit7_start;
    ramdisk_data[79].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[80].data = data_things_explosion1_start;
    ramdisk_data[80].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[81].data = data_things_explosion2_start;
    ramdisk_data[81].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[82].data = data_things_explosion3_start;
    ramdisk_data[82].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[83].data = data_things_explosion4_start;
    ramdisk_data[83].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[84].data = data_things_fireball_start;
    ramdisk_data[84].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[85].data = data_things_floor1_start;
    ramdisk_data[85].len = data_things_floor1_end - data_things_floor1_start;
    ...
    ramdisk_data[109].data = data_things_monk_start;
    ramdisk_data[109].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[110].data = data_things_noentry_start;
    ramdisk_data[110].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[111].data = data_things_pipe_start;
    ramdisk_data[111].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[112].data = data_things_plant_start;
    ramdisk_data[112].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[113].data = data_things_poison1_start;
    ramdisk_data[113].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[114].data = data_things_poison2_start;
    ramdisk_data[114].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[115].data = data_things_poison3_start;
    ramdisk_data[115].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[116].data = data_things_poison4_start;
    ramdisk_data[116].len = data_things_poison4_end - data_things_poison4_start;
    ...
    ramdisk_data[125].data = data_things_rock1_start;
    ramdisk_data[125].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[126].data = data_things_scythe1_start;
    ramdisk_data[126].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[127].data = data_things_scythe1_anim_start;
    ramdisk_data[127].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[128].data = data_things_seedpod_start;
    ramdisk_data[128].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[129].data = data_things_spam_start;
    ramdisk_data[129].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[130].data = data_things_sparks1_start;
    ramdisk_data[130].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[131].data = data_things_sparks2_start;
    ramdisk_data[131].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[132].data = data_things_sparks3_start;
    ramdisk_data[132].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[133].data = data_things_sword1_start;
    ramdisk_data[133].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[134].data = data_things_sword1_anim_start;
    ramdisk_data[134].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[135].data = data_things_sword2_start;
    ramdisk_data[135].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[136].data = data_things_sword2_anim_start;
    ramdisk_data[136].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[137].data = data_things_sword3_start;
    ramdisk_data[137].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[138].data = data_things_sword3_anim_start;
    ramdisk_data[138].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[139].data = data_things_torch_start;
    ramdisk_data[139].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[140].data = data_things_valkyrie_start;
    ramdisk_data[140].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[141].data = data_things_wall1_start;
    ramdisk_data[141].len = data_things_wall1_end - data_things_wall1_start;
    ramdisk_data[142].data = data_things_wall2_start;
    ramdisk_data[142].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[143].data = data_things_wall3_start;
    ramdisk_data[143].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[144].data = data_things_wall4_start;
    ramdisk_data[144].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[145].data = data_things_wall5_start;
    ramdisk_data[145].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[146].data = data_things_wall6_start;
    ramdisk_data[146].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[147].data = data_things_wand1_anim_start;
    ramdisk_data[147].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ramdisk_data[148].data = data_things_wand_fire_start;
    ramdisk_data[148].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[149].data = data_things_warrior_start;
    ramdisk_data[149].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[150].data = data_things_water_start;
    ramdisk_data[150].len = data_things_water_end - data_things_water_start;
    ramdisk_data[151].data = data_things_water_poison_start;
    ramdisk_data[151].len = data_things_water_poison_end - data_things_water_poison_start;
    ramdisk_data[152].data = data_things_weapon_swing1_start;
    ramdisk_data[152].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[153].data = data_things_wizard_start;
    ramdisk_data[153].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[154].data = data_ttf_emulogic_gif_start;
    ramdisk_data[154].len = data_ttf_emulogic_gif_end - data_ttf_emulogic_gif_start;
    ramdisk_data[155].data = data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[155].len = data_ttf_emulogic_ttf_pointsize10_data_end - data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[156].data = data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[156].len = data_ttf_emulogic_ttf_pointsize10_tga_end - data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[157].data = data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[157].len = data_ttf_emulogic_ttf_pointsize11_data_end - data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[158].data = data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[158].len = data_ttf_emulogic_ttf_pointsize11_tga_end - data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[159].data = data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[159].len = data_ttf_emulogic_ttf_pointsize12_data_end - data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[160].data = data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[160].len = data_ttf_emulogic_ttf_pointsize12_tga_end - data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[161].data = data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[161].len = data_ttf_emulogic_ttf_pointsize14_data_end - data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[162].data = data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[162].len = data_ttf_emulogic_ttf_pointsize14_tga_end - data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[163].data = data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[163].len = data_ttf_emulogic_ttf_pointsize15_data_end - data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[164].data = data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[164].len = data_ttf_emulogic_ttf_pointsize15_tga_end - data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[165].data = data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[165].len = data_ttf_emulogic_ttf_pointsize16_data_end - data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[166].data = data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[166].len = data_ttf_emulogic_ttf_pointsize16_tga_end - data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[167].data = data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[167].len = data_ttf_emulogic_ttf_pointsize17_data_end - data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[168].data = data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[168].len = data_ttf_emulogic_ttf_pointsize17_tga_end - data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[169].data = data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[169].len = data_ttf_emulogic_ttf_pointsize18_data_end - data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[170].data = data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[170].len = data_ttf_emulogic_ttf_pointsize18_tga_end - data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[171].data = data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[171].len = data_ttf_emulogic_ttf_pointsize19_data_end - data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[172].data = data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[172].len = data_ttf_emulogic_ttf_pointsize19_tga_end - data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[173].data = data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[173].len = data_ttf_emulogic_ttf_pointsize20_data_end - data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[174].data = data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[174].len = data_ttf_emulogic_ttf_pointsize20_tga_end - data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[175].data = data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[175].len = data_ttf_emulogic_ttf_pointsize21_data_end - data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[176].data = data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[176].len = data_ttf_emulogic_ttf_pointsize21_tga_end - data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[177].data = data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[177].len = data_ttf_emulogic_ttf_pointsize22_data_end - data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[178].data = data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[178].len = data_ttf_emulogic_ttf_pointsize22_tga_end - data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[179].data = data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[179].len = data_ttf_emulogic_ttf_pointsize23_data_end - data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[180].data = data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[180].len = data_ttf_emulogic_ttf_pointsize23_tga_end - data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[181].data = data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[181].len = data_ttf_emulogic_ttf_pointsize24_data_end - data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[182].data = data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[182].len = data_ttf_emulogic_ttf_pointsize24_tga_end - data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[183].data = data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[183].len = data_ttf_emulogic_ttf_pointsize25_data_end - data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[184].data = data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[184].len = data_ttf_emulogic_ttf_pointsize25_tga_end - data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[185].data = data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[185].len = data_ttf_emulogic_ttf_pointsize26_data_end - data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[186].data = data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[186].len = data_ttf_emulogic_ttf_pointsize26_tga_end - data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[187].data = data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[187].len = data_ttf_emulogic_ttf_pointsize28_data_end - data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[188].data = data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[188].len = data_ttf_emulogic_ttf_pointsize28_tga_end - data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[189].data = data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[189].len = data_ttf_emulogic_ttf_pointsize30_data_end - data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[190].data = data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[190].len = data_ttf_emulogic_ttf_pointsize30_tga_end - data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[191].data = data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[191].len = data_ttf_emulogic_ttf_pointsize32_data_end - data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[192].data = data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[192].len = data_ttf_emulogic_ttf_pointsize32_tga_end - data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[193].data = data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[193].len = data_ttf_emulogic_ttf_pointsize36_data_end - data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[194].data = data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[194].len = data_ttf_emulogic_ttf_pointsize36_tga_end - data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[195].data = data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[195].len = data_ttf_emulogic_ttf_pointsize6_data_end - data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[196].data = data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[196].len = data_ttf_emulogic_ttf_pointsize6_tga_end - data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[197].data = data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[197].len = data_ttf_emulogic_ttf_pointsize7_data_end - data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[198].data = data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[198].len = data_ttf_emulogic_ttf_pointsize7_tga_end - data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[199].data = data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[199].len = data_ttf_emulogic_ttf_pointsize8_data_end - data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[200].data = data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[200].len = data_ttf_emulogic_ttf_pointsize8_tga_end - data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[201].data = data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[201].len = data_ttf_emulogic_ttf_pointsize9_data_end - data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[202].data = data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[202].len = data_ttf_emulogic_ttf_pointsize9_tga_end - data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[203].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[203].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[204].data = data_ttf_Readme_txt_start;
    ramdisk_data[204].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
}
