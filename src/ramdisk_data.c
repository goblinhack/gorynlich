...
void ramdisk_init (void)
{
    ...
    ramdisk_data[68].data = data_gfx_cloudkill_png_start;
    ramdisk_data[68].len = data_gfx_cloudkill_png_end - data_gfx_cloudkill_png_start;
    ramdisk_data[69].data = data_gfx_gravestone2_png_start;
    ramdisk_data[69].len = data_gfx_gravestone2_png_end - data_gfx_gravestone2_png_start;
    ramdisk_data[70].data = data_gfx_gorynlich_png_start;
    ramdisk_data[70].len = data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start;
    ramdisk_data[71].data = data_gfx_sprites_small_png_start;
    ramdisk_data[71].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[72].data = data_gfx_title3_png_start;
    ramdisk_data[72].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ramdisk_data[73].data = data_gfx_title2_png_start;
    ramdisk_data[73].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[74].data = data_gfx_help2_png_start;
    ramdisk_data[74].len = data_gfx_help2_png_end - data_gfx_help2_png_start;
    ramdisk_data[75].data = data_gfx_gravestone_png_start;
    ramdisk_data[75].len = data_gfx_gravestone_png_end - data_gfx_gravestone_png_start;
    ramdisk_data[76].data = data_gfx_explosion_png_start;
    ramdisk_data[76].len = data_gfx_explosion_png_end - data_gfx_explosion_png_start;
    ramdisk_data[77].data = data_gfx_rat_png_start;
    ramdisk_data[77].len = data_gfx_rat_png_end - data_gfx_rat_png_start;
    ramdisk_data[78].data = data_gfx_poison_png_start;
    ramdisk_data[78].len = data_gfx_poison_png_end - data_gfx_poison_png_start;
    ramdisk_data[79].data = data_gfx_dragon_png_start;
    ramdisk_data[79].len = data_gfx_dragon_png_end - data_gfx_dragon_png_start;
    ramdisk_data[80].data = data_gfx_title_png_start;
    ramdisk_data[80].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[81].data = data_levels_2_start;
    ramdisk_data[81].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[82].data = data_levels_1_start;
    ramdisk_data[82].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[83].data = data_things_exit5_start;
    ramdisk_data[83].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[84].data = data_things_potion_cloudkill_start;
    ramdisk_data[84].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[85].data = data_things_sword3_start;
    ramdisk_data[85].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[86].data = data_things_plant_start;
    ramdisk_data[86].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[87].data = data_things_dwarf_start;
    ramdisk_data[87].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[88].data = data_things_generator7_start;
    ramdisk_data[88].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[89].data = data_things_exit2_start;
    ramdisk_data[89].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[90].data = data_things_ghost2_start;
    ramdisk_data[90].len = data_things_ghost2_end - data_things_ghost2_start;
    ...
    ramdisk_data[94].data = data_things_scythe1_anim_start;
    ramdisk_data[94].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ...
    ramdisk_data[96].data = data_things_ring2_start;
    ramdisk_data[96].len = data_things_ring2_end - data_things_ring2_start;
    ...
    ramdisk_data[101].data = data_things_cheese_start;
    ramdisk_data[101].len = data_things_cheese_end - data_things_cheese_start;
    ...
    ramdisk_data[108].data = data_things_ring1_start;
    ramdisk_data[108].len = data_things_ring1_end - data_things_ring1_start;
    ...
    ramdisk_data[112].data = data_things_potion_fire_start;
    ramdisk_data[112].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[113].data = data_things_keys2_start;
    ramdisk_data[113].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[114].data = data_things_wall1_start;
    ramdisk_data[114].len = data_things_wall1_end - data_things_wall1_start;
    ramdisk_data[115].data = data_things_lizard_start;
    ramdisk_data[115].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[116].data = data_things_ring3_start;
    ramdisk_data[116].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[117].data = data_things_rock1_start;
    ramdisk_data[117].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[118].data = data_things_gem1_start;
    ramdisk_data[118].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[119].data = data_things_axe2_anim_start;
    ramdisk_data[119].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[120].data = data_things_weapon_swing1_start;
    ramdisk_data[120].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[121].data = data_things_warrior_start;
    ramdisk_data[121].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[122].data = data_things_gem5_start;
    ramdisk_data[122].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[123].data = data_things_cloudkill2_start;
    ramdisk_data[123].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ...
    ramdisk_data[128].data = data_things_axe1_start;
    ramdisk_data[128].len = data_things_axe1_end - data_things_axe1_start;
    ...
    ramdisk_data[134].data = data_things_bow4_start;
    ramdisk_data[134].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[135].data = data_things_poison3_start;
    ramdisk_data[135].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[136].data = data_things_valkyrie_start;
    ramdisk_data[136].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[137].data = data_things_elf_start;
    ramdisk_data[137].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[138].data = data_things_sword1_start;
    ramdisk_data[138].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[139].data = data_things_wall4_start;
    ramdisk_data[139].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[140].data = data_things_sparks1_start;
    ramdisk_data[140].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[141].data = data_things_sword2_start;
    ramdisk_data[141].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[142].data = data_things_water_start;
    ramdisk_data[142].len = data_things_water_end - data_things_water_start;
    ramdisk_data[143].data = data_things_floor6_start;
    ramdisk_data[143].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[144].data = data_things_wizard_start;
    ramdisk_data[144].len = data_things_wizard_end - data_things_wizard_start;
    ...
    ramdisk_data[161].data = data_things_apple_start;
    ramdisk_data[161].len = data_things_apple_end - data_things_apple_start;
    ...
    ramdisk_data[164].data = data_things_generator6_start;
    ramdisk_data[164].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[165].data = data_things_fireball_start;
    ramdisk_data[165].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[166].data = data_things_potion_shield_start;
    ramdisk_data[166].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[167].data = data_things_explosion3_start;
    ramdisk_data[167].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[168].data = data_things_water_poison_start;
    ramdisk_data[168].len = data_things_water_poison_end - data_things_water_poison_start;
    ...
    ramdisk_data[171].data = data_things_bonepile3_start;
    ramdisk_data[171].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[172].data = data_things_explosion4_start;
    ramdisk_data[172].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[173].data = data_things_exit7_start;
    ramdisk_data[173].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[174].data = data_things_pipe_start;
    ramdisk_data[174].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[175].data = data_things_noentry_start;
    ramdisk_data[175].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[176].data = data_things_sparks3_start;
    ramdisk_data[176].len = data_things_sparks3_end - data_things_sparks3_start;
    ...
    ramdisk_data[178].data = data_things_apple_poison_start;
    ramdisk_data[178].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[179].data = data_things_explosion2_start;
    ramdisk_data[179].len = data_things_explosion2_end - data_things_explosion2_start;
    ...
    ramdisk_data[181].data = data_things_gem2_start;
    ramdisk_data[181].len = data_things_gem2_end - data_things_gem2_start;
    ...
    ramdisk_data[183].data = data_things_bonepile2_start;
    ramdisk_data[183].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[184].data = data_things_wand_fire_start;
    ramdisk_data[184].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[185].data = data_things_scythe1_start;
    ramdisk_data[185].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[186].data = data_things_gem4_start;
    ramdisk_data[186].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[187].data = data_things_bow1_start;
    ramdisk_data[187].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[188].data = data_things_poison4_start;
    ramdisk_data[188].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[189].data = data_things_door1_start;
    ramdisk_data[189].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[190].data = data_things_cloudkill3_start;
    ramdisk_data[190].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[191].data = data_things_keys3_start;
    ramdisk_data[191].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[192].data = data_things_door2_start;
    ramdisk_data[192].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[193].data = data_things_wall3_start;
    ramdisk_data[193].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[194].data = data_map_jigsaw_map_start;
    ramdisk_data[194].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[195].data = data_music_hiscore_wav_start;
    ramdisk_data[195].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[196].data = data_music_charlotte_mp3_start;
    ramdisk_data[196].len = data_music_charlotte_mp3_end - data_music_charlotte_mp3_start;
    ramdisk_data[197].data = data_music_music_wav_start;
    ramdisk_data[197].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[198].data = data_music_charlotte8bit_mp3_start;
    ramdisk_data[198].len = data_music_charlotte8bit_mp3_end - data_music_charlotte8bit_mp3_start;
    ramdisk_data[199].data = data_music_intro_wav_start;
    ramdisk_data[199].len = data_music_intro_wav_end - data_music_intro_wav_start;
}
