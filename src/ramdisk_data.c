...
void ramdisk_init (void)
{
    ...
    ramdisk_data[3].data = data_gfx_floor_png_start;
    ramdisk_data[3].len = data_gfx_floor_png_end - data_gfx_floor_png_start;
    ...
    ramdisk_data[38].data = data_things_apple_start;
    ramdisk_data[38].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[39].data = data_things_apple_poison_start;
    ramdisk_data[39].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[40].data = data_things_arrow_start;
    ramdisk_data[40].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[41].data = data_things_axe1_start;
    ramdisk_data[41].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[42].data = data_things_axe1_anim_start;
    ramdisk_data[42].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[43].data = data_things_axe2_start;
    ramdisk_data[43].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[44].data = data_things_axe2_anim_start;
    ramdisk_data[44].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[45].data = data_things_banana_start;
    ramdisk_data[45].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[46].data = data_things_bonepile1_start;
    ramdisk_data[46].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[47].data = data_things_bonepile2_start;
    ramdisk_data[47].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[48].data = data_things_bonepile3_start;
    ramdisk_data[48].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[49].data = data_things_bow1_start;
    ramdisk_data[49].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[50].data = data_things_bow1_anim_start;
    ramdisk_data[50].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ...
    ramdisk_data[54].data = data_things_bread_start;
    ramdisk_data[54].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[55].data = data_things_cheese_start;
    ramdisk_data[55].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[56].data = data_things_chest1_start;
    ramdisk_data[56].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[57].data = data_things_cloudkill1_start;
    ramdisk_data[57].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[58].data = data_things_cloudkill2_start;
    ramdisk_data[58].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[59].data = data_things_cloudkill3_start;
    ramdisk_data[59].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[60].data = data_things_cloudkill4_start;
    ramdisk_data[60].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ...
    ramdisk_data[64].data = data_things_door1_start;
    ramdisk_data[64].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[65].data = data_things_door2_start;
    ramdisk_data[65].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[66].data = data_things_dwarf_start;
    ramdisk_data[66].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[67].data = data_things_elf_start;
    ramdisk_data[67].len = data_things_elf_end - data_things_elf_start;
    ...
    ramdisk_data[79].data = data_things_fireball_start;
    ramdisk_data[79].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[80].data = data_things_floor1_start;
    ramdisk_data[80].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[81].data = data_things_floor2_start;
    ramdisk_data[81].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[82].data = data_things_floor3_start;
    ramdisk_data[82].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[83].data = data_things_floor4_start;
    ramdisk_data[83].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[84].data = data_things_floor5_start;
    ramdisk_data[84].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[85].data = data_things_floor6_start;
    ramdisk_data[85].len = data_things_floor6_end - data_things_floor6_start;
    ...
    ramdisk_data[100].data = data_things_key_start;
    ramdisk_data[100].len = data_things_key_end - data_things_key_start;
    ...
    ramdisk_data[104].data = data_things_monk_start;
    ramdisk_data[104].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[105].data = data_things_noentry_start;
    ramdisk_data[105].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[106].data = data_things_pipe_start;
    ramdisk_data[106].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[107].data = data_things_plant_start;
    ramdisk_data[107].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[108].data = data_things_poison1_start;
    ramdisk_data[108].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[109].data = data_things_poison2_start;
    ramdisk_data[109].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[110].data = data_things_poison3_start;
    ramdisk_data[110].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[111].data = data_things_poison4_start;
    ramdisk_data[111].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[112].data = data_things_potion_cloudkill_start;
    ramdisk_data[112].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[113].data = data_things_potion_fire_start;
    ramdisk_data[113].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[114].data = data_things_potion_life_start;
    ramdisk_data[114].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[115].data = data_things_potion_monsticide_start;
    ramdisk_data[115].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[116].data = data_things_potion_shield_start;
    ramdisk_data[116].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[117].data = data_things_ring1_start;
    ramdisk_data[117].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[118].data = data_things_ring2_start;
    ramdisk_data[118].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[119].data = data_things_ring3_start;
    ramdisk_data[119].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[120].data = data_things_scythe1_start;
    ramdisk_data[120].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[121].data = data_things_scythe1_anim_start;
    ramdisk_data[121].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ...
    ramdisk_data[124].data = data_things_sparks1_start;
    ramdisk_data[124].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[125].data = data_things_sparks2_start;
    ramdisk_data[125].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[126].data = data_things_sparks3_start;
    ramdisk_data[126].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[127].data = data_things_sword1_start;
    ramdisk_data[127].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[128].data = data_things_sword1_anim_start;
    ramdisk_data[128].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[129].data = data_things_sword2_start;
    ramdisk_data[129].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[130].data = data_things_sword2_anim_start;
    ramdisk_data[130].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[131].data = data_things_sword3_start;
    ramdisk_data[131].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[132].data = data_things_sword3_anim_start;
    ramdisk_data[132].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[133].data = data_things_valkyrie_start;
    ramdisk_data[133].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[134].data = data_things_wall1_start;
    ramdisk_data[134].len = data_things_wall1_end - data_things_wall1_start;
    ...
    ramdisk_data[139].data = data_things_wall6_start;
    ramdisk_data[139].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[140].data = data_things_wand1_anim_start;
    ramdisk_data[140].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ...
    ramdisk_data[145].data = data_things_weapon_swing1_start;
    ramdisk_data[145].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
