...
void ramdisk_init (void)
{
    ...
    ramdisk_data[30].data = data_things__amulet1_session_start;
    ramdisk_data[30].len = data_things__amulet1_session_end - data_things__amulet1_session_start;
    ramdisk_data[31].data = data_things__chest1_session_start;
    ramdisk_data[31].len = data_things__chest1_session_end - data_things__chest1_session_start;
    ramdisk_data[32].data = data_things__door_session_start;
    ramdisk_data[32].len = data_things__door_session_end - data_things__door_session_start;
    ramdisk_data[33].data = data_things__floor_session_start;
    ramdisk_data[33].len = data_things__floor_session_end - data_things__floor_session_start;
    ramdisk_data[34].data = data_things__floor1_session_start;
    ramdisk_data[34].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[35].data = data_things__floor2_session_start;
    ramdisk_data[35].len = data_things__floor2_session_end - data_things__floor2_session_start;
    ramdisk_data[36].data = data_things__floor3_session_start;
    ramdisk_data[36].len = data_things__floor3_session_end - data_things__floor3_session_start;
    ramdisk_data[37].data = data_things__floor4_session_start;
    ramdisk_data[37].len = data_things__floor4_session_end - data_things__floor4_session_start;
    ramdisk_data[38].data = data_things__floor5_session_start;
    ramdisk_data[38].len = data_things__floor5_session_end - data_things__floor5_session_start;
    ramdisk_data[39].data = data_things__floor6_session_start;
    ramdisk_data[39].len = data_things__floor6_session_end - data_things__floor6_session_start;
    ramdisk_data[40].data = data_things__food_session_start;
    ramdisk_data[40].len = data_things__food_session_end - data_things__food_session_start;
    ramdisk_data[41].data = data_things__food2_session_start;
    ramdisk_data[41].len = data_things__food2_session_end - data_things__food2_session_start;
    ramdisk_data[42].data = data_things__gem1_session_start;
    ramdisk_data[42].len = data_things__gem1_session_end - data_things__gem1_session_start;
    ramdisk_data[43].data = data_things__gem7_session_start;
    ramdisk_data[43].len = data_things__gem7_session_end - data_things__gem7_session_start;
    ramdisk_data[44].data = data_things__generator1_session_start;
    ramdisk_data[44].len = data_things__generator1_session_end - data_things__generator1_session_start;
    ramdisk_data[45].data = data_things__generator3_session_start;
    ramdisk_data[45].len = data_things__generator3_session_end - data_things__generator3_session_start;
    ...
    ramdisk_data[53].data = data_things__player_session_start;
    ramdisk_data[53].len = data_things__player_session_end - data_things__player_session_start;
    ramdisk_data[54].data = data_things__potion1_session_start;
    ramdisk_data[54].len = data_things__potion1_session_end - data_things__potion1_session_start;
    ramdisk_data[55].data = data_things__potion5_session_start;
    ramdisk_data[55].len = data_things__potion5_session_end - data_things__potion5_session_start;
    ramdisk_data[56].data = data_things__rock_0_session_start;
    ramdisk_data[56].len = data_things__rock_0_session_end - data_things__rock_0_session_start;
    ramdisk_data[57].data = data_things__rock_1_session_start;
    ramdisk_data[57].len = data_things__rock_1_session_end - data_things__rock_1_session_start;
    ...
    ramdisk_data[59].data = data_things__treasure_session_start;
    ramdisk_data[59].len = data_things__treasure_session_end - data_things__treasure_session_start;
    ramdisk_data[60].data = data_things__wall_session_start;
    ramdisk_data[60].len = data_things__wall_session_end - data_things__wall_session_start;
    ramdisk_data[61].data = data_things__wall2_session_start;
    ramdisk_data[61].len = data_things__wall2_session_end - data_things__wall2_session_start;
    ramdisk_data[62].data = data_things__water_session_start;
    ramdisk_data[62].len = data_things__water_session_end - data_things__water_session_start;
    ramdisk_data[63].data = data_things__water1_session_start;
    ramdisk_data[63].len = data_things__water1_session_end - data_things__water1_session_start;
    ramdisk_data[64].data = data_things__water2_session_start;
    ramdisk_data[64].len = data_things__water2_session_end - data_things__water2_session_start;
    ramdisk_data[65].data = data_things_amulet1_start;
    ramdisk_data[65].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[66].data = data_things_bomb_start;
    ramdisk_data[66].len = data_things_bomb_end - data_things_bomb_start;
    ...
    ramdisk_data[69].data = data_things_door_start;
    ramdisk_data[69].len = data_things_door_end - data_things_door_start;
    ramdisk_data[70].data = data_things_exit_start;
    ramdisk_data[70].len = data_things_exit_end - data_things_exit_start;
    ...
    ramdisk_data[78].data = data_things_explosion_start;
    ramdisk_data[78].len = data_things_explosion_end - data_things_explosion_start;
    ...
    ramdisk_data[109].data = data_things_player_start;
    ramdisk_data[109].len = data_things_player_end - data_things_player_start;
    ...
    ramdisk_data[122].data = data_things_water1_start;
    ramdisk_data[122].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[123].data = data_things_water2_start;
    ramdisk_data[123].len = data_things_water2_end - data_things_water2_start;
    ramdisk_data[124].data = data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[124].len = data_ttf_large_ttf_pointsize50_data_end - data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[125].data = data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[125].len = data_ttf_large_ttf_pointsize50_tga_end - data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[126].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[126].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[127].data = data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[127].len = data_ttf_med_ttf_pointsize40_data_end - data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[128].data = data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[128].len = data_ttf_med_ttf_pointsize40_tga_end - data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[129].data = data_ttf_Readme_txt_start;
    ramdisk_data[129].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
    ...
    ramdisk_data[131].data = data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[131].len = data_ttf_small_ttf_pointsize10_tga_end - data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[132].data = data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[132].len = data_ttf_small_ttf_pointsize15_data_end - data_ttf_small_ttf_pointsize15_data_start;
    ...
    ramdisk_data[134].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[134].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[135].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[135].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
