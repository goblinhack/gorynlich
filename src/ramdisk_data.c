...
void ramdisk_init (void)
{
    ...
    ramdisk_data[25].data = data_map__jigsaw_map_swp_start;
    ramdisk_data[25].len = data_map__jigsaw_map_swp_end - data_map__jigsaw_map_swp_start;
    ramdisk_data[26].data = data_map_jigsaw_map_start;
    ramdisk_data[26].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[27].data = data_map_map_light_data_start;
    ramdisk_data[27].len = data_map_map_light_data_end - data_map_map_light_data_start;
    ramdisk_data[28].data = data_map_tile_map_start;
    ramdisk_data[28].len = data_map_tile_map_end - data_map_tile_map_start;
    ramdisk_data[29].data = data_music_hiscore_wav_start;
    ramdisk_data[29].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[30].data = data_music_intro_wav_start;
    ramdisk_data[30].len = data_music_intro_wav_end - data_music_intro_wav_start;
    ramdisk_data[31].data = data_music_music_wav_start;
    ramdisk_data[31].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[32].data = data_sound_chomp_wav_start;
    ramdisk_data[32].len = data_sound_chomp_wav_end - data_sound_chomp_wav_start;
    ramdisk_data[33].data = data_sound_chomp2_wav_start;
    ramdisk_data[33].len = data_sound_chomp2_wav_end - data_sound_chomp2_wav_start;
    ramdisk_data[34].data = data_sound_click_wav_start;
    ramdisk_data[34].len = data_sound_click_wav_end - data_sound_click_wav_start;
    ramdisk_data[35].data = data_sound_doorbell_wav_start;
    ramdisk_data[35].len = data_sound_doorbell_wav_end - data_sound_doorbell_wav_start;
    ramdisk_data[36].data = data_sound_explosion_wav_start;
    ramdisk_data[36].len = data_sound_explosion_wav_end - data_sound_explosion_wav_start;
    ramdisk_data[37].data = data_sound_letter_wav_start;
    ramdisk_data[37].len = data_sound_letter_wav_end - data_sound_letter_wav_start;
    ramdisk_data[38].data = data_sound_level_end_wav_start;
    ramdisk_data[38].len = data_sound_level_end_wav_end - data_sound_level_end_wav_start;
    ramdisk_data[39].data = data_sound_paper_wav_start;
    ramdisk_data[39].len = data_sound_paper_wav_end - data_sound_paper_wav_start;
    ramdisk_data[40].data = data_sound_powerup_wav_start;
    ramdisk_data[40].len = data_sound_powerup_wav_end - data_sound_powerup_wav_start;
    ramdisk_data[41].data = data_sound_ratdeath_wav_start;
    ramdisk_data[41].len = data_sound_ratdeath_wav_end - data_sound_ratdeath_wav_start;
    ramdisk_data[42].data = data_sound_rocket_wav_start;
    ramdisk_data[42].len = data_sound_rocket_wav_end - data_sound_rocket_wav_start;
    ramdisk_data[43].data = data_sound_slime_wav_start;
    ramdisk_data[43].len = data_sound_slime_wav_end - data_sound_slime_wav_start;
    ramdisk_data[44].data = data_sound_spam_wav_start;
    ramdisk_data[44].len = data_sound_spam_wav_end - data_sound_spam_wav_start;
    ramdisk_data[45].data = data_sound_thief_wav_start;
    ramdisk_data[45].len = data_sound_thief_wav_end - data_sound_thief_wav_start;
    ramdisk_data[46].data = data_things_brick_0_start;
    ramdisk_data[46].len = data_things_brick_0_end - data_things_brick_0_start;
    ramdisk_data[47].data = data_things_brick_1_start;
    ramdisk_data[47].len = data_things_brick_1_end - data_things_brick_1_start;
    ramdisk_data[48].data = data_things_brick_2_start;
    ramdisk_data[48].len = data_things_brick_2_end - data_things_brick_2_start;
    ramdisk_data[49].data = data_things_brick_3_start;
    ramdisk_data[49].len = data_things_brick_3_end - data_things_brick_3_start;
    ramdisk_data[50].data = data_things_brick_4_start;
    ramdisk_data[50].len = data_things_brick_4_end - data_things_brick_4_start;
    ramdisk_data[51].data = data_things_brick_5_start;
    ramdisk_data[51].len = data_things_brick_5_end - data_things_brick_5_start;
    ramdisk_data[52].data = data_things_brick_6_start;
    ramdisk_data[52].len = data_things_brick_6_end - data_things_brick_6_start;
    ramdisk_data[53].data = data_things_brick_7_start;
    ramdisk_data[53].len = data_things_brick_7_end - data_things_brick_7_start;
    ramdisk_data[54].data = data_things_brick_8_start;
    ramdisk_data[54].len = data_things_brick_8_end - data_things_brick_8_start;
    ramdisk_data[55].data = data_things_lava_0_start;
    ramdisk_data[55].len = data_things_lava_0_end - data_things_lava_0_start;
    ramdisk_data[56].data = data_things_rock_0_start;
    ramdisk_data[56].len = data_things_rock_0_end - data_things_rock_0_start;
    ramdisk_data[57].data = data_things_water_0_start;
    ramdisk_data[57].len = data_things_water_0_end - data_things_water_0_start;
    ramdisk_data[58].data = data_ttf_large_ttf_pointsize40_data_start;
    ramdisk_data[58].len = data_ttf_large_ttf_pointsize40_data_end - data_ttf_large_ttf_pointsize40_data_start;
    ramdisk_data[59].data = data_ttf_large_ttf_pointsize40_tga_start;
    ramdisk_data[59].len = data_ttf_large_ttf_pointsize40_tga_end - data_ttf_large_ttf_pointsize40_tga_start;
    ...
    ramdisk_data[62].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[62].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[63].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[63].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
