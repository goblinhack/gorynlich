...
void ramdisk_init (void)
{
    ...
    ramdisk_data[80].data = data_things__bread_session_start;
    ramdisk_data[80].len = data_things__bread_session_end - data_things__bread_session_start;
    ramdisk_data[81].data = data_things__coins1_session_start;
    ramdisk_data[81].len = data_things__coins1_session_end - data_things__coins1_session_start;
    ramdisk_data[82].data = data_things__death_session_start;
    ramdisk_data[82].len = data_things__death_session_end - data_things__death_session_start;
    ramdisk_data[83].data = data_things__dwarf_session_start;
    ramdisk_data[83].len = data_things__dwarf_session_end - data_things__dwarf_session_start;
    ramdisk_data[84].data = data_things__key_session_start;
    ramdisk_data[84].len = data_things__key_session_end - data_things__key_session_start;
    ramdisk_data[85].data = data_things__potion_life_session_start;
    ramdisk_data[85].len = data_things__potion_life_session_end - data_things__potion_life_session_start;
    ramdisk_data[86].data = data_things__sword1_session_start;
    ramdisk_data[86].len = data_things__sword1_session_end - data_things__sword1_session_start;
    ramdisk_data[87].data = data_things__sword2_session_start;
    ramdisk_data[87].len = data_things__sword2_session_end - data_things__sword2_session_start;
    ramdisk_data[88].data = data_things__thing_h_session_start;
    ramdisk_data[88].len = data_things__thing_h_session_end - data_things__thing_h_session_start;
    ramdisk_data[89].data = data_things__thing_template_h_session_start;
    ramdisk_data[89].len = data_things__thing_template_h_session_end - data_things__thing_template_h_session_start;
    ramdisk_data[90].data = data_things__torches_session_start;
    ramdisk_data[90].len = data_things__torches_session_end - data_things__torches_session_start;
    ramdisk_data[91].data = data_things__valkyrie_session_start;
    ramdisk_data[91].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[92].data = data_things__wand_session_start;
    ramdisk_data[92].len = data_things__wand_session_end - data_things__wand_session_start;
    ramdisk_data[93].data = data_things__warrior_session_start;
    ramdisk_data[93].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[94].data = data_things__water_session_start;
    ramdisk_data[94].len = data_things__water_session_end - data_things__water_session_start;
    ramdisk_data[95].data = data_things__water_poison_session_start;
    ramdisk_data[95].len = data_things__water_poison_session_end - data_things__water_poison_session_start;
    ...
    ramdisk_data[98].data = data_things_anim_eyes_start;
    ramdisk_data[98].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[99].data = data_things_anim_man_start;
    ramdisk_data[99].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[100].data = data_things_anim_treasure_chest_start;
    ramdisk_data[100].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ramdisk_data[101].data = data_things_apple1_start;
    ramdisk_data[101].len = data_things_apple1_end - data_things_apple1_start;
    ramdisk_data[102].data = data_things_apple2_start;
    ramdisk_data[102].len = data_things_apple2_end - data_things_apple2_start;
    ramdisk_data[103].data = data_things_arrow_start;
    ramdisk_data[103].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[104].data = data_things_axe1_start;
    ramdisk_data[104].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[105].data = data_things_axe1_anim_start;
    ramdisk_data[105].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[106].data = data_things_axe2_start;
    ramdisk_data[106].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[107].data = data_things_axe2_anim_start;
    ramdisk_data[107].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[108].data = data_things_banana_start;
    ramdisk_data[108].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[109].data = data_things_blood1_start;
    ramdisk_data[109].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[110].data = data_things_blood2_start;
    ramdisk_data[110].len = data_things_blood2_end - data_things_blood2_start;
    ramdisk_data[111].data = data_things_bonepile1_start;
    ramdisk_data[111].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[112].data = data_things_bonepile2_start;
    ramdisk_data[112].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[113].data = data_things_bonepile3_start;
    ramdisk_data[113].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[114].data = data_things_bow1_start;
    ramdisk_data[114].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[115].data = data_things_bow1_anim_start;
    ramdisk_data[115].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[116].data = data_things_bow2_start;
    ramdisk_data[116].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[117].data = data_things_bow3_start;
    ramdisk_data[117].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[118].data = data_things_bow4_start;
    ramdisk_data[118].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[119].data = data_things_brazier_start;
    ramdisk_data[119].len = data_things_brazier_end - data_things_brazier_start;
    ramdisk_data[120].data = data_things_bread_start;
    ramdisk_data[120].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[121].data = data_things_cheese_start;
    ramdisk_data[121].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[122].data = data_things_chest1_start;
    ramdisk_data[122].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[123].data = data_things_cloudkill1_start;
    ramdisk_data[123].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[124].data = data_things_cloudkill2_start;
    ramdisk_data[124].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[125].data = data_things_cloudkill3_start;
    ramdisk_data[125].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[126].data = data_things_cloudkill4_start;
    ramdisk_data[126].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[127].data = data_things_coins1_start;
    ramdisk_data[127].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[128].data = data_things_death_start;
    ramdisk_data[128].len = data_things_death_end - data_things_death_start;
    ...
    ramdisk_data[165].data = data_things_hit_miss_start;
    ramdisk_data[165].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[166].data = data_things_hit_success_start;
    ramdisk_data[166].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[167].data = data_things_key_start;
    ramdisk_data[167].len = data_things_key_end - data_things_key_start;
    ramdisk_data[168].data = data_things_keys2_start;
    ramdisk_data[168].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[169].data = data_things_keys3_start;
    ramdisk_data[169].len = data_things_keys3_end - data_things_keys3_start;
    ...
    ramdisk_data[172].data = data_things_poison1_start;
    ramdisk_data[172].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[173].data = data_things_poison2_start;
    ramdisk_data[173].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[174].data = data_things_poison3_start;
    ramdisk_data[174].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[175].data = data_things_poison4_start;
    ramdisk_data[175].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[176].data = data_things_potion_cloudkill_start;
    ramdisk_data[176].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[177].data = data_things_potion_fire_start;
    ramdisk_data[177].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[178].data = data_things_potion_life_start;
    ramdisk_data[178].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[179].data = data_things_potion_monsticide_start;
    ramdisk_data[179].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[180].data = data_things_potion_shield_start;
    ramdisk_data[180].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[181].data = data_things_ring1_start;
    ramdisk_data[181].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[182].data = data_things_ring2_start;
    ramdisk_data[182].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[183].data = data_things_ring3_start;
    ramdisk_data[183].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[184].data = data_things_rock1_start;
    ramdisk_data[184].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[185].data = data_things_scythe1_start;
    ramdisk_data[185].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[186].data = data_things_scythe1_anim_start;
    ramdisk_data[186].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[187].data = data_things_spam_start;
    ramdisk_data[187].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[188].data = data_things_sword1_start;
    ramdisk_data[188].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[189].data = data_things_sword1_anim_start;
    ramdisk_data[189].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[190].data = data_things_sword2_start;
    ramdisk_data[190].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[191].data = data_things_sword2_anim_start;
    ramdisk_data[191].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[192].data = data_things_sword3_start;
    ramdisk_data[192].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[193].data = data_things_sword3_anim_start;
    ramdisk_data[193].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[194].data = data_things_torch_start;
    ramdisk_data[194].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[195].data = data_things_torches_start;
    ramdisk_data[195].len = data_things_torches_end - data_things_torches_start;
    ramdisk_data[196].data = data_things_valkyrie_start;
    ramdisk_data[196].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[197].data = data_things_wall1_start;
    ramdisk_data[197].len = data_things_wall1_end - data_things_wall1_start;
    ramdisk_data[198].data = data_things_wall2_start;
    ramdisk_data[198].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[199].data = data_things_wall3_start;
    ramdisk_data[199].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[200].data = data_things_wall4_start;
    ramdisk_data[200].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[201].data = data_things_wall5_start;
    ramdisk_data[201].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[202].data = data_things_wall6_start;
    ramdisk_data[202].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[203].data = data_things_wand1_anim_start;
    ramdisk_data[203].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ramdisk_data[204].data = data_things_wand_fire_start;
    ramdisk_data[204].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[205].data = data_things_warrior_start;
    ramdisk_data[205].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[206].data = data_things_water_start;
    ramdisk_data[206].len = data_things_water_end - data_things_water_start;
    ramdisk_data[207].data = data_things_water_poison_start;
    ramdisk_data[207].len = data_things_water_poison_end - data_things_water_poison_start;
    ramdisk_data[208].data = data_things_weapon_swing1_start;
    ramdisk_data[208].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[209].data = data_things_wizard_start;
    ramdisk_data[209].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[210].data = data_ttf_emulogic_gif_start;
    ramdisk_data[210].len = data_ttf_emulogic_gif_end - data_ttf_emulogic_gif_start;
    ramdisk_data[211].data = data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[211].len = data_ttf_emulogic_ttf_pointsize10_data_end - data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[212].data = data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[212].len = data_ttf_emulogic_ttf_pointsize10_tga_end - data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[213].data = data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[213].len = data_ttf_emulogic_ttf_pointsize11_data_end - data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[214].data = data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[214].len = data_ttf_emulogic_ttf_pointsize11_tga_end - data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[215].data = data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[215].len = data_ttf_emulogic_ttf_pointsize12_data_end - data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[216].data = data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[216].len = data_ttf_emulogic_ttf_pointsize12_tga_end - data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[217].data = data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[217].len = data_ttf_emulogic_ttf_pointsize14_data_end - data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[218].data = data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[218].len = data_ttf_emulogic_ttf_pointsize14_tga_end - data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[219].data = data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[219].len = data_ttf_emulogic_ttf_pointsize15_data_end - data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[220].data = data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[220].len = data_ttf_emulogic_ttf_pointsize15_tga_end - data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[221].data = data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[221].len = data_ttf_emulogic_ttf_pointsize16_data_end - data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[222].data = data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[222].len = data_ttf_emulogic_ttf_pointsize16_tga_end - data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[223].data = data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[223].len = data_ttf_emulogic_ttf_pointsize17_data_end - data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[224].data = data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[224].len = data_ttf_emulogic_ttf_pointsize17_tga_end - data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[225].data = data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[225].len = data_ttf_emulogic_ttf_pointsize18_data_end - data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[226].data = data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[226].len = data_ttf_emulogic_ttf_pointsize18_tga_end - data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[227].data = data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[227].len = data_ttf_emulogic_ttf_pointsize19_data_end - data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[228].data = data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[228].len = data_ttf_emulogic_ttf_pointsize19_tga_end - data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[229].data = data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[229].len = data_ttf_emulogic_ttf_pointsize20_data_end - data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[230].data = data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[230].len = data_ttf_emulogic_ttf_pointsize20_tga_end - data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[231].data = data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[231].len = data_ttf_emulogic_ttf_pointsize21_data_end - data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[232].data = data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[232].len = data_ttf_emulogic_ttf_pointsize21_tga_end - data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[233].data = data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[233].len = data_ttf_emulogic_ttf_pointsize22_data_end - data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[234].data = data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[234].len = data_ttf_emulogic_ttf_pointsize22_tga_end - data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[235].data = data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[235].len = data_ttf_emulogic_ttf_pointsize23_data_end - data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[236].data = data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[236].len = data_ttf_emulogic_ttf_pointsize23_tga_end - data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[237].data = data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[237].len = data_ttf_emulogic_ttf_pointsize24_data_end - data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[238].data = data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[238].len = data_ttf_emulogic_ttf_pointsize24_tga_end - data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[239].data = data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[239].len = data_ttf_emulogic_ttf_pointsize25_data_end - data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[240].data = data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[240].len = data_ttf_emulogic_ttf_pointsize25_tga_end - data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[241].data = data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[241].len = data_ttf_emulogic_ttf_pointsize26_data_end - data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[242].data = data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[242].len = data_ttf_emulogic_ttf_pointsize26_tga_end - data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[243].data = data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[243].len = data_ttf_emulogic_ttf_pointsize28_data_end - data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[244].data = data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[244].len = data_ttf_emulogic_ttf_pointsize28_tga_end - data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[245].data = data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[245].len = data_ttf_emulogic_ttf_pointsize30_data_end - data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[246].data = data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[246].len = data_ttf_emulogic_ttf_pointsize30_tga_end - data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[247].data = data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[247].len = data_ttf_emulogic_ttf_pointsize32_data_end - data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[248].data = data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[248].len = data_ttf_emulogic_ttf_pointsize32_tga_end - data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[249].data = data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[249].len = data_ttf_emulogic_ttf_pointsize36_data_end - data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[250].data = data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[250].len = data_ttf_emulogic_ttf_pointsize36_tga_end - data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[251].data = data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[251].len = data_ttf_emulogic_ttf_pointsize6_data_end - data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[252].data = data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[252].len = data_ttf_emulogic_ttf_pointsize6_tga_end - data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[253].data = data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[253].len = data_ttf_emulogic_ttf_pointsize7_data_end - data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[254].data = data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[254].len = data_ttf_emulogic_ttf_pointsize7_tga_end - data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[255].data = data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[255].len = data_ttf_emulogic_ttf_pointsize8_data_end - data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[256].data = data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[256].len = data_ttf_emulogic_ttf_pointsize8_tga_end - data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[257].data = data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[257].len = data_ttf_emulogic_ttf_pointsize9_data_end - data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[258].data = data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[258].len = data_ttf_emulogic_ttf_pointsize9_tga_end - data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[259].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[259].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[260].data = data_ttf_Metamorphous_Regular_ttf_pointsize10_data_start;
    ramdisk_data[260].len = data_ttf_Metamorphous_Regular_ttf_pointsize10_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize10_data_start;
    ramdisk_data[261].data = data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_start;
    ramdisk_data[261].len = data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_start;
    ramdisk_data[262].data = data_ttf_Metamorphous_Regular_ttf_pointsize12_data_start;
    ramdisk_data[262].len = data_ttf_Metamorphous_Regular_ttf_pointsize12_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize12_data_start;
    ramdisk_data[263].data = data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_start;
    ramdisk_data[263].len = data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_start;
    ramdisk_data[264].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start;
    ramdisk_data[264].len = data_ttf_Metamorphous_Regular_ttf_pointsize14_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start;
    ramdisk_data[265].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start;
    ramdisk_data[265].len = data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start;
    ramdisk_data[266].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start;
    ramdisk_data[266].len = data_ttf_Metamorphous_Regular_ttf_pointsize16_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start;
    ramdisk_data[267].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start;
    ramdisk_data[267].len = data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start;
    ramdisk_data[268].data = data_ttf_Metamorphous_Regular_ttf_pointsize20_data_start;
    ramdisk_data[268].len = data_ttf_Metamorphous_Regular_ttf_pointsize20_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize20_data_start;
    ramdisk_data[269].data = data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_start;
    ramdisk_data[269].len = data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_start;
    ramdisk_data[270].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start;
    ramdisk_data[270].len = data_ttf_Metamorphous_Regular_ttf_pointsize22_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start;
    ramdisk_data[271].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start;
    ramdisk_data[271].len = data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start;
    ramdisk_data[272].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start;
    ramdisk_data[272].len = data_ttf_Metamorphous_Regular_ttf_pointsize24_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start;
    ramdisk_data[273].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start;
    ramdisk_data[273].len = data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start;
    ramdisk_data[274].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start;
    ramdisk_data[274].len = data_ttf_Metamorphous_Regular_ttf_pointsize28_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start;
    ramdisk_data[275].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start;
    ramdisk_data[275].len = data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start;
    ramdisk_data[276].data = data_ttf_OFL_txt_start;
    ramdisk_data[276].len = data_ttf_OFL_txt_end - data_ttf_OFL_txt_start;
    ramdisk_data[277].data = data_ttf_Readme_txt_start;
    ramdisk_data[277].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
}
