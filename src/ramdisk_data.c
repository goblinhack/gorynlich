...
void ramdisk_init (void)
{
    ...
    ramdisk_data[242].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start;
    ramdisk_data[242].len = data_ttf_Metamorphous_Regular_ttf_pointsize14_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start;
    ramdisk_data[243].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start;
    ramdisk_data[243].len = data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start;
    ramdisk_data[244].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start;
    ramdisk_data[244].len = data_ttf_Metamorphous_Regular_ttf_pointsize16_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start;
    ramdisk_data[245].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start;
    ramdisk_data[245].len = data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start;
    ramdisk_data[246].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start;
    ramdisk_data[246].len = data_ttf_Metamorphous_Regular_ttf_pointsize22_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start;
    ramdisk_data[247].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start;
    ramdisk_data[247].len = data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start;
    ramdisk_data[248].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start;
    ramdisk_data[248].len = data_ttf_Metamorphous_Regular_ttf_pointsize24_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start;
    ramdisk_data[249].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start;
    ramdisk_data[249].len = data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start;
    ramdisk_data[250].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start;
    ramdisk_data[250].len = data_ttf_Metamorphous_Regular_ttf_pointsize28_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start;
    ramdisk_data[251].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start;
    ramdisk_data[251].len = data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start;
    ramdisk_data[252].data = data_ttf_OFL_txt_start;
    ramdisk_data[252].len = data_ttf_OFL_txt_end - data_ttf_OFL_txt_start;
