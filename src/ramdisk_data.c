...
void ramdisk_init (void)
{
    ...
    ramdisk_data[68].data = data_gfx_gorynlich_png_start;
    ramdisk_data[68].len = data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start;
    ramdisk_data[69].data = data_gfx_sprites_small_png_start;
    ramdisk_data[69].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[70].data = data_gfx_title3_png_start;
    ramdisk_data[70].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ramdisk_data[71].data = data_gfx_title2_png_start;
    ramdisk_data[71].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[72].data = data_gfx_help2_png_start;
    ramdisk_data[72].len = data_gfx_help2_png_end - data_gfx_help2_png_start;
    ramdisk_data[73].data = data_gfx_rat_png_start;
    ramdisk_data[73].len = data_gfx_rat_png_end - data_gfx_rat_png_start;
    ramdisk_data[74].data = data_gfx_dragon_png_start;
    ramdisk_data[74].len = data_gfx_dragon_png_end - data_gfx_dragon_png_start;
    ramdisk_data[75].data = data_gfx_title_png_start;
    ramdisk_data[75].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[76].data = data_levels_2_start;
    ramdisk_data[76].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[77].data = data_levels_1_start;
    ramdisk_data[77].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[78].data = data_things_explosion6_start;
    ramdisk_data[78].len = data_things_explosion6_end - data_things_explosion6_start;
    ramdisk_data[79].data = data_things_exit5_start;
    ramdisk_data[79].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[80].data = data_things_plant_start;
    ramdisk_data[80].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[81].data = data_things_dwarf_start;
    ramdisk_data[81].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[82].data = data_things_generator7_start;
    ramdisk_data[82].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[83].data = data_things_exit2_start;
    ramdisk_data[83].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[84].data = data_things_ghost2_start;
    ramdisk_data[84].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[85].data = data_things_gem3_start;
    ramdisk_data[85].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[86].data = data_things_water2_start;
    ramdisk_data[86].len = data_things_water2_end - data_things_water2_start;
    ramdisk_data[87].data = data_things_wall2_start;
    ramdisk_data[87].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[88].data = data_things_gem6_start;
    ramdisk_data[88].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[89].data = data_things_explosion8_start;
    ramdisk_data[89].len = data_things_explosion8_end - data_things_explosion8_start;
    ramdisk_data[90].data = data_things_explosion1_start;
    ramdisk_data[90].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[91].data = data_things_amulet1_start;
    ramdisk_data[91].len = data_things_amulet1_end - data_things_amulet1_start;
    ...
    ramdisk_data[96].data = data_things_gem7_start;
    ramdisk_data[96].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[97].data = data_things_chest1_start;
    ramdisk_data[97].len = data_things_chest1_end - data_things_chest1_start;
    ...
    ramdisk_data[102].data = data_things_potion_fire_start;
    ramdisk_data[102].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[103].data = data_things_keys2_start;
    ramdisk_data[103].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[104].data = data_things_door_start;
    ramdisk_data[104].len = data_things_door_end - data_things_door_start;
    ...
    ramdisk_data[107].data = data_things_warrior_start;
    ramdisk_data[107].len = data_things_warrior_end - data_things_warrior_start;
    ...
    ramdisk_data[112].data = data_things_water1_start;
    ramdisk_data[112].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[113].data = data_things_poison8_start;
    ramdisk_data[113].len = data_things_poison8_end - data_things_poison8_start;
    ramdisk_data[114].data = data_things_arrow_start;
    ramdisk_data[114].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[115].data = data_things_poison1_start;
    ramdisk_data[115].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[116].data = data_things_generator5_start;
    ramdisk_data[116].len = data_things_generator5_end - data_things_generator5_start;
    ...
    ramdisk_data[120].data = data_things_valkyrie_start;
    ramdisk_data[120].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[121].data = data_things_elf_start;
    ramdisk_data[121].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[122].data = data_things_mask2_start;
    ramdisk_data[122].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[123].data = data_things_wall4_start;
    ramdisk_data[123].len = data_things_wall4_end - data_things_wall4_start;
    ...
    ramdisk_data[126].data = data_things_bomb_start;
    ramdisk_data[126].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[127].data = data_things_exit3_start;
    ramdisk_data[127].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[128].data = data_things_exit_start;
    ramdisk_data[128].len = data_things_exit_end - data_things_exit_start;
    ramdisk_data[129].data = data_things_coins1_start;
    ramdisk_data[129].len = data_things_coins1_end - data_things_coins1_start;
    ...
    ramdisk_data[132].data = data_things_death_start;
    ramdisk_data[132].len = data_things_death_end - data_things_death_start;
    ramdisk_data[133].data = data_things_ghost1_start;
    ramdisk_data[133].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[134].data = data_things_demon_start;
    ramdisk_data[134].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[135].data = data_things_poison5_start;
    ramdisk_data[135].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[136].data = data_things_ghost3_start;
    ramdisk_data[136].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[137].data = data_things_generator2_start;
    ramdisk_data[137].len = data_things_generator2_end - data_things_generator2_start;
    ramdisk_data[138].data = data_things_floor5_start;
    ramdisk_data[138].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[139].data = data_things_generator4_start;
    ramdisk_data[139].len = data_things_generator4_end - data_things_generator4_start;
    ramdisk_data[140].data = data_things_wall_start;
    ramdisk_data[140].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[141].data = data_things_poison6_start;
    ramdisk_data[141].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[142].data = data_things_poison7_start;
    ramdisk_data[142].len = data_things_poison7_end - data_things_poison7_start;
    ...
    ramdisk_data[144].data = data_things_mask3_start;
    ramdisk_data[144].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[145].data = data_things_fireball_start;
    ramdisk_data[145].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[146].data = data_things_potion_shield_start;
    ramdisk_data[146].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[147].data = data_things_explosion3_start;
    ramdisk_data[147].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[148].data = data_things_poison2_start;
    ramdisk_data[148].len = data_things_poison2_end - data_things_poison2_start;
    ...
    ramdisk_data[151].data = data_things_explosion_start;
    ramdisk_data[151].len = data_things_explosion_end - data_things_explosion_start;
    ...
    ramdisk_data[156].data = data_things_potion_death_start;
    ramdisk_data[156].len = data_things_potion_death_end - data_things_potion_death_start;
    ramdisk_data[157].data = data_things_explosion7_start;
    ramdisk_data[157].len = data_things_explosion7_end - data_things_explosion7_start;
    ramdisk_data[158].data = data_things_food_start;
    ramdisk_data[158].len = data_things_food_end - data_things_food_start;
    ...
    ramdisk_data[163].data = data_things_mask1_start;
    ramdisk_data[163].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[164].data = data_things_gem4_start;
    ramdisk_data[164].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[165].data = data_things_generator3_start;
    ramdisk_data[165].len = data_things_generator3_end - data_things_generator3_start;
    ramdisk_data[166].data = data_things_bow1_start;
    ramdisk_data[166].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[167].data = data_things_floor_start;
    ramdisk_data[167].len = data_things_floor_end - data_things_floor_start;
    ramdisk_data[168].data = data_things_poison4_start;
    ramdisk_data[168].len = data_things_poison4_end - data_things_poison4_start;
    ...
    ramdisk_data[171].data = data_map_jigsaw_map_start;
    ramdisk_data[171].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[172].data = data_map_map_light_data_start;
    ramdisk_data[172].len = data_map_map_light_data_end - data_map_map_light_data_start;
    ramdisk_data[173].data = data_music_hiscore_wav_start;
    ramdisk_data[173].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[174].data = data_music_music_wav_start;
    ramdisk_data[174].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[175].data = data_music_intro_wav_start;
    ramdisk_data[175].len = data_music_intro_wav_end - data_music_intro_wav_start;
}
