...
extern unsigned char *data_things__bow3_session_start_ asm("data_things__bow3_session_start_");
extern unsigned char *data_things__bow3_session_end_ asm("data_things__bow3_session_end_");
static const unsigned char *const data_things__bow3_session_start =
    (const unsigned char *const) (char*)&data_things__bow3_session_start_;
static const unsigned char *const data_things__bow3_session_end   =
    (const unsigned char *const) (char*)&data_things__bow3_session_end_;

extern unsigned char *data_things__bow4_session_start_ asm("data_things__bow4_session_start_");
extern unsigned char *data_things__bow4_session_end_ asm("data_things__bow4_session_end_");
static const unsigned char *const data_things__bow4_session_start =
    (const unsigned char *const) (char*)&data_things__bow4_session_start_;
static const unsigned char *const data_things__bow4_session_end   =
    (const unsigned char *const) (char*)&data_things__bow4_session_end_;
...
extern unsigned char *data_things__splat_session_start_ asm("data_things__splat_session_start_");
extern unsigned char *data_things__splat_session_end_ asm("data_things__splat_session_end_");
static const unsigned char *const data_things__splat_session_start =
    (const unsigned char *const) (char*)&data_things__splat_session_start_;
static const unsigned char *const data_things__splat_session_end   =
    (const unsigned char *const) (char*)&data_things__splat_session_end_;
...
{
    /* filename */ "data/things/.bow3.session",
},
{
    /* filename */ "data/things/.bow4.session",
},
{
...
{
    /* filename */ "data/things/.splat.session",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[37].data = data_things__bow3_session_start;
    ramdisk_data[37].len = data_things__bow3_session_end - data_things__bow3_session_start;
    ramdisk_data[38].data = data_things__bow4_session_start;
    ramdisk_data[38].len = data_things__bow4_session_end - data_things__bow4_session_start;
    ramdisk_data[39].data = data_things__elf_session_start;
    ramdisk_data[39].len = data_things__elf_session_end - data_things__elf_session_start;
    ramdisk_data[40].data = data_things__gem1_session_start;
    ramdisk_data[40].len = data_things__gem1_session_end - data_things__gem1_session_start;
    ramdisk_data[41].data = data_things__potion1_session_start;
    ramdisk_data[41].len = data_things__potion1_session_end - data_things__potion1_session_start;
    ramdisk_data[42].data = data_things__splat_session_start;
    ramdisk_data[42].len = data_things__splat_session_end - data_things__splat_session_start;
    ...
    ramdisk_data[44].data = data_things__wand_fire_session_start;
    ramdisk_data[44].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[45].data = data_things__warrior_session_start;
    ramdisk_data[45].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[46].data = data_things__water2_session_start;
    ramdisk_data[46].len = data_things__water2_session_end - data_things__water2_session_start;
    ...
    ramdisk_data[114].data = data_things_potion1_start;
    ramdisk_data[114].len = data_things_potion1_end - data_things_potion1_start;
    ramdisk_data[115].data = data_things_potion2_start;
    ramdisk_data[115].len = data_things_potion2_end - data_things_potion2_start;
    ramdisk_data[116].data = data_things_potion3_start;
    ramdisk_data[116].len = data_things_potion3_end - data_things_potion3_start;
    ramdisk_data[117].data = data_things_potion4_start;
    ramdisk_data[117].len = data_things_potion4_end - data_things_potion4_start;
    ramdisk_data[118].data = data_things_potion5_start;
    ramdisk_data[118].len = data_things_potion5_end - data_things_potion5_start;
    ramdisk_data[119].data = data_things_potion_effect1_start;
    ramdisk_data[119].len = data_things_potion_effect1_end - data_things_potion_effect1_start;
    ramdisk_data[120].data = data_things_potion_effect2_start;
    ramdisk_data[120].len = data_things_potion_effect2_end - data_things_potion_effect2_start;
    ramdisk_data[121].data = data_things_potion_effect3_start;
    ramdisk_data[121].len = data_things_potion_effect3_end - data_things_potion_effect3_start;
    ramdisk_data[122].data = data_things_potion_effect4_start;
    ramdisk_data[122].len = data_things_potion_effect4_end - data_things_potion_effect4_start;
    ramdisk_data[123].data = data_things_potion_effect5_start;
    ramdisk_data[123].len = data_things_potion_effect5_end - data_things_potion_effect5_start;
    ramdisk_data[124].data = data_things_potion_effect6_start;
    ramdisk_data[124].len = data_things_potion_effect6_end - data_things_potion_effect6_start;
    ...
    ramdisk_data[135].data = data_things_water1_start;
    ramdisk_data[135].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[136].data = data_things_water2_start;
    ramdisk_data[136].len = data_things_water2_end - data_things_water2_start;
