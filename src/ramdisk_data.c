...
void ramdisk_init (void)
{
    ...
    ramdisk_data[35].data = data_things_amulet1_start;
    ramdisk_data[35].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[36].data = data_things_arrow_start;
    ramdisk_data[36].len = data_things_arrow_end - data_things_arrow_start;
    ...
    ramdisk_data[58].data = data_things_explosion1_start;
    ramdisk_data[58].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[59].data = data_things_explosion2_start;
    ramdisk_data[59].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[60].data = data_things_explosion3_start;
    ramdisk_data[60].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[61].data = data_things_explosion4_start;
    ramdisk_data[61].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[62].data = data_things_explosion5_start;
    ramdisk_data[62].len = data_things_explosion5_end - data_things_explosion5_start;
    ramdisk_data[63].data = data_things_explosion6_start;
    ramdisk_data[63].len = data_things_explosion6_end - data_things_explosion6_start;
    ramdisk_data[64].data = data_things_explosion7_start;
    ramdisk_data[64].len = data_things_explosion7_end - data_things_explosion7_start;
    ramdisk_data[65].data = data_things_explosion8_start;
    ramdisk_data[65].len = data_things_explosion8_end - data_things_explosion8_start;
    ramdisk_data[66].data = data_things_fireball_start;
    ramdisk_data[66].len = data_things_fireball_end - data_things_fireball_start;
    ...
    ramdisk_data[88].data = data_things_ghost1_start;
    ramdisk_data[88].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[89].data = data_things_ghost2_start;
    ramdisk_data[89].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[90].data = data_things_ghost3_start;
    ramdisk_data[90].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[91].data = data_things_keys1_start;
    ramdisk_data[91].len = data_things_keys1_end - data_things_keys1_start;
    ramdisk_data[92].data = data_things_keys2_start;
    ramdisk_data[92].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[93].data = data_things_keys3_start;
    ramdisk_data[93].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[94].data = data_things_lizard_start;
    ramdisk_data[94].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[95].data = data_things_mask1_start;
    ramdisk_data[95].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[96].data = data_things_mask2_start;
    ramdisk_data[96].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[97].data = data_things_mask3_start;
    ramdisk_data[97].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[98].data = data_things_monk_start;
    ramdisk_data[98].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[99].data = data_things_noentry_start;
    ramdisk_data[99].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[100].data = data_things_pipe_start;
    ramdisk_data[100].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[101].data = data_things_plant_start;
    ramdisk_data[101].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[102].data = data_things_potion1_start;
    ramdisk_data[102].len = data_things_potion1_end - data_things_potion1_start;
    ramdisk_data[103].data = data_things_potion2_start;
    ramdisk_data[103].len = data_things_potion2_end - data_things_potion2_start;
    ramdisk_data[104].data = data_things_potion3_start;
    ramdisk_data[104].len = data_things_potion3_end - data_things_potion3_start;
    ramdisk_data[105].data = data_things_potion4_start;
    ramdisk_data[105].len = data_things_potion4_end - data_things_potion4_start;
    ramdisk_data[106].data = data_things_potion5_start;
    ramdisk_data[106].len = data_things_potion5_end - data_things_potion5_start;
    ramdisk_data[107].data = data_things_potion_effect1_start;
    ramdisk_data[107].len = data_things_potion_effect1_end - data_things_potion_effect1_start;
    ramdisk_data[108].data = data_things_potion_effect2_start;
    ramdisk_data[108].len = data_things_potion_effect2_end - data_things_potion_effect2_start;
    ramdisk_data[109].data = data_things_potion_effect3_start;
    ramdisk_data[109].len = data_things_potion_effect3_end - data_things_potion_effect3_start;
    ramdisk_data[110].data = data_things_potion_effect4_start;
    ramdisk_data[110].len = data_things_potion_effect4_end - data_things_potion_effect4_start;
    ramdisk_data[111].data = data_things_potion_effect5_start;
    ramdisk_data[111].len = data_things_potion_effect5_end - data_things_potion_effect5_start;
    ramdisk_data[112].data = data_things_potion_effect6_start;
    ramdisk_data[112].len = data_things_potion_effect6_end - data_things_potion_effect6_start;
    ramdisk_data[113].data = data_things_seedpod_start;
    ramdisk_data[113].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[114].data = data_things_spam_start;
    ramdisk_data[114].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[115].data = data_things_valkyrie_start;
    ramdisk_data[115].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[116].data = data_things_wall_start;
    ramdisk_data[116].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[117].data = data_things_wall2_start;
    ramdisk_data[117].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[118].data = data_things_wall3_start;
    ramdisk_data[118].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[119].data = data_things_wall4_start;
    ramdisk_data[119].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[120].data = data_things_wall5_start;
    ramdisk_data[120].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[121].data = data_things_wand_fire_start;
    ramdisk_data[121].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ...
    ramdisk_data[175].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[175].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[176].data = data_ttf_readme_txt_start;
    ramdisk_data[176].len = data_ttf_readme_txt_end - data_ttf_readme_txt_start;
}
