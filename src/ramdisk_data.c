...
void ramdisk_init (void)
{
    ...
    ramdisk_data[29].data = data_music_DST_AncientCurse_II_wav_start;
    ramdisk_data[29].len = data_music_DST_AncientCurse_II_wav_end - data_music_DST_AncientCurse_II_wav_start;
    ramdisk_data[30].data = data_music_DST_Arch_Delerium_wav_start;
    ramdisk_data[30].len = data_music_DST_Arch_Delerium_wav_end - data_music_DST_Arch_Delerium_wav_start;
    ramdisk_data[31].data = data_music_DST_Arches_wav_start;
    ramdisk_data[31].len = data_music_DST_Arches_wav_end - data_music_DST_Arches_wav_start;
    ...
    ramdisk_data[49].data = data_things_anim_eyes_start;
    ramdisk_data[49].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[50].data = data_things_anim_man_start;
    ramdisk_data[50].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[51].data = data_things_anim_treasure_chest_start;
    ramdisk_data[51].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ramdisk_data[52].data = data_things_apple_start;
    ramdisk_data[52].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[53].data = data_things_apple_poison_start;
    ramdisk_data[53].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[54].data = data_things_arrow_start;
    ramdisk_data[54].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[55].data = data_things_axe1_start;
    ramdisk_data[55].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[56].data = data_things_axe1_anim_start;
    ramdisk_data[56].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[57].data = data_things_axe2_start;
    ramdisk_data[57].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[58].data = data_things_axe2_anim_start;
    ramdisk_data[58].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[59].data = data_things_banana_start;
    ramdisk_data[59].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[60].data = data_things_blood1_start;
    ramdisk_data[60].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[61].data = data_things_blood2_start;
    ramdisk_data[61].len = data_things_blood2_end - data_things_blood2_start;
    ...
    ramdisk_data[70].data = data_things_brazier_start;
    ramdisk_data[70].len = data_things_brazier_end - data_things_brazier_start;
    ramdisk_data[71].data = data_things_bread_start;
    ramdisk_data[71].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[72].data = data_things_cheese_start;
    ramdisk_data[72].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[73].data = data_things_chest1_start;
    ramdisk_data[73].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[74].data = data_things_cloudkill1_start;
    ramdisk_data[74].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[75].data = data_things_cloudkill2_start;
    ramdisk_data[75].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[76].data = data_things_cloudkill3_start;
    ramdisk_data[76].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[77].data = data_things_cloudkill4_start;
    ramdisk_data[77].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ...
    ramdisk_data[116].data = data_things_hit_miss_start;
    ramdisk_data[116].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[117].data = data_things_hit_success_start;
    ramdisk_data[117].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[118].data = data_things_key_start;
    ramdisk_data[118].len = data_things_key_end - data_things_key_start;
    ramdisk_data[119].data = data_things_keys2_start;
    ramdisk_data[119].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[120].data = data_things_keys3_start;
    ramdisk_data[120].len = data_things_keys3_end - data_things_keys3_start;
    ...
    ramdisk_data[123].data = data_things_poison1_start;
    ramdisk_data[123].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[124].data = data_things_poison2_start;
    ramdisk_data[124].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[125].data = data_things_poison3_start;
    ramdisk_data[125].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[126].data = data_things_poison4_start;
    ramdisk_data[126].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[127].data = data_things_potion_cloudkill_start;
    ramdisk_data[127].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ...
    ramdisk_data[129].data = data_things_potion_life_start;
    ramdisk_data[129].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[130].data = data_things_potion_monsticide_start;
    ramdisk_data[130].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[131].data = data_things_potion_shield_start;
    ramdisk_data[131].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[132].data = data_things_ring1_start;
    ramdisk_data[132].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[133].data = data_things_ring2_start;
    ramdisk_data[133].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[134].data = data_things_ring3_start;
    ramdisk_data[134].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[135].data = data_things_rock1_start;
    ramdisk_data[135].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[136].data = data_things_scythe1_start;
    ramdisk_data[136].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[137].data = data_things_scythe1_anim_start;
    ramdisk_data[137].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[138].data = data_things_spam_start;
    ramdisk_data[138].len = data_things_spam_end - data_things_spam_start;
