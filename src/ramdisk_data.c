...
void ramdisk_init (void)
{
    ...
    ramdisk_data[65].data = data_gfx_anim_treasure_chest_png_start;
    ramdisk_data[65].len = data_gfx_anim_treasure_chest_png_end - data_gfx_anim_treasure_chest_png_start;
    ramdisk_data[66].data = data_gfx_help1_png_start;
    ramdisk_data[66].len = data_gfx_help1_png_end - data_gfx_help1_png_start;
    ramdisk_data[67].data = data_gfx_anim_eyes_png_start;
    ramdisk_data[67].len = data_gfx_anim_eyes_png_end - data_gfx_anim_eyes_png_start;
    ramdisk_data[68].data = data_gfx_title_small_png_start;
    ramdisk_data[68].len = data_gfx_title_small_png_end - data_gfx_title_small_png_start;
    ramdisk_data[69].data = data_gfx_giant_rock_png_start;
    ramdisk_data[69].len = data_gfx_giant_rock_png_end - data_gfx_giant_rock_png_start;
    ramdisk_data[70].data = data_gfx_help3_png_start;
    ramdisk_data[70].len = data_gfx_help3_png_end - data_gfx_help3_png_start;
    ramdisk_data[71].data = data_gfx_cloudkill_png_start;
    ramdisk_data[71].len = data_gfx_cloudkill_png_end - data_gfx_cloudkill_png_start;
    ramdisk_data[72].data = data_gfx_gravestone2_png_start;
    ramdisk_data[72].len = data_gfx_gravestone2_png_end - data_gfx_gravestone2_png_start;
    ramdisk_data[73].data = data_gfx_gorynlich_png_start;
    ramdisk_data[73].len = data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start;
    ramdisk_data[74].data = data_gfx_sprites_small_png_start;
    ramdisk_data[74].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[75].data = data_gfx_title3_png_start;
    ramdisk_data[75].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ramdisk_data[76].data = data_gfx_title2_png_start;
    ramdisk_data[76].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[77].data = data_gfx_wall_floor_png_start;
    ramdisk_data[77].len = data_gfx_wall_floor_png_end - data_gfx_wall_floor_png_start;
    ramdisk_data[78].data = data_gfx_anim_man_png_start;
    ramdisk_data[78].len = data_gfx_anim_man_png_end - data_gfx_anim_man_png_start;
    ramdisk_data[79].data = data_gfx_help2_png_start;
    ramdisk_data[79].len = data_gfx_help2_png_end - data_gfx_help2_png_start;
    ramdisk_data[80].data = data_gfx_gravestone_png_start;
    ramdisk_data[80].len = data_gfx_gravestone_png_end - data_gfx_gravestone_png_start;
    ramdisk_data[81].data = data_gfx_explosion_png_start;
    ramdisk_data[81].len = data_gfx_explosion_png_end - data_gfx_explosion_png_start;
    ramdisk_data[82].data = data_gfx_rat_png_start;
    ramdisk_data[82].len = data_gfx_rat_png_end - data_gfx_rat_png_start;
    ramdisk_data[83].data = data_gfx_poison_png_start;
    ramdisk_data[83].len = data_gfx_poison_png_end - data_gfx_poison_png_start;
    ramdisk_data[84].data = data_gfx_dragon_png_start;
    ramdisk_data[84].len = data_gfx_dragon_png_end - data_gfx_dragon_png_start;
    ramdisk_data[85].data = data_gfx_title_png_start;
    ramdisk_data[85].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[86].data = data_levels_2_start;
    ramdisk_data[86].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[87].data = data_levels_1_start;
    ramdisk_data[87].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[88].data = data_things_hit_miss_start;
    ramdisk_data[88].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[89].data = data_things_exit5_start;
    ramdisk_data[89].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[90].data = data_things_potion_cloudkill_start;
    ramdisk_data[90].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[91].data = data_things_sword3_start;
    ramdisk_data[91].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[92].data = data_things_hit_success_start;
    ramdisk_data[92].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[93].data = data_things_plant_start;
    ramdisk_data[93].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[94].data = data_things_dwarf_start;
    ramdisk_data[94].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[95].data = data_things_generator7_start;
    ramdisk_data[95].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[96].data = data_things_exit2_start;
    ramdisk_data[96].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[97].data = data_things_ghost2_start;
    ramdisk_data[97].len = data_things_ghost2_end - data_things_ghost2_start;
    ...
    ramdisk_data[100].data = data_things_gem6_start;
    ramdisk_data[100].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[101].data = data_things_anim_treasure_chest_start;
    ramdisk_data[101].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ramdisk_data[102].data = data_things_scythe1_anim_start;
    ramdisk_data[102].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ...
    ramdisk_data[104].data = data_things_ring2_start;
    ramdisk_data[104].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[105].data = data_things_bread_start;
    ramdisk_data[105].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[106].data = data_things_amulet1_start;
    ramdisk_data[106].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[107].data = data_things_axe2_start;
    ramdisk_data[107].len = data_things_axe2_end - data_things_axe2_start;
    ...
    ramdisk_data[111].data = data_things_cloudkill1_start;
    ramdisk_data[111].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ...
    ramdisk_data[114].data = data_things_gem7_start;
    ramdisk_data[114].len = data_things_gem7_end - data_things_gem7_start;
    ...
    ramdisk_data[117].data = data_things_blood1_start;
    ramdisk_data[117].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[118].data = data_things_ring1_start;
    ramdisk_data[118].len = data_things_ring1_end - data_things_ring1_start;
    ...
    ramdisk_data[122].data = data_things_potion_fire_start;
    ramdisk_data[122].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[123].data = data_things_keys2_start;
    ramdisk_data[123].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[124].data = data_things_wall1_start;
    ramdisk_data[124].len = data_things_wall1_end - data_things_wall1_start;
    ramdisk_data[125].data = data_things_torches_start;
    ramdisk_data[125].len = data_things_torches_end - data_things_torches_start;
    ramdisk_data[126].data = data_things_lizard_start;
    ramdisk_data[126].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[127].data = data_things_brazier_start;
    ramdisk_data[127].len = data_things_brazier_end - data_things_brazier_start;
    ramdisk_data[128].data = data_things_ring3_start;
    ramdisk_data[128].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[129].data = data_things_rock1_start;
    ramdisk_data[129].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[130].data = data_things_gem1_start;
    ramdisk_data[130].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[131].data = data_things_axe2_anim_start;
    ramdisk_data[131].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[132].data = data_things_anim_man_start;
    ramdisk_data[132].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[133].data = data_things_weapon_swing1_start;
    ramdisk_data[133].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[134].data = data_things_warrior_start;
    ramdisk_data[134].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[135].data = data_things_gem5_start;
    ramdisk_data[135].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[136].data = data_things_cloudkill2_start;
    ramdisk_data[136].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[137].data = data_things_monk_start;
    ramdisk_data[137].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[138].data = data_things_banana_start;
    ramdisk_data[138].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[139].data = data_things_floor4_start;
    ramdisk_data[139].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[140].data = data_things_axe1_start;
    ramdisk_data[140].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[141].data = data_things_arrow_start;
    ramdisk_data[141].len = data_things_arrow_end - data_things_arrow_start;
    ...
    ramdisk_data[145].data = data_things_bonepile1_start;
    ramdisk_data[145].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[146].data = data_things_bow4_start;
    ramdisk_data[146].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[147].data = data_things_poison3_start;
    ramdisk_data[147].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[148].data = data_things_valkyrie_start;
    ramdisk_data[148].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[149].data = data_things_elf_start;
    ramdisk_data[149].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[150].data = data_things_sword1_start;
    ramdisk_data[150].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[151].data = data_things_wall4_start;
    ramdisk_data[151].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[152].data = data_things_sword2_start;
    ramdisk_data[152].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[153].data = data_things_water_start;
    ramdisk_data[153].len = data_things_water_end - data_things_water_start;
    ramdisk_data[154].data = data_things_floor6_start;
    ramdisk_data[154].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[155].data = data_things_wizard_start;
    ramdisk_data[155].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[156].data = data_things_anim_eyes_start;
    ramdisk_data[156].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[157].data = data_things_floor1_start;
    ramdisk_data[157].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[158].data = data_things_wall6_start;
    ramdisk_data[158].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[159].data = data_things_exit3_start;
    ramdisk_data[159].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[160].data = data_things_coins1_start;
    ramdisk_data[160].len = data_things_coins1_end - data_things_coins1_start;
    ...
    ramdisk_data[162].data = data_things_bow3_start;
    ramdisk_data[162].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[163].data = data_things_seedpod_start;
    ramdisk_data[163].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[164].data = data_things_death_start;
    ramdisk_data[164].len = data_things_death_end - data_things_death_start;
    ramdisk_data[165].data = data_things_bow1_anim_start;
    ramdisk_data[165].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[166].data = data_things_ghost1_start;
    ramdisk_data[166].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[167].data = data_things_cloudkill4_start;
    ramdisk_data[167].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[168].data = data_things_axe1_anim_start;
    ramdisk_data[168].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[169].data = data_things_demon_start;
    ramdisk_data[169].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[170].data = data_things_key_start;
    ramdisk_data[170].len = data_things_key_end - data_things_key_start;
    ...
    ramdisk_data[173].data = data_things_apple_start;
    ramdisk_data[173].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[174].data = data_things_floor5_start;
    ramdisk_data[174].len = data_things_floor5_end - data_things_floor5_start;
    ...
    ramdisk_data[176].data = data_things_generator6_start;
    ramdisk_data[176].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[177].data = data_things_fireball_start;
    ramdisk_data[177].len = data_things_fireball_end - data_things_fireball_start;
    ...
    ramdisk_data[179].data = data_things_explosion3_start;
    ramdisk_data[179].len = data_things_explosion3_end - data_things_explosion3_start;
    ...
    ramdisk_data[181].data = data_things_poison2_start;
    ramdisk_data[181].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[182].data = data_things_spam_start;
    ramdisk_data[182].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[183].data = data_things_bonepile3_start;
    ramdisk_data[183].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[184].data = data_things_torch_start;
    ramdisk_data[184].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[185].data = data_things_explosion4_start;
    ramdisk_data[185].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[186].data = data_things_exit7_start;
    ramdisk_data[186].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[187].data = data_things_pipe_start;
    ramdisk_data[187].len = data_things_pipe_end - data_things_pipe_start;
    ...
    ramdisk_data[190].data = data_things_apple_poison_start;
    ramdisk_data[190].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[191].data = data_things_explosion2_start;
    ramdisk_data[191].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[192].data = data_things_potion_life_start;
    ramdisk_data[192].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[193].data = data_things_gem2_start;
    ramdisk_data[193].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[194].data = data_things_sword3_anim_start;
    ramdisk_data[194].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[195].data = data_things_bonepile2_start;
    ramdisk_data[195].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ...
    ramdisk_data[197].data = data_things_scythe1_start;
    ramdisk_data[197].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[198].data = data_things_gem4_start;
    ramdisk_data[198].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[199].data = data_things_bow1_start;
    ramdisk_data[199].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[200].data = data_things_poison4_start;
    ramdisk_data[200].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[201].data = data_things_door1_start;
    ramdisk_data[201].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[202].data = data_things_cloudkill3_start;
    ramdisk_data[202].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[203].data = data_things_keys3_start;
    ramdisk_data[203].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[204].data = data_things_door2_start;
    ramdisk_data[204].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[205].data = data_things_wall3_start;
    ramdisk_data[205].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[206].data = data_map_jigsaw_map_start;
    ramdisk_data[206].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[207].data = data_music_hiscore_wav_start;
    ramdisk_data[207].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[208].data = data_music_charlotte_mp3_start;
    ramdisk_data[208].len = data_music_charlotte_mp3_end - data_music_charlotte_mp3_start;
    ramdisk_data[209].data = data_music_music_wav_start;
    ramdisk_data[209].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[210].data = data_music_charlotte8bit_mp3_start;
    ramdisk_data[210].len = data_music_charlotte8bit_mp3_end - data_music_charlotte8bit_mp3_start;
    ramdisk_data[211].data = data_music_intro_wav_start;
    ramdisk_data[211].len = data_music_intro_wav_end - data_music_intro_wav_start;
}
