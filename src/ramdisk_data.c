...
void ramdisk_init (void)
{
    ...
    ramdisk_data[36].data = data_things__dwarf_session_start;
    ramdisk_data[36].len = data_things__dwarf_session_end - data_things__dwarf_session_start;
    ramdisk_data[37].data = data_things__explosion_session_start;
    ramdisk_data[37].len = data_things__explosion_session_end - data_things__explosion_session_start;
    ramdisk_data[38].data = data_things__fireball_session_start;
    ramdisk_data[38].len = data_things__fireball_session_end - data_things__fireball_session_start;
    ramdisk_data[39].data = data_things__ghost1_session_start;
    ramdisk_data[39].len = data_things__ghost1_session_end - data_things__ghost1_session_start;
    ramdisk_data[40].data = data_things__keys_session_start;
    ramdisk_data[40].len = data_things__keys_session_end - data_things__keys_session_start;
    ramdisk_data[41].data = data_things__keys1_session_start;
    ramdisk_data[41].len = data_things__keys1_session_end - data_things__keys1_session_start;
    ramdisk_data[42].data = data_things__keys3_session_start;
    ramdisk_data[42].len = data_things__keys3_session_end - data_things__keys3_session_start;
    ramdisk_data[43].data = data_things__plant_session_start;
    ramdisk_data[43].len = data_things__plant_session_end - data_things__plant_session_start;
    ramdisk_data[44].data = data_things__valkyrie_session_start;
    ramdisk_data[44].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[45].data = data_things__wall_session_start;
    ramdisk_data[45].len = data_things__wall_session_end - data_things__wall_session_start;
    ramdisk_data[46].data = data_things__wall1_session_start;
    ramdisk_data[46].len = data_things__wall1_session_end - data_things__wall1_session_start;
    ramdisk_data[47].data = data_things__warrior_session_start;
    ramdisk_data[47].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[48].data = data_things__water2_session_start;
    ramdisk_data[48].len = data_things__water2_session_end - data_things__water2_session_start;
    ramdisk_data[49].data = data_things__wizard_session_start;
    ramdisk_data[49].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ramdisk_data[50].data = data_things_amulet1_start;
    ramdisk_data[50].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[51].data = data_things_arrow_start;
    ramdisk_data[51].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[52].data = data_things_bomb_start;
    ramdisk_data[52].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[53].data = data_things_chest1_start;
    ramdisk_data[53].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[54].data = data_things_coins1_start;
    ramdisk_data[54].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[55].data = data_things_death_start;
    ramdisk_data[55].len = data_things_death_end - data_things_death_start;
    ramdisk_data[56].data = data_things_demon_start;
    ramdisk_data[56].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[57].data = data_things_door_start;
    ramdisk_data[57].len = data_things_door_end - data_things_door_start;
    ramdisk_data[58].data = data_things_dwarf_start;
    ramdisk_data[58].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[59].data = data_things_elf_start;
    ramdisk_data[59].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[60].data = data_things_exit_start;
    ramdisk_data[60].len = data_things_exit_end - data_things_exit_start;
    ramdisk_data[61].data = data_things_exit1_start;
    ramdisk_data[61].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[62].data = data_things_exit2_start;
    ramdisk_data[62].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[63].data = data_things_exit3_start;
    ramdisk_data[63].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[64].data = data_things_exit4_start;
    ramdisk_data[64].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[65].data = data_things_exit5_start;
    ramdisk_data[65].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[66].data = data_things_exit6_start;
    ramdisk_data[66].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[67].data = data_things_exit7_start;
    ramdisk_data[67].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[68].data = data_things_explosion_start;
    ramdisk_data[68].len = data_things_explosion_end - data_things_explosion_start;
    ramdisk_data[69].data = data_things_fireball_start;
    ramdisk_data[69].len = data_things_fireball_end - data_things_fireball_start;
    ...
    ramdisk_data[91].data = data_things_ghost1_start;
    ramdisk_data[91].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[92].data = data_things_ghost2_start;
    ramdisk_data[92].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[93].data = data_things_ghost3_start;
    ramdisk_data[93].len = data_things_ghost3_end - data_things_ghost3_start;
