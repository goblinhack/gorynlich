...
void ramdisk_init (void)
{
    ...
    ramdisk_data[21].data = data_levels_1_start;
    ramdisk_data[21].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[22].data = data_levels_2_start;
    ramdisk_data[22].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[23].data = data_map_jigsaw_map_start;
    ramdisk_data[23].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[24].data = data_music_charlotte_mp3_start;
    ramdisk_data[24].len = data_music_charlotte_mp3_end - data_music_charlotte_mp3_start;
    ramdisk_data[25].data = data_music_charlotte8bit_mp3_start;
    ramdisk_data[25].len = data_music_charlotte8bit_mp3_end - data_music_charlotte8bit_mp3_start;
    ...
    ramdisk_data[43].data = data_things__anim_eyes_session_start;
    ramdisk_data[43].len = data_things__anim_eyes_session_end - data_things__anim_eyes_session_start;
    ramdisk_data[44].data = data_things__anim_man_session_start;
    ramdisk_data[44].len = data_things__anim_man_session_end - data_things__anim_man_session_start;
    ramdisk_data[45].data = data_things__anim_treasure_chest_session_start;
    ramdisk_data[45].len = data_things__anim_treasure_chest_session_end - data_things__anim_treasure_chest_session_start;
    ramdisk_data[46].data = data_things__blood1_session_start;
    ramdisk_data[46].len = data_things__blood1_session_end - data_things__blood1_session_start;
    ramdisk_data[47].data = data_things__blood2_session_start;
    ramdisk_data[47].len = data_things__blood2_session_end - data_things__blood2_session_start;
    ramdisk_data[48].data = data_things__brazier_session_start;
    ramdisk_data[48].len = data_things__brazier_session_end - data_things__brazier_session_start;
    ramdisk_data[49].data = data_things__door1_session_start;
    ramdisk_data[49].len = data_things__door1_session_end - data_things__door1_session_start;
    ...
    ramdisk_data[52].data = data_things__floor1_session_start;
    ramdisk_data[52].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[53].data = data_things__key_session_start;
    ramdisk_data[53].len = data_things__key_session_end - data_things__key_session_start;
    ramdisk_data[54].data = data_things__keys_session_start;
    ramdisk_data[54].len = data_things__keys_session_end - data_things__keys_session_start;
    ramdisk_data[55].data = data_things__spam_session_start;
    ramdisk_data[55].len = data_things__spam_session_end - data_things__spam_session_start;
    ramdisk_data[56].data = data_things__sparks1_session_start;
    ramdisk_data[56].len = data_things__sparks1_session_end - data_things__sparks1_session_start;
    ramdisk_data[57].data = data_things__sparks2_session_start;
    ramdisk_data[57].len = data_things__sparks2_session_end - data_things__sparks2_session_start;
    ramdisk_data[58].data = data_things__torch_session_start;
    ramdisk_data[58].len = data_things__torch_session_end - data_things__torch_session_start;
    ramdisk_data[59].data = data_things__torches_session_start;
    ramdisk_data[59].len = data_things__torches_session_end - data_things__torches_session_start;
    ramdisk_data[60].data = data_things__wand_f_session_start;
    ramdisk_data[60].len = data_things__wand_f_session_end - data_things__wand_f_session_start;
    ramdisk_data[61].data = data_things__wand_fire_session_start;
    ramdisk_data[61].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[62].data = data_things_amulet1_start;
    ramdisk_data[62].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[63].data = data_things_anim_eyes_start;
    ramdisk_data[63].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[64].data = data_things_anim_man_start;
    ramdisk_data[64].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[65].data = data_things_anim_treasure_chest_start;
    ramdisk_data[65].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ...
    ramdisk_data[74].data = data_things_blood1_start;
    ramdisk_data[74].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[75].data = data_things_blood2_start;
    ramdisk_data[75].len = data_things_blood2_end - data_things_blood2_start;
    ramdisk_data[76].data = data_things_bonepile1_start;
    ramdisk_data[76].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[77].data = data_things_bonepile2_start;
    ramdisk_data[77].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[78].data = data_things_bonepile3_start;
    ramdisk_data[78].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ...
    ramdisk_data[84].data = data_things_brazier_start;
    ramdisk_data[84].len = data_things_brazier_end - data_things_brazier_start;
    ...
    ramdisk_data[92].data = data_things_coins1_start;
    ramdisk_data[92].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[93].data = data_things_death_start;
    ramdisk_data[93].len = data_things_death_end - data_things_death_start;
    ramdisk_data[94].data = data_things_demon_start;
    ramdisk_data[94].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[95].data = data_things_door1_start;
    ramdisk_data[95].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[96].data = data_things_door2_start;
    ramdisk_data[96].len = data_things_door2_end - data_things_door2_start;
    ...
    ramdisk_data[110].data = data_things_fireball_start;
    ramdisk_data[110].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[111].data = data_things_floor1_start;
    ramdisk_data[111].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[112].data = data_things_floor2_start;
    ramdisk_data[112].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[113].data = data_things_floor3_start;
    ramdisk_data[113].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[114].data = data_things_floor4_start;
    ramdisk_data[114].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[115].data = data_things_floor5_start;
    ramdisk_data[115].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[116].data = data_things_floor6_start;
    ramdisk_data[116].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[117].data = data_things_gem1_start;
    ramdisk_data[117].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[118].data = data_things_gem2_start;
    ramdisk_data[118].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[119].data = data_things_gem3_start;
    ramdisk_data[119].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[120].data = data_things_gem4_start;
    ramdisk_data[120].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[121].data = data_things_gem5_start;
    ramdisk_data[121].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[122].data = data_things_gem6_start;
    ramdisk_data[122].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[123].data = data_things_gem7_start;
    ramdisk_data[123].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[124].data = data_things_generator1_start;
    ramdisk_data[124].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[125].data = data_things_generator5_start;
    ramdisk_data[125].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[126].data = data_things_generator6_start;
    ramdisk_data[126].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[127].data = data_things_generator7_start;
    ramdisk_data[127].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[128].data = data_things_ghost1_start;
    ramdisk_data[128].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[129].data = data_things_ghost2_start;
    ramdisk_data[129].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[130].data = data_things_ghost3_start;
    ramdisk_data[130].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[131].data = data_things_hit_miss_start;
    ramdisk_data[131].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[132].data = data_things_hit_success_start;
    ramdisk_data[132].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[133].data = data_things_key_start;
    ramdisk_data[133].len = data_things_key_end - data_things_key_start;
    ramdisk_data[134].data = data_things_keys2_start;
    ramdisk_data[134].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[135].data = data_things_keys3_start;
    ramdisk_data[135].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[136].data = data_things_lizard_start;
    ramdisk_data[136].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[137].data = data_things_monk_start;
    ramdisk_data[137].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[138].data = data_things_noentry_start;
    ramdisk_data[138].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[139].data = data_things_pipe_start;
    ramdisk_data[139].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[140].data = data_things_plant_start;
    ramdisk_data[140].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[141].data = data_things_poison1_start;
    ramdisk_data[141].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[142].data = data_things_poison2_start;
    ramdisk_data[142].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[143].data = data_things_poison3_start;
    ramdisk_data[143].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[144].data = data_things_poison4_start;
    ramdisk_data[144].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[145].data = data_things_potion_cloudkill_start;
    ramdisk_data[145].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[146].data = data_things_potion_fire_start;
    ramdisk_data[146].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[147].data = data_things_potion_life_start;
    ramdisk_data[147].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[148].data = data_things_potion_monsticide_start;
    ramdisk_data[148].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[149].data = data_things_potion_shield_start;
    ramdisk_data[149].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[150].data = data_things_ring1_start;
    ramdisk_data[150].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[151].data = data_things_ring2_start;
    ramdisk_data[151].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[152].data = data_things_ring3_start;
    ramdisk_data[152].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[153].data = data_things_rock1_start;
    ramdisk_data[153].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[154].data = data_things_scythe1_start;
    ramdisk_data[154].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[155].data = data_things_scythe1_anim_start;
    ramdisk_data[155].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[156].data = data_things_seedpod_start;
    ramdisk_data[156].len = data_things_seedpod_end - data_things_seedpod_start;
