...
void ramdisk_init (void)
{
    ...
    ramdisk_data[233].data = data_music_DST_SuperWin_ogg_start;
    ramdisk_data[233].len = data_music_DST_SuperWin_ogg_end - data_music_DST_SuperWin_ogg_start;
    ramdisk_data[234].data = data_music_DST_BoneTower_ogg_start;
    ramdisk_data[234].len = data_music_DST_BoneTower_ogg_end - data_music_DST_BoneTower_ogg_start;
    ramdisk_data[235].data = data_music_resample_sh_start;
    ramdisk_data[235].len = data_music_resample_sh_end - data_music_resample_sh_start;
    ramdisk_data[236].data = data_music_DST_Legends_ogg_start;
    ramdisk_data[236].len = data_music_DST_Legends_ogg_end - data_music_DST_Legends_ogg_start;
    ramdisk_data[237].data = data_music_DST_ClockTower_ogg_start;
    ramdisk_data[237].len = data_music_DST_ClockTower_ogg_end - data_music_DST_ClockTower_ogg_start;
    ramdisk_data[238].data = data_music_DST_ExInfernus_ogg_start;
    ramdisk_data[238].len = data_music_DST_ExInfernus_ogg_end - data_music_DST_ExInfernus_ogg_start;
    ramdisk_data[239].data = data_music_charlotte_slow_ogg_start;
    ramdisk_data[239].len = data_music_charlotte_slow_ogg_end - data_music_charlotte_slow_ogg_start;
    ramdisk_data[240].data = data_music_DST_Alters_ogg_start;
    ramdisk_data[240].len = data_music_DST_Alters_ogg_end - data_music_DST_Alters_ogg_start;
    ramdisk_data[241].data = data_music_DST_BattleLands_ogg_start;
    ramdisk_data[241].len = data_music_DST_BattleLands_ogg_end - data_music_DST_BattleLands_ogg_start;
    ramdisk_data[242].data = data_music_charlotte_ogg_start;
    ramdisk_data[242].len = data_music_charlotte_ogg_end - data_music_charlotte_ogg_start;
    ramdisk_data[243].data = data_music_DST_DoomCity_ogg_start;
    ramdisk_data[243].len = data_music_DST_DoomCity_ogg_end - data_music_DST_DoomCity_ogg_start;
    ramdisk_data[244].data = data_music_DST_Arch_Delerium_ogg_start;
    ramdisk_data[244].len = data_music_DST_Arch_Delerium_ogg_end - data_music_DST_Arch_Delerium_ogg_start;
    ramdisk_data[245].data = data_music_DST_LeDanse_ogg_start;
    ramdisk_data[245].len = data_music_DST_LeDanse_ogg_end - data_music_DST_LeDanse_ogg_start;
    ramdisk_data[246].data = data_music_DST_Arches_ogg_start;
    ramdisk_data[246].len = data_music_DST_Arches_ogg_end - data_music_DST_Arches_ogg_start;
    ramdisk_data[247].data = data_music_oggconv_sh_start;
    ramdisk_data[247].len = data_music_oggconv_sh_end - data_music_oggconv_sh_start;
    ramdisk_data[248].data = data_music_DST_AncientCurse_II_ogg_start;
    ramdisk_data[248].len = data_music_DST_AncientCurse_II_ogg_end - data_music_DST_AncientCurse_II_ogg_start;
    ramdisk_data[249].data = data_music_DST_BlackRiver_ogg_start;
    ramdisk_data[249].len = data_music_DST_BlackRiver_ogg_end - data_music_DST_BlackRiver_ogg_start;
    ramdisk_data[250].data = data_music_DST_DarkestKnight_ogg_start;
    ramdisk_data[250].len = data_music_DST_DarkestKnight_ogg_end - data_music_DST_DarkestKnight_ogg_start;
    ramdisk_data[251].data = data_music_charlotte8bit_ogg_start;
    ramdisk_data[251].len = data_music_charlotte8bit_ogg_end - data_music_charlotte8bit_ogg_start;
}
