...
{
    ramdisk_data[0].data = data_gfx_anim_man_png_start;
    ramdisk_data[0].len = data_gfx_anim_man_png_end - data_gfx_anim_man_png_start;
    ramdisk_data[1].data = data_gfx_anim_treasure_chest_png_start;
    ramdisk_data[1].len = data_gfx_anim_treasure_chest_png_end - data_gfx_anim_treasure_chest_png_start;
    ramdisk_data[2].data = data_gfx_cloudkill_png_start;
    ramdisk_data[2].len = data_gfx_cloudkill_png_end - data_gfx_cloudkill_png_start;
    ramdisk_data[3].data = data_gfx_dragon_png_start;
    ramdisk_data[3].len = data_gfx_dragon_png_end - data_gfx_dragon_png_start;
    ramdisk_data[4].data = data_gfx_explosion_png_start;
    ramdisk_data[4].len = data_gfx_explosion_png_end - data_gfx_explosion_png_start;
    ...
    ramdisk_data[11].data = data_gfx_main_title_png_start;
    ramdisk_data[11].len = data_gfx_main_title_png_end - data_gfx_main_title_png_start;
    ramdisk_data[12].data = data_gfx_poison_png_start;
    ramdisk_data[12].len = data_gfx_poison_png_end - data_gfx_poison_png_start;
    ...
    ramdisk_data[41].data = data_things__anim_man_session_start;
    ramdisk_data[41].len = data_things__anim_man_session_end - data_things__anim_man_session_start;
    ramdisk_data[42].data = data_things__anim_treasure_chest_session_start;
    ramdisk_data[42].len = data_things__anim_treasure_chest_session_end - data_things__anim_treasure_chest_session_start;
    ramdisk_data[43].data = data_things__blood1_session_start;
    ramdisk_data[43].len = data_things__blood1_session_end - data_things__blood1_session_start;
    ramdisk_data[44].data = data_things__blood2_session_start;
    ramdisk_data[44].len = data_things__blood2_session_end - data_things__blood2_session_start;
    ramdisk_data[45].data = data_things__brazier_session_start;
    ramdisk_data[45].len = data_things__brazier_session_end - data_things__brazier_session_start;
    ramdisk_data[46].data = data_things__door1_session_start;
    ramdisk_data[46].len = data_things__door1_session_end - data_things__door1_session_start;
    ...
    ramdisk_data[48].data = data_things__exit7_session_start;
    ramdisk_data[48].len = data_things__exit7_session_end - data_things__exit7_session_start;
    ...
    ramdisk_data[50].data = data_things__key_session_start;
    ramdisk_data[50].len = data_things__key_session_end - data_things__key_session_start;
    ramdisk_data[51].data = data_things__keys_session_start;
    ramdisk_data[51].len = data_things__keys_session_end - data_things__keys_session_start;
    ramdisk_data[52].data = data_things__spam_session_start;
    ramdisk_data[52].len = data_things__spam_session_end - data_things__spam_session_start;
    ramdisk_data[53].data = data_things__sparks1_session_start;
    ramdisk_data[53].len = data_things__sparks1_session_end - data_things__sparks1_session_start;
    ramdisk_data[54].data = data_things__sparks2_session_start;
    ramdisk_data[54].len = data_things__sparks2_session_end - data_things__sparks2_session_start;
    ramdisk_data[55].data = data_things__torch_session_start;
    ramdisk_data[55].len = data_things__torch_session_end - data_things__torch_session_start;
    ramdisk_data[56].data = data_things__torches_session_start;
    ramdisk_data[56].len = data_things__torches_session_end - data_things__torches_session_start;
    ramdisk_data[57].data = data_things__wand_f_session_start;
    ramdisk_data[57].len = data_things__wand_f_session_end - data_things__wand_f_session_start;
    ramdisk_data[58].data = data_things__wand_fire_session_start;
    ramdisk_data[58].len = data_things__wand_fire_session_end - data_things__wand_fire_session_start;
    ramdisk_data[59].data = data_things_amulet1_start;
    ramdisk_data[59].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[60].data = data_things_anim_man_start;
    ramdisk_data[60].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[61].data = data_things_anim_treasure_chest_start;
    ramdisk_data[61].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ramdisk_data[62].data = data_things_apple_start;
    ramdisk_data[62].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[63].data = data_things_apple_poison_start;
    ramdisk_data[63].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[64].data = data_things_arrow_start;
    ramdisk_data[64].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[65].data = data_things_axe1_start;
    ramdisk_data[65].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[66].data = data_things_axe1_anim_start;
    ramdisk_data[66].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[67].data = data_things_axe2_start;
    ramdisk_data[67].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[68].data = data_things_axe2_anim_start;
    ramdisk_data[68].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[69].data = data_things_banana_start;
    ramdisk_data[69].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[70].data = data_things_blood1_start;
    ramdisk_data[70].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[71].data = data_things_blood2_start;
    ramdisk_data[71].len = data_things_blood2_end - data_things_blood2_start;
    ...
    ramdisk_data[127].data = data_things_hit_miss_start;
    ramdisk_data[127].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[128].data = data_things_hit_success_start;
    ramdisk_data[128].len = data_things_hit_success_end - data_things_hit_success_start;
    ...
    ramdisk_data[160].data = data_things_torch_start;
    ramdisk_data[160].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[161].data = data_things_torches_start;
    ramdisk_data[161].len = data_things_torches_end - data_things_torches_start;
