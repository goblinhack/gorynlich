...
void ramdisk_init (void)
{
    ...
    ramdisk_data[41].data = data_things_1_start;
    ramdisk_data[41].len = data_things_1_end - data_things_1_start;
    ...
    ramdisk_data[44].data = data_things_bomb_start;
    ramdisk_data[44].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[45].data = data_things_bow1_start;
    ramdisk_data[45].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[46].data = data_things_bow2_start;
    ramdisk_data[46].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[47].data = data_things_bow3_start;
    ramdisk_data[47].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[48].data = data_things_bow4_start;
    ramdisk_data[48].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[49].data = data_things_chest1_start;
    ramdisk_data[49].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[50].data = data_things_coins1_start;
    ramdisk_data[50].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[51].data = data_things_death_start;
    ramdisk_data[51].len = data_things_death_end - data_things_death_start;
    ramdisk_data[52].data = data_things_demon_start;
    ramdisk_data[52].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[53].data = data_things_door_start;
    ramdisk_data[53].len = data_things_door_end - data_things_door_start;
    ramdisk_data[54].data = data_things_dwarf_start;
    ramdisk_data[54].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[55].data = data_things_elf_start;
    ramdisk_data[55].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[56].data = data_things_exit_start;
    ramdisk_data[56].len = data_things_exit_end - data_things_exit_start;
    ...
    ramdisk_data[64].data = data_things_explosion_start;
    ramdisk_data[64].len = data_things_explosion_end - data_things_explosion_start;
    ramdisk_data[65].data = data_things_explosion1_start;
    ramdisk_data[65].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[66].data = data_things_explosion2_start;
    ramdisk_data[66].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[67].data = data_things_explosion3_start;
    ramdisk_data[67].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[68].data = data_things_explosion4_start;
    ramdisk_data[68].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[69].data = data_things_explosion5_start;
    ramdisk_data[69].len = data_things_explosion5_end - data_things_explosion5_start;
    ramdisk_data[70].data = data_things_explosion6_start;
    ramdisk_data[70].len = data_things_explosion6_end - data_things_explosion6_start;
    ramdisk_data[71].data = data_things_explosion7_start;
    ramdisk_data[71].len = data_things_explosion7_end - data_things_explosion7_start;
    ramdisk_data[72].data = data_things_explosion8_start;
    ramdisk_data[72].len = data_things_explosion8_end - data_things_explosion8_start;
    ramdisk_data[73].data = data_things_fireball_start;
    ramdisk_data[73].len = data_things_fireball_end - data_things_fireball_start;
    ...
    ramdisk_data[95].data = data_things_ghost1_start;
    ramdisk_data[95].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[96].data = data_things_ghost2_start;
    ramdisk_data[96].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[97].data = data_things_ghost3_start;
    ramdisk_data[97].len = data_things_ghost3_end - data_things_ghost3_start;
    ...
    ramdisk_data[114].data = data_things_potion_effect1_start;
    ramdisk_data[114].len = data_things_potion_effect1_end - data_things_potion_effect1_start;
    ramdisk_data[115].data = data_things_potion_effect2_start;
    ramdisk_data[115].len = data_things_potion_effect2_end - data_things_potion_effect2_start;
    ramdisk_data[116].data = data_things_potion_effect3_start;
    ramdisk_data[116].len = data_things_potion_effect3_end - data_things_potion_effect3_start;
    ramdisk_data[117].data = data_things_potion_effect4_start;
    ramdisk_data[117].len = data_things_potion_effect4_end - data_things_potion_effect4_start;
    ramdisk_data[118].data = data_things_potion_effect5_start;
    ramdisk_data[118].len = data_things_potion_effect5_end - data_things_potion_effect5_start;
    ramdisk_data[119].data = data_things_potion_effect6_start;
    ramdisk_data[119].len = data_things_potion_effect6_end - data_things_potion_effect6_start;
    ramdisk_data[120].data = data_things_seedpod_start;
    ramdisk_data[120].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[121].data = data_things_spam_start;
    ramdisk_data[121].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[122].data = data_things_valkyrie_start;
    ramdisk_data[122].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[123].data = data_things_wall_start;
    ramdisk_data[123].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[124].data = data_things_wall2_start;
    ramdisk_data[124].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[125].data = data_things_wall3_start;
    ramdisk_data[125].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[126].data = data_things_wall4_start;
    ramdisk_data[126].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[127].data = data_things_wall5_start;
    ramdisk_data[127].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[128].data = data_things_wand_fire_start;
    ramdisk_data[128].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[129].data = data_things_warrior_start;
    ramdisk_data[129].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[130].data = data_things_water1_start;
    ramdisk_data[130].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[131].data = data_things_water2_start;
    ramdisk_data[131].len = data_things_water2_end - data_things_water2_start;
    ramdisk_data[132].data = data_things_wizard_start;
    ramdisk_data[132].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[133].data = data_ttf_emulogic_gif_start;
    ramdisk_data[133].len = data_ttf_emulogic_gif_end - data_ttf_emulogic_gif_start;
    ramdisk_data[134].data = data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[134].len = data_ttf_emulogic_ttf_pointsize10_data_end - data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[135].data = data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[135].len = data_ttf_emulogic_ttf_pointsize10_tga_end - data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[136].data = data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[136].len = data_ttf_emulogic_ttf_pointsize11_data_end - data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[137].data = data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[137].len = data_ttf_emulogic_ttf_pointsize11_tga_end - data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[138].data = data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[138].len = data_ttf_emulogic_ttf_pointsize12_data_end - data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[139].data = data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[139].len = data_ttf_emulogic_ttf_pointsize12_tga_end - data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[140].data = data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[140].len = data_ttf_emulogic_ttf_pointsize14_data_end - data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[141].data = data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[141].len = data_ttf_emulogic_ttf_pointsize14_tga_end - data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[142].data = data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[142].len = data_ttf_emulogic_ttf_pointsize15_data_end - data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[143].data = data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[143].len = data_ttf_emulogic_ttf_pointsize15_tga_end - data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[144].data = data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[144].len = data_ttf_emulogic_ttf_pointsize16_data_end - data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[145].data = data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[145].len = data_ttf_emulogic_ttf_pointsize16_tga_end - data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[146].data = data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[146].len = data_ttf_emulogic_ttf_pointsize17_data_end - data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[147].data = data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[147].len = data_ttf_emulogic_ttf_pointsize17_tga_end - data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[148].data = data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[148].len = data_ttf_emulogic_ttf_pointsize18_data_end - data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[149].data = data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[149].len = data_ttf_emulogic_ttf_pointsize18_tga_end - data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[150].data = data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[150].len = data_ttf_emulogic_ttf_pointsize19_data_end - data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[151].data = data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[151].len = data_ttf_emulogic_ttf_pointsize19_tga_end - data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[152].data = data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[152].len = data_ttf_emulogic_ttf_pointsize20_data_end - data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[153].data = data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[153].len = data_ttf_emulogic_ttf_pointsize20_tga_end - data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[154].data = data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[154].len = data_ttf_emulogic_ttf_pointsize21_data_end - data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[155].data = data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[155].len = data_ttf_emulogic_ttf_pointsize21_tga_end - data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[156].data = data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[156].len = data_ttf_emulogic_ttf_pointsize22_data_end - data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[157].data = data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[157].len = data_ttf_emulogic_ttf_pointsize22_tga_end - data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[158].data = data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[158].len = data_ttf_emulogic_ttf_pointsize23_data_end - data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[159].data = data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[159].len = data_ttf_emulogic_ttf_pointsize23_tga_end - data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[160].data = data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[160].len = data_ttf_emulogic_ttf_pointsize24_data_end - data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[161].data = data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[161].len = data_ttf_emulogic_ttf_pointsize24_tga_end - data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[162].data = data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[162].len = data_ttf_emulogic_ttf_pointsize25_data_end - data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[163].data = data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[163].len = data_ttf_emulogic_ttf_pointsize25_tga_end - data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[164].data = data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[164].len = data_ttf_emulogic_ttf_pointsize26_data_end - data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[165].data = data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[165].len = data_ttf_emulogic_ttf_pointsize26_tga_end - data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[166].data = data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[166].len = data_ttf_emulogic_ttf_pointsize28_data_end - data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[167].data = data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[167].len = data_ttf_emulogic_ttf_pointsize28_tga_end - data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[168].data = data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[168].len = data_ttf_emulogic_ttf_pointsize30_data_end - data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[169].data = data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[169].len = data_ttf_emulogic_ttf_pointsize30_tga_end - data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[170].data = data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[170].len = data_ttf_emulogic_ttf_pointsize32_data_end - data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[171].data = data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[171].len = data_ttf_emulogic_ttf_pointsize32_tga_end - data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[172].data = data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[172].len = data_ttf_emulogic_ttf_pointsize36_data_end - data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[173].data = data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[173].len = data_ttf_emulogic_ttf_pointsize36_tga_end - data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[174].data = data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[174].len = data_ttf_emulogic_ttf_pointsize6_data_end - data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[175].data = data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[175].len = data_ttf_emulogic_ttf_pointsize6_tga_end - data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[176].data = data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[176].len = data_ttf_emulogic_ttf_pointsize7_data_end - data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[177].data = data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[177].len = data_ttf_emulogic_ttf_pointsize7_tga_end - data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[178].data = data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[178].len = data_ttf_emulogic_ttf_pointsize8_data_end - data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[179].data = data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[179].len = data_ttf_emulogic_ttf_pointsize8_tga_end - data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[180].data = data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[180].len = data_ttf_emulogic_ttf_pointsize9_data_end - data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[181].data = data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[181].len = data_ttf_emulogic_ttf_pointsize9_tga_end - data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[182].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[182].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
