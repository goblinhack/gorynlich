...
extern unsigned char *data_ttf__LICENSE_txt_session_start_ asm("data_ttf__LICENSE_txt_session_start_");
extern unsigned char *data_ttf__LICENSE_txt_session_end_ asm("data_ttf__LICENSE_txt_session_end_");
static const unsigned char *const data_ttf__LICENSE_txt_session_start =
    (const unsigned char *const) (char*)&data_ttf__LICENSE_txt_session_start_;
static const unsigned char *const data_ttf__LICENSE_txt_session_end   =
    (const unsigned char *const) (char*)&data_ttf__LICENSE_txt_session_end_;

extern unsigned char *data_ttf__Readme_txt_session_start_ asm("data_ttf__Readme_txt_session_start_");
extern unsigned char *data_ttf__Readme_txt_session_end_ asm("data_ttf__Readme_txt_session_end_");
static const unsigned char *const data_ttf__Readme_txt_session_start =
    (const unsigned char *const) (char*)&data_ttf__Readme_txt_session_start_;
static const unsigned char *const data_ttf__Readme_txt_session_end   =
    (const unsigned char *const) (char*)&data_ttf__Readme_txt_session_end_;
...
{
    /* filename */ "data/ttf/.LICENSE.txt.session",
},
{
    /* filename */ "data/ttf/.Readme.txt.session",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[76].data = data_things_amulet1_start;
    ramdisk_data[76].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[77].data = data_things_anim_eyes_start;
    ramdisk_data[77].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[78].data = data_things_anim_man_start;
    ramdisk_data[78].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[79].data = data_things_anim_treasure_chest_start;
    ramdisk_data[79].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ...
    ramdisk_data[88].data = data_things_blood1_start;
    ramdisk_data[88].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[89].data = data_things_blood2_start;
    ramdisk_data[89].len = data_things_blood2_end - data_things_blood2_start;
    ...
    ramdisk_data[98].data = data_things_brazier_start;
    ramdisk_data[98].len = data_things_brazier_end - data_things_brazier_start;
    ...
    ramdisk_data[106].data = data_things_coins1_start;
    ramdisk_data[106].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[107].data = data_things_death_start;
    ramdisk_data[107].len = data_things_death_end - data_things_death_start;
    ramdisk_data[108].data = data_things_door1_start;
    ramdisk_data[108].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[109].data = data_things_door2_start;
    ramdisk_data[109].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[110].data = data_things_dwarf_start;
    ramdisk_data[110].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[111].data = data_things_elf_start;
    ramdisk_data[111].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[112].data = data_things_exit1_start;
    ramdisk_data[112].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[113].data = data_things_exit2_start;
    ramdisk_data[113].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[114].data = data_things_exit3_start;
    ramdisk_data[114].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[115].data = data_things_exit4_start;
    ramdisk_data[115].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[116].data = data_things_exit5_start;
    ramdisk_data[116].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[117].data = data_things_exit6_start;
    ramdisk_data[117].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[118].data = data_things_exit7_start;
    ramdisk_data[118].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[119].data = data_things_explosion1_start;
    ramdisk_data[119].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[120].data = data_things_explosion2_start;
    ramdisk_data[120].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[121].data = data_things_explosion3_start;
    ramdisk_data[121].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[122].data = data_things_explosion4_start;
    ramdisk_data[122].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[123].data = data_things_fireball_start;
    ramdisk_data[123].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[124].data = data_things_floor1_start;
    ramdisk_data[124].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[125].data = data_things_floor2_start;
    ramdisk_data[125].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[126].data = data_things_floor3_start;
    ramdisk_data[126].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[127].data = data_things_floor4_start;
    ramdisk_data[127].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[128].data = data_things_floor5_start;
    ramdisk_data[128].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[129].data = data_things_floor6_start;
    ramdisk_data[129].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[130].data = data_things_gem1_start;
    ramdisk_data[130].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[131].data = data_things_gem2_start;
    ramdisk_data[131].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[132].data = data_things_gem3_start;
    ramdisk_data[132].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[133].data = data_things_gem4_start;
    ramdisk_data[133].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[134].data = data_things_gem5_start;
    ramdisk_data[134].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[135].data = data_things_gem6_start;
    ramdisk_data[135].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[136].data = data_things_gem7_start;
    ramdisk_data[136].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[137].data = data_things_generator1_start;
    ramdisk_data[137].len = data_things_generator1_end - data_things_generator1_start;
    ...
    ramdisk_data[144].data = data_things_hit_miss_start;
    ramdisk_data[144].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[145].data = data_things_hit_success_start;
    ramdisk_data[145].len = data_things_hit_success_end - data_things_hit_success_start;
    ramdisk_data[146].data = data_things_key_start;
    ramdisk_data[146].len = data_things_key_end - data_things_key_start;
    ramdisk_data[147].data = data_things_keys2_start;
    ramdisk_data[147].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[148].data = data_things_keys3_start;
    ramdisk_data[148].len = data_things_keys3_end - data_things_keys3_start;
    ...
    ramdisk_data[151].data = data_things_poison1_start;
    ramdisk_data[151].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[152].data = data_things_poison2_start;
    ramdisk_data[152].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[153].data = data_things_poison3_start;
    ramdisk_data[153].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[154].data = data_things_poison4_start;
    ramdisk_data[154].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[155].data = data_things_potion_cloudkill_start;
    ramdisk_data[155].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ...
    ramdisk_data[157].data = data_things_potion_life_start;
    ramdisk_data[157].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[158].data = data_things_potion_monsticide_start;
    ramdisk_data[158].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[159].data = data_things_potion_shield_start;
    ramdisk_data[159].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[160].data = data_things_ring1_start;
    ramdisk_data[160].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[161].data = data_things_ring2_start;
    ramdisk_data[161].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[162].data = data_things_ring3_start;
    ramdisk_data[162].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[163].data = data_things_rock1_start;
    ramdisk_data[163].len = data_things_rock1_end - data_things_rock1_start;
    ...
    ramdisk_data[166].data = data_things_spam_start;
    ramdisk_data[166].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[167].data = data_things_sword1_start;
    ramdisk_data[167].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[168].data = data_things_sword1_anim_start;
    ramdisk_data[168].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[169].data = data_things_sword2_start;
    ramdisk_data[169].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[170].data = data_things_sword2_anim_start;
    ramdisk_data[170].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[171].data = data_things_sword3_start;
    ramdisk_data[171].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[172].data = data_things_sword3_anim_start;
    ramdisk_data[172].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[173].data = data_things_torch_start;
    ramdisk_data[173].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[174].data = data_things_torches_start;
    ramdisk_data[174].len = data_things_torches_end - data_things_torches_start;
    ramdisk_data[175].data = data_things_valkyrie_start;
    ramdisk_data[175].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[176].data = data_things_wall1_start;
    ramdisk_data[176].len = data_things_wall1_end - data_things_wall1_start;
    ...
    ramdisk_data[181].data = data_things_wall6_start;
    ramdisk_data[181].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[182].data = data_things_wand1_anim_start;
    ramdisk_data[182].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ramdisk_data[183].data = data_things_wand_fire_start;
    ramdisk_data[183].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[184].data = data_things_warrior_start;
    ramdisk_data[184].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[185].data = data_things_water_start;
    ramdisk_data[185].len = data_things_water_end - data_things_water_start;
    ramdisk_data[186].data = data_things_water_poison_start;
    ramdisk_data[186].len = data_things_water_poison_end - data_things_water_poison_start;
    ramdisk_data[187].data = data_things_weapon_swing1_start;
    ramdisk_data[187].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
    ramdisk_data[188].data = data_things_wizard_start;
    ramdisk_data[188].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[189].data = data_ttf__LICENSE_txt_session_start;
    ramdisk_data[189].len = data_ttf__LICENSE_txt_session_end - data_ttf__LICENSE_txt_session_start;
    ramdisk_data[190].data = data_ttf__Readme_txt_session_start;
    ramdisk_data[190].len = data_ttf__Readme_txt_session_end - data_ttf__Readme_txt_session_start;
    ...
    ramdisk_data[241].data = data_ttf_OFL_txt_start;
    ramdisk_data[241].len = data_ttf_OFL_txt_end - data_ttf_OFL_txt_start;
    ramdisk_data[242].data = data_ttf_Readme_txt_start;
    ramdisk_data[242].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
}
