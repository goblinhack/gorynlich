...
void ramdisk_init (void)
{
    ...
    ramdisk_data[10].data = data_levels_1_start;
    ramdisk_data[10].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[11].data = data_levels_2_start;
    ramdisk_data[11].len = data_levels_2_end - data_levels_2_start;
    ...
    ramdisk_data[31].data = data_things__death_session_start;
    ramdisk_data[31].len = data_things__death_session_end - data_things__death_session_start;
    ramdisk_data[32].data = data_things__demon_session_start;
    ramdisk_data[32].len = data_things__demon_session_end - data_things__demon_session_start;
    ramdisk_data[33].data = data_things__dwarve_session_start;
    ramdisk_data[33].len = data_things__dwarve_session_end - data_things__dwarve_session_start;
    ramdisk_data[34].data = data_things__elve_session_start;
    ramdisk_data[34].len = data_things__elve_session_end - data_things__elve_session_start;
    ramdisk_data[35].data = data_things__ghost_session_start;
    ramdisk_data[35].len = data_things__ghost_session_end - data_things__ghost_session_start;
    ramdisk_data[36].data = data_things__lizard_session_start;
    ramdisk_data[36].len = data_things__lizard_session_end - data_things__lizard_session_start;
    ramdisk_data[37].data = data_things__monk_session_start;
    ramdisk_data[37].len = data_things__monk_session_end - data_things__monk_session_start;
    ramdisk_data[38].data = data_things__valkyrie_session_start;
    ramdisk_data[38].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[39].data = data_things__warrior_session_start;
    ramdisk_data[39].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[40].data = data_things__wizard_session_start;
    ramdisk_data[40].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ...
    ramdisk_data[48].data = data_things_dwarve_start;
    ramdisk_data[48].len = data_things_dwarve_end - data_things_dwarve_start;
    ramdisk_data[49].data = data_things_elve_start;
    ramdisk_data[49].len = data_things_elve_end - data_things_elve_start;
