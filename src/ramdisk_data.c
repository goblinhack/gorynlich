...
void ramdisk_init (void)
{
    ...
    ramdisk_data[43].data = data_things__elf_session_start;
    ramdisk_data[43].len = data_things__elf_session_end - data_things__elf_session_start;
    ...
    ramdisk_data[45].data = data_things__explosion1_session_start;
    ramdisk_data[45].len = data_things__explosion1_session_end - data_things__explosion1_session_start;
    ramdisk_data[46].data = data_things__explosion3_session_start;
    ramdisk_data[46].len = data_things__explosion3_session_end - data_things__explosion3_session_start;
    ramdisk_data[47].data = data_things__explosion4_session_start;
    ramdisk_data[47].len = data_things__explosion4_session_end - data_things__explosion4_session_start;
    ramdisk_data[48].data = data_things__floor1_session_start;
    ramdisk_data[48].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[49].data = data_things__floor6_session_start;
    ramdisk_data[49].len = data_things__floor6_session_end - data_things__floor6_session_start;
    ramdisk_data[50].data = data_things__key1_session_start;
    ramdisk_data[50].len = data_things__key1_session_end - data_things__key1_session_start;
    ramdisk_data[51].data = data_things__keys2_session_start;
    ramdisk_data[51].len = data_things__keys2_session_end - data_things__keys2_session_start;
    ramdisk_data[52].data = data_things__keys3_session_start;
    ramdisk_data[52].len = data_things__keys3_session_end - data_things__keys3_session_start;
    ramdisk_data[53].data = data_things__lantern_session_start;
    ramdisk_data[53].len = data_things__lantern_session_end - data_things__lantern_session_start;
    ...
    ramdisk_data[79].data = data_things_bread_start;
    ramdisk_data[79].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[80].data = data_things_cheese_start;
    ramdisk_data[80].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[81].data = data_things_chest1_start;
    ramdisk_data[81].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[82].data = data_things_cloudkill1_start;
    ramdisk_data[82].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[83].data = data_things_cloudkill2_start;
    ramdisk_data[83].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[84].data = data_things_cloudkill3_start;
    ramdisk_data[84].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[85].data = data_things_cloudkill4_start;
    ramdisk_data[85].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[86].data = data_things_coins1_start;
    ramdisk_data[86].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[87].data = data_things_death_start;
    ramdisk_data[87].len = data_things_death_end - data_things_death_start;
    ramdisk_data[88].data = data_things_demon_start;
    ramdisk_data[88].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[89].data = data_things_door1_start;
    ramdisk_data[89].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[90].data = data_things_door2_start;
    ramdisk_data[90].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[91].data = data_things_dwarf_start;
    ramdisk_data[91].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[92].data = data_things_elf_start;
    ramdisk_data[92].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[93].data = data_things_exit1_start;
    ramdisk_data[93].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[94].data = data_things_exit2_start;
    ramdisk_data[94].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[95].data = data_things_exit3_start;
    ramdisk_data[95].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[96].data = data_things_exit4_start;
    ramdisk_data[96].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[97].data = data_things_exit5_start;
    ramdisk_data[97].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[98].data = data_things_exit6_start;
    ramdisk_data[98].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[99].data = data_things_exit7_start;
    ramdisk_data[99].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[100].data = data_things_explosion1_start;
    ramdisk_data[100].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[101].data = data_things_explosion2_start;
    ramdisk_data[101].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[102].data = data_things_explosion3_start;
    ramdisk_data[102].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[103].data = data_things_explosion4_start;
    ramdisk_data[103].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[104].data = data_things_fireball_start;
    ramdisk_data[104].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[105].data = data_things_floor1_start;
    ramdisk_data[105].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[106].data = data_things_floor2_start;
    ramdisk_data[106].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[107].data = data_things_floor3_start;
    ramdisk_data[107].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[108].data = data_things_floor4_start;
    ramdisk_data[108].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[109].data = data_things_floor5_start;
    ramdisk_data[109].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[110].data = data_things_floor6_start;
    ramdisk_data[110].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[111].data = data_things_gem1_start;
    ramdisk_data[111].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[112].data = data_things_gem2_start;
    ramdisk_data[112].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[113].data = data_things_gem3_start;
    ramdisk_data[113].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[114].data = data_things_gem4_start;
    ramdisk_data[114].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[115].data = data_things_gem5_start;
    ramdisk_data[115].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[116].data = data_things_gem6_start;
    ramdisk_data[116].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[117].data = data_things_gem7_start;
    ramdisk_data[117].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[118].data = data_things_generator1_start;
    ramdisk_data[118].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[119].data = data_things_generator5_start;
    ramdisk_data[119].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[120].data = data_things_generator6_start;
    ramdisk_data[120].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[121].data = data_things_generator7_start;
    ramdisk_data[121].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[122].data = data_things_ghost1_start;
    ramdisk_data[122].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[123].data = data_things_ghost2_start;
    ramdisk_data[123].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[124].data = data_things_ghost3_start;
    ramdisk_data[124].len = data_things_ghost3_end - data_things_ghost3_start;
    ...
    ramdisk_data[128].data = data_things_lantern_start;
    ramdisk_data[128].len = data_things_lantern_end - data_things_lantern_start;
