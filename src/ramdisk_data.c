...
void ramdisk_init (void)
{
    ...
    ramdisk_data[0].len = (int32_t) (data_gfx_anim_eyes_png_end - data_gfx_anim_eyes_png_start);
    ramdisk_data[1].data = data_gfx_anim_man_png_start;
    ramdisk_data[1].len = (int32_t) (data_gfx_anim_man_png_end - data_gfx_anim_man_png_start);
    ramdisk_data[2].data = data_gfx_anim_treasure_chest_png_start;
    ramdisk_data[2].len = (int32_t) (data_gfx_anim_treasure_chest_png_end - data_gfx_anim_treasure_chest_png_start);
    ramdisk_data[3].data = data_gfx_button_black_png_start;
    ramdisk_data[3].len = (int32_t) (data_gfx_button_black_png_end - data_gfx_button_black_png_start);
    ramdisk_data[4].data = data_gfx_button_green_png_start;
    ramdisk_data[4].len = (int32_t) (data_gfx_button_green_png_end - data_gfx_button_green_png_start);
    ramdisk_data[5].data = data_gfx_button_red_png_start;
    ramdisk_data[5].len = (int32_t) (data_gfx_button_red_png_end - data_gfx_button_red_png_start);
    ramdisk_data[6].data = data_gfx_cloudkill_png_start;
    ramdisk_data[6].len = (int32_t) (data_gfx_cloudkill_png_end - data_gfx_cloudkill_png_start);
    ramdisk_data[7].data = data_gfx_crystal_png_start;
    ramdisk_data[7].len = (int32_t) (data_gfx_crystal_png_end - data_gfx_crystal_png_start);
    ramdisk_data[8].data = data_gfx_crystalball_png_start;
    ramdisk_data[8].len = (int32_t) (data_gfx_crystalball_png_end - data_gfx_crystalball_png_start);
    ramdisk_data[9].data = data_gfx_crystalball_purple_png_start;
    ramdisk_data[9].len = (int32_t) (data_gfx_crystalball_purple_png_end - data_gfx_crystalball_purple_png_start);
    ramdisk_data[10].data = data_gfx_dragon_png_start;
    ramdisk_data[10].len = (int32_t) (data_gfx_dragon_png_end - data_gfx_dragon_png_start);
    ramdisk_data[11].data = data_gfx_explosion_png_start;
    ramdisk_data[11].len = (int32_t) (data_gfx_explosion_png_end - data_gfx_explosion_png_start);
    ramdisk_data[12].data = data_gfx_giant_rock_png_start;
    ramdisk_data[12].len = (int32_t) (data_gfx_giant_rock_png_end - data_gfx_giant_rock_png_start);
    ramdisk_data[13].data = data_gfx_gorynlich_png_start;
    ramdisk_data[13].len = (int32_t) (data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start);
    ramdisk_data[14].data = data_gfx_gothic_tall_axe_png_start;
    ramdisk_data[14].len = (int32_t) (data_gfx_gothic_tall_axe_png_end - data_gfx_gothic_tall_axe_png_start);
    ramdisk_data[15].data = data_gfx_gothic_tall_chest_png_start;
    ramdisk_data[15].len = (int32_t) (data_gfx_gothic_tall_chest_png_end - data_gfx_gothic_tall_chest_png_start);
    ramdisk_data[16].data = data_gfx_gothic_tall_skull_png_start;
    ramdisk_data[16].len = (int32_t) (data_gfx_gothic_tall_skull_png_end - data_gfx_gothic_tall_skull_png_start);
    ramdisk_data[17].data = data_gfx_gothic_wide_png_start;
    ramdisk_data[17].len = (int32_t) (data_gfx_gothic_wide_png_end - data_gfx_gothic_wide_png_start);
    ramdisk_data[18].data = data_gfx_gravestone_png_start;
    ramdisk_data[18].len = (int32_t) (data_gfx_gravestone_png_end - data_gfx_gravestone_png_start);
    ramdisk_data[19].data = data_gfx_gravestone2_png_start;
    ramdisk_data[19].len = (int32_t) (data_gfx_gravestone2_png_end - data_gfx_gravestone2_png_start);
    ramdisk_data[20].data = data_gfx_itembar_png_start;
    ramdisk_data[20].len = (int32_t) (data_gfx_itembar_png_end - data_gfx_itembar_png_start);
    ramdisk_data[21].data = data_gfx_main_title_png_start;
    ramdisk_data[21].len = (int32_t) (data_gfx_main_title_png_end - data_gfx_main_title_png_start);
    ramdisk_data[22].data = data_gfx_poison_png_start;
    ramdisk_data[22].len = (int32_t) (data_gfx_poison_png_end - data_gfx_poison_png_start);
    ramdisk_data[23].data = data_gfx_rat_png_start;
    ramdisk_data[23].len = (int32_t) (data_gfx_rat_png_end - data_gfx_rat_png_start);
    ramdisk_data[24].data = data_gfx_sprites_small_png_start;
    ramdisk_data[24].len = (int32_t) (data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start);
    ramdisk_data[25].data = data_gfx_squiggles_png_start;
    ramdisk_data[25].len = (int32_t) (data_gfx_squiggles_png_end - data_gfx_squiggles_png_start);
    ramdisk_data[26].data = data_gfx_title_png_start;
    ramdisk_data[26].len = (int32_t) (data_gfx_title_png_end - data_gfx_title_png_start);
    ramdisk_data[27].data = data_gfx_title2_png_start;
    ramdisk_data[27].len = (int32_t) (data_gfx_title2_png_end - data_gfx_title2_png_start);
    ramdisk_data[28].data = data_gfx_title3_png_start;
    ramdisk_data[28].len = (int32_t) (data_gfx_title3_png_end - data_gfx_title3_png_start);
    ramdisk_data[29].data = data_gfx_title_small_png_start;
    ramdisk_data[29].len = (int32_t) (data_gfx_title_small_png_end - data_gfx_title_small_png_start);
    ramdisk_data[30].data = data_gfx_wall_floor_png_start;
    ramdisk_data[30].len = (int32_t) (data_gfx_wall_floor_png_end - data_gfx_wall_floor_png_start);
    ramdisk_data[31].data = data_gfx_window_gothic_png_start;
    ramdisk_data[31].len = (int32_t) (data_gfx_window_gothic_png_end - data_gfx_window_gothic_png_start);
    ramdisk_data[32].data = data_gfx_window_gothic_wide_png_start;
    ramdisk_data[32].len = (int32_t) (data_gfx_window_gothic_wide_png_end - data_gfx_window_gothic_wide_png_start);
    ramdisk_data[33].data = data_gfx_window_rock_png_start;
    ramdisk_data[33].len = (int32_t) (data_gfx_window_rock_png_end - data_gfx_window_rock_png_start);
    ramdisk_data[34].data = data_levels_1_start;
    ramdisk_data[34].len = (int32_t) (data_levels_1_end - data_levels_1_start);
    ramdisk_data[35].data = data_levels_1_old_start;
    ramdisk_data[35].len = (int32_t) (data_levels_1_old_end - data_levels_1_old_start);
    ramdisk_data[36].data = data_map__jigsaw_map_session_start;
    ramdisk_data[36].len = (int32_t) (data_map__jigsaw_map_session_end - data_map__jigsaw_map_session_start);
    ramdisk_data[37].data = data_map_jigsaw_map_start;
    ramdisk_data[37].len = (int32_t) (data_map_jigsaw_map_end - data_map_jigsaw_map_start);
    ramdisk_data[38].data = data_map_jigsaw1_map_start;
    ramdisk_data[38].len = (int32_t) (data_map_jigsaw1_map_end - data_map_jigsaw1_map_start);
    ramdisk_data[39].data = data_music__1_session_start;
    ramdisk_data[39].len = (int32_t) (data_music__1_session_end - data_music__1_session_start);
    ramdisk_data[40].data = data_music__resample_sh_session_start;
    ramdisk_data[40].len = (int32_t) (data_music__resample_sh_session_end - data_music__resample_sh_session_start);
    ramdisk_data[41].data = data_music_charlotte_ogg_start;
    ramdisk_data[41].len = (int32_t) (data_music_charlotte_ogg_end - data_music_charlotte_ogg_start);
    ramdisk_data[42].data = data_music_charlotte8bit_ogg_start;
    ramdisk_data[42].len = (int32_t) (data_music_charlotte8bit_ogg_end - data_music_charlotte8bit_ogg_start);
    ramdisk_data[43].data = data_music_charlotte_slow_ogg_start;
    ramdisk_data[43].len = (int32_t) (data_music_charlotte_slow_ogg_end - data_music_charlotte_slow_ogg_start);
    ramdisk_data[44].data = data_music_DST_Alters_ogg_start;
    ramdisk_data[44].len = (int32_t) (data_music_DST_Alters_ogg_end - data_music_DST_Alters_ogg_start);
    ramdisk_data[45].data = data_music_DST_AncientCurse_II_ogg_start;
    ramdisk_data[45].len = (int32_t) (data_music_DST_AncientCurse_II_ogg_end - data_music_DST_AncientCurse_II_ogg_start);
    ramdisk_data[46].data = data_music_DST_Arch_Delerium_ogg_start;
    ramdisk_data[46].len = (int32_t) (data_music_DST_Arch_Delerium_ogg_end - data_music_DST_Arch_Delerium_ogg_start);
    ramdisk_data[47].data = data_music_DST_Arches_ogg_start;
    ramdisk_data[47].len = (int32_t) (data_music_DST_Arches_ogg_end - data_music_DST_Arches_ogg_start);
    ramdisk_data[48].data = data_music_DST_BattleLands_ogg_start;
    ramdisk_data[48].len = (int32_t) (data_music_DST_BattleLands_ogg_end - data_music_DST_BattleLands_ogg_start);
    ramdisk_data[49].data = data_music_DST_BlackRiver_ogg_start;
    ramdisk_data[49].len = (int32_t) (data_music_DST_BlackRiver_ogg_end - data_music_DST_BlackRiver_ogg_start);
    ramdisk_data[50].data = data_music_DST_BoneTower_ogg_start;
    ramdisk_data[50].len = (int32_t) (data_music_DST_BoneTower_ogg_end - data_music_DST_BoneTower_ogg_start);
    ramdisk_data[51].data = data_music_DST_ClockTower_ogg_start;
    ramdisk_data[51].len = (int32_t) (data_music_DST_ClockTower_ogg_end - data_music_DST_ClockTower_ogg_start);
    ramdisk_data[52].data = data_music_DST_DarkestKnight_ogg_start;
    ramdisk_data[52].len = (int32_t) (data_music_DST_DarkestKnight_ogg_end - data_music_DST_DarkestKnight_ogg_start);
    ramdisk_data[53].data = data_music_DST_DoomCity_ogg_start;
    ramdisk_data[53].len = (int32_t) (data_music_DST_DoomCity_ogg_end - data_music_DST_DoomCity_ogg_start);
    ramdisk_data[54].data = data_music_DST_ExInfernus_ogg_start;
    ramdisk_data[54].len = (int32_t) (data_music_DST_ExInfernus_ogg_end - data_music_DST_ExInfernus_ogg_start);
    ramdisk_data[55].data = data_music_DST_LeDanse_ogg_start;
    ramdisk_data[55].len = (int32_t) (data_music_DST_LeDanse_ogg_end - data_music_DST_LeDanse_ogg_start);
    ramdisk_data[56].data = data_music_DST_Legends_ogg_start;
    ramdisk_data[56].len = (int32_t) (data_music_DST_Legends_ogg_end - data_music_DST_Legends_ogg_start);
    ramdisk_data[57].data = data_music_DST_SuperWin_ogg_start;
    ramdisk_data[57].len = (int32_t) (data_music_DST_SuperWin_ogg_end - data_music_DST_SuperWin_ogg_start);
    ramdisk_data[58].data = data_music_oggconv_sh_start;
    ramdisk_data[58].len = (int32_t) (data_music_oggconv_sh_end - data_music_oggconv_sh_start);
    ramdisk_data[59].data = data_music_resample_sh_start;
    ramdisk_data[59].len = (int32_t) (data_music_resample_sh_end - data_music_resample_sh_start);
    ramdisk_data[60].data = data_sound_boom_wav_start;
    ramdisk_data[60].len = (int32_t) (data_sound_boom_wav_end - data_sound_boom_wav_start);
    ramdisk_data[61].data = data_sound_cash_register_wav_start;
    ramdisk_data[61].len = (int32_t) (data_sound_cash_register_wav_end - data_sound_cash_register_wav_start);
    ramdisk_data[62].data = data_sound_click_wav_start;
    ramdisk_data[62].len = (int32_t) (data_sound_click_wav_end - data_sound_click_wav_start);
    ramdisk_data[63].data = data_sound_demon_wav_start;
    ramdisk_data[63].len = (int32_t) (data_sound_demon_wav_end - data_sound_demon_wav_start);
    ramdisk_data[64].data = data_sound_dinosaur_wav_start;
    ramdisk_data[64].len = (int32_t) (data_sound_dinosaur_wav_end - data_sound_dinosaur_wav_start);
    ramdisk_data[65].data = data_sound_drop_wav_start;
    ramdisk_data[65].len = (int32_t) (data_sound_drop_wav_end - data_sound_drop_wav_start);
    ramdisk_data[66].data = data_sound_explosion_wav_start;
    ramdisk_data[66].len = (int32_t) (data_sound_explosion_wav_end - data_sound_explosion_wav_start);
    ramdisk_data[67].data = data_sound_explosion_big_wav_start;
    ramdisk_data[67].len = (int32_t) (data_sound_explosion_big_wav_end - data_sound_explosion_big_wav_start);
    ramdisk_data[68].data = data_sound_kick_wav_start;
    ramdisk_data[68].len = (int32_t) (data_sound_kick_wav_end - data_sound_kick_wav_start);
    ramdisk_data[69].data = data_sound_laugh_wav_start;
    ramdisk_data[69].len = (int32_t) (data_sound_laugh_wav_end - data_sound_laugh_wav_start);
    ramdisk_data[70].data = data_sound_level_end_wav_start;
    ramdisk_data[70].len = (int32_t) (data_sound_level_end_wav_end - data_sound_level_end_wav_start);
    ramdisk_data[71].data = data_sound_magic_tinkle_wav_start;
    ramdisk_data[71].len = (int32_t) (data_sound_magic_tinkle_wav_end - data_sound_magic_tinkle_wav_start);
    ...
    ramdisk_data[73].data = data_sound_scream_male_wav_start;
    ramdisk_data[73].len = (int32_t) (data_sound_scream_male_wav_end - data_sound_scream_male_wav_start);
    ramdisk_data[74].data = data_sound_shriek_wav_start;
    ramdisk_data[74].len = (int32_t) (data_sound_shriek_wav_end - data_sound_shriek_wav_start);
    ramdisk_data[75].data = data_sound_slime_wav_start;
    ramdisk_data[75].len = (int32_t) (data_sound_slime_wav_end - data_sound_slime_wav_start);
    ramdisk_data[76].data = data_sound_sword_wav_start;
    ramdisk_data[76].len = (int32_t) (data_sound_sword_wav_end - data_sound_sword_wav_start);
    ramdisk_data[77].data = data_sound_treasure_wav_start;
    ramdisk_data[77].len = (int32_t) (data_sound_treasure_wav_end - data_sound_treasure_wav_start);
    ramdisk_data[78].data = data_sound_wand_dead_wav_start;
    ramdisk_data[78].len = (int32_t) (data_sound_wand_dead_wav_end - data_sound_wand_dead_wav_start);
    ramdisk_data[79].data = data_things__amulet1_session_start;
    ramdisk_data[79].len = (int32_t) (data_things__amulet1_session_end - data_things__amulet1_session_start);
    ramdisk_data[80].data = data_things__apple1_session_start;
    ramdisk_data[80].len = (int32_t) (data_things__apple1_session_end - data_things__apple1_session_start);
    ramdisk_data[81].data = data_things__apple_poison_session_start;
    ramdisk_data[81].len = (int32_t) (data_things__apple_poison_session_end - data_things__apple_poison_session_start);
    ramdisk_data[82].data = data_things__axe1_session_start;
    ramdisk_data[82].len = (int32_t) (data_things__axe1_session_end - data_things__axe1_session_start);
    ramdisk_data[83].data = data_things__axe3_session_start;
    ramdisk_data[83].len = (int32_t) (data_things__axe3_session_end - data_things__axe3_session_start);
    ramdisk_data[84].data = data_things__axe4_session_start;
    ramdisk_data[84].len = (int32_t) (data_things__axe4_session_end - data_things__axe4_session_start);
    ramdisk_data[85].data = data_things__axe5_session_start;
    ramdisk_data[85].len = (int32_t) (data_things__axe5_session_end - data_things__axe5_session_start);
    ramdisk_data[86].data = data_things__bread_session_start;
    ramdisk_data[86].len = (int32_t) (data_things__bread_session_end - data_things__bread_session_start);
    ramdisk_data[87].data = data_things__chest1_session_start;
    ramdisk_data[87].len = (int32_t) (data_things__chest1_session_end - data_things__chest1_session_start);
    ramdisk_data[88].data = data_things__coins1_session_start;
    ramdisk_data[88].len = (int32_t) (data_things__coins1_session_end - data_things__coins1_session_start);
    ramdisk_data[89].data = data_things__death_session_start;
    ramdisk_data[89].len = (int32_t) (data_things__death_session_end - data_things__death_session_start);
    ramdisk_data[90].data = data_things__door2_session_start;
    ramdisk_data[90].len = (int32_t) (data_things__door2_session_end - data_things__door2_session_start);
    ramdisk_data[91].data = data_things__dwarf_session_start;
    ramdisk_data[91].len = (int32_t) (data_things__dwarf_session_end - data_things__dwarf_session_start);
    ramdisk_data[92].data = data_things__elf_session_start;
    ramdisk_data[92].len = (int32_t) (data_things__elf_session_end - data_things__elf_session_start);
    ramdisk_data[93].data = data_things__key_session_start;
    ramdisk_data[93].len = (int32_t) (data_things__key_session_end - data_things__key_session_start);
    ramdisk_data[94].data = data_things__keys2_session_start;
    ramdisk_data[94].len = (int32_t) (data_things__keys2_session_end - data_things__keys2_session_start);
    ramdisk_data[95].data = data_things__potion_life_session_start;
    ramdisk_data[95].len = (int32_t) (data_things__potion_life_session_end - data_things__potion_life_session_start);
    ramdisk_data[96].data = data_things__ring2_session_start;
    ramdisk_data[96].len = (int32_t) (data_things__ring2_session_end - data_things__ring2_session_start);
    ramdisk_data[97].data = data_things__sword_session_start;
    ramdisk_data[97].len = (int32_t) (data_things__sword_session_end - data_things__sword_session_start);
    ramdisk_data[98].data = data_things__sword1_session_start;
    ramdisk_data[98].len = (int32_t) (data_things__sword1_session_end - data_things__sword1_session_start);
    ramdisk_data[99].data = data_things__sword1_anim_session_start;
    ramdisk_data[99].len = (int32_t) (data_things__sword1_anim_session_end - data_things__sword1_anim_session_start);
    ramdisk_data[100].data = data_things__sword2_session_start;
    ramdisk_data[100].len = (int32_t) (data_things__sword2_session_end - data_things__sword2_session_start);
    ramdisk_data[101].data = data_things__sword4_session_start;
    ramdisk_data[101].len = (int32_t) (data_things__sword4_session_end - data_things__sword4_session_start);
    ramdisk_data[102].data = data_things__thing_h_session_start;
    ramdisk_data[102].len = (int32_t) (data_things__thing_h_session_end - data_things__thing_h_session_start);
    ramdisk_data[103].data = data_things__thing_template_h_session_start;
    ramdisk_data[103].len = (int32_t) (data_things__thing_template_h_session_end - data_things__thing_template_h_session_start);
    ramdisk_data[104].data = data_things__torches_session_start;
    ramdisk_data[104].len = (int32_t) (data_things__torches_session_end - data_things__torches_session_start);
    ramdisk_data[105].data = data_things__valkyrie_session_start;
    ramdisk_data[105].len = (int32_t) (data_things__valkyrie_session_end - data_things__valkyrie_session_start);
    ramdisk_data[106].data = data_things__wand_session_start;
    ramdisk_data[106].len = (int32_t) (data_things__wand_session_end - data_things__wand_session_start);
    ramdisk_data[107].data = data_things__wand_fire_session_start;
    ramdisk_data[107].len = (int32_t) (data_things__wand_fire_session_end - data_things__wand_fire_session_start);
    ramdisk_data[108].data = data_things__warrior_session_start;
    ramdisk_data[108].len = (int32_t) (data_things__warrior_session_end - data_things__warrior_session_start);
    ramdisk_data[109].data = data_things__water_session_start;
    ramdisk_data[109].len = (int32_t) (data_things__water_session_end - data_things__water_session_start);
    ramdisk_data[110].data = data_things__water_poison_session_start;
    ramdisk_data[110].len = (int32_t) (data_things__water_poison_session_end - data_things__water_poison_session_start);
    ramdisk_data[111].data = data_things__weapon_swing1_session_start;
    ramdisk_data[111].len = (int32_t) (data_things__weapon_swing1_session_end - data_things__weapon_swing1_session_start);
    ramdisk_data[112].data = data_things__wizard_session_start;
    ramdisk_data[112].len = (int32_t) (data_things__wizard_session_end - data_things__wizard_session_start);
    ramdisk_data[113].data = data_things_anim_eyes_start;
    ramdisk_data[113].len = (int32_t) (data_things_anim_eyes_end - data_things_anim_eyes_start);
    ramdisk_data[114].data = data_things_anim_man_start;
    ramdisk_data[114].len = (int32_t) (data_things_anim_man_end - data_things_anim_man_start);
    ramdisk_data[115].data = data_things_anim_treasure_chest_start;
    ramdisk_data[115].len = (int32_t) (data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start);
    ramdisk_data[116].data = data_things_apple1_start;
    ramdisk_data[116].len = (int32_t) (data_things_apple1_end - data_things_apple1_start);
    ramdisk_data[117].data = data_things_apple2_start;
    ramdisk_data[117].len = (int32_t) (data_things_apple2_end - data_things_apple2_start);
    ramdisk_data[118].data = data_things_arrow_start;
    ramdisk_data[118].len = (int32_t) (data_things_arrow_end - data_things_arrow_start);
    ramdisk_data[119].data = data_things_axe1_start;
    ramdisk_data[119].len = (int32_t) (data_things_axe1_end - data_things_axe1_start);
    ramdisk_data[120].data = data_things_axe1_anim_start;
    ramdisk_data[120].len = (int32_t) (data_things_axe1_anim_end - data_things_axe1_anim_start);
    ramdisk_data[121].data = data_things_axe2_start;
    ramdisk_data[121].len = (int32_t) (data_things_axe2_end - data_things_axe2_start);
    ramdisk_data[122].data = data_things_axe2_anim_start;
    ramdisk_data[122].len = (int32_t) (data_things_axe2_anim_end - data_things_axe2_anim_start);
    ramdisk_data[123].data = data_things_axe3_start;
    ramdisk_data[123].len = (int32_t) (data_things_axe3_end - data_things_axe3_start);
    ramdisk_data[124].data = data_things_axe4_start;
    ramdisk_data[124].len = (int32_t) (data_things_axe4_end - data_things_axe4_start);
    ramdisk_data[125].data = data_things_axe5_start;
    ramdisk_data[125].len = (int32_t) (data_things_axe5_end - data_things_axe5_start);
    ramdisk_data[126].data = data_things_banana_start;
    ramdisk_data[126].len = (int32_t) (data_things_banana_end - data_things_banana_start);
    ramdisk_data[127].data = data_things_blood1_start;
    ramdisk_data[127].len = (int32_t) (data_things_blood1_end - data_things_blood1_start);
    ramdisk_data[128].data = data_things_blood2_start;
    ramdisk_data[128].len = (int32_t) (data_things_blood2_end - data_things_blood2_start);
    ramdisk_data[129].data = data_things_bonepile1_start;
    ramdisk_data[129].len = (int32_t) (data_things_bonepile1_end - data_things_bonepile1_start);
    ramdisk_data[130].data = data_things_bonepile2_start;
    ramdisk_data[130].len = (int32_t) (data_things_bonepile2_end - data_things_bonepile2_start);
    ramdisk_data[131].data = data_things_bonepile3_start;
    ramdisk_data[131].len = (int32_t) (data_things_bonepile3_end - data_things_bonepile3_start);
    ramdisk_data[132].data = data_things_bow1_start;
    ramdisk_data[132].len = (int32_t) (data_things_bow1_end - data_things_bow1_start);
    ramdisk_data[133].data = data_things_bow1_anim_start;
    ramdisk_data[133].len = (int32_t) (data_things_bow1_anim_end - data_things_bow1_anim_start);
    ramdisk_data[134].data = data_things_bow2_start;
    ramdisk_data[134].len = (int32_t) (data_things_bow2_end - data_things_bow2_start);
    ramdisk_data[135].data = data_things_bow3_start;
    ramdisk_data[135].len = (int32_t) (data_things_bow3_end - data_things_bow3_start);
    ramdisk_data[136].data = data_things_bow4_start;
    ramdisk_data[136].len = (int32_t) (data_things_bow4_end - data_things_bow4_start);
    ramdisk_data[137].data = data_things_brazier_start;
    ramdisk_data[137].len = (int32_t) (data_things_brazier_end - data_things_brazier_start);
    ramdisk_data[138].data = data_things_bread_start;
    ramdisk_data[138].len = (int32_t) (data_things_bread_end - data_things_bread_start);
    ramdisk_data[139].data = data_things_cheese_start;
    ramdisk_data[139].len = (int32_t) (data_things_cheese_end - data_things_cheese_start);
    ramdisk_data[140].data = data_things_chest1_start;
    ramdisk_data[140].len = (int32_t) (data_things_chest1_end - data_things_chest1_start);
    ramdisk_data[141].data = data_things_cloudkill1_start;
    ramdisk_data[141].len = (int32_t) (data_things_cloudkill1_end - data_things_cloudkill1_start);
    ramdisk_data[142].data = data_things_cloudkill2_start;
    ramdisk_data[142].len = (int32_t) (data_things_cloudkill2_end - data_things_cloudkill2_start);
    ramdisk_data[143].data = data_things_cloudkill3_start;
    ramdisk_data[143].len = (int32_t) (data_things_cloudkill3_end - data_things_cloudkill3_start);
    ramdisk_data[144].data = data_things_cloudkill4_start;
    ramdisk_data[144].len = (int32_t) (data_things_cloudkill4_end - data_things_cloudkill4_start);
    ramdisk_data[145].data = data_things_coins1_start;
    ramdisk_data[145].len = (int32_t) (data_things_coins1_end - data_things_coins1_start);
    ramdisk_data[146].data = data_things_death_start;
    ramdisk_data[146].len = (int32_t) (data_things_death_end - data_things_death_start);
    ramdisk_data[147].data = data_things_door1_start;
    ramdisk_data[147].len = (int32_t) (data_things_door1_end - data_things_door1_start);
    ramdisk_data[148].data = data_things_door2_start;
    ramdisk_data[148].len = (int32_t) (data_things_door2_end - data_things_door2_start);
    ramdisk_data[149].data = data_things_dwarf_start;
    ramdisk_data[149].len = (int32_t) (data_things_dwarf_end - data_things_dwarf_start);
    ramdisk_data[150].data = data_things_elf_start;
    ramdisk_data[150].len = (int32_t) (data_things_elf_end - data_things_elf_start);
    ramdisk_data[151].data = data_things_exit1_start;
    ramdisk_data[151].len = (int32_t) (data_things_exit1_end - data_things_exit1_start);
    ramdisk_data[152].data = data_things_exit2_start;
    ramdisk_data[152].len = (int32_t) (data_things_exit2_end - data_things_exit2_start);
    ramdisk_data[153].data = data_things_exit3_start;
    ramdisk_data[153].len = (int32_t) (data_things_exit3_end - data_things_exit3_start);
    ramdisk_data[154].data = data_things_exit4_start;
    ramdisk_data[154].len = (int32_t) (data_things_exit4_end - data_things_exit4_start);
    ramdisk_data[155].data = data_things_exit5_start;
    ramdisk_data[155].len = (int32_t) (data_things_exit5_end - data_things_exit5_start);
    ramdisk_data[156].data = data_things_exit6_start;
    ramdisk_data[156].len = (int32_t) (data_things_exit6_end - data_things_exit6_start);
    ramdisk_data[157].data = data_things_exit7_start;
    ramdisk_data[157].len = (int32_t) (data_things_exit7_end - data_things_exit7_start);
    ramdisk_data[158].data = data_things_explosion1_start;
    ramdisk_data[158].len = (int32_t) (data_things_explosion1_end - data_things_explosion1_start);
    ramdisk_data[159].data = data_things_explosion2_start;
    ramdisk_data[159].len = (int32_t) (data_things_explosion2_end - data_things_explosion2_start);
    ramdisk_data[160].data = data_things_explosion3_start;
    ramdisk_data[160].len = (int32_t) (data_things_explosion3_end - data_things_explosion3_start);
    ramdisk_data[161].data = data_things_explosion4_start;
    ramdisk_data[161].len = (int32_t) (data_things_explosion4_end - data_things_explosion4_start);
    ramdisk_data[162].data = data_things_fireball_start;
    ramdisk_data[162].len = (int32_t) (data_things_fireball_end - data_things_fireball_start);
    ramdisk_data[163].data = data_things_floor1_start;
    ramdisk_data[163].len = (int32_t) (data_things_floor1_end - data_things_floor1_start);
    ramdisk_data[164].data = data_things_floor2_start;
    ramdisk_data[164].len = (int32_t) (data_things_floor2_end - data_things_floor2_start);
    ...
    ramdisk_data[166].data = data_things_floor4_start;
    ramdisk_data[166].len = (int32_t) (data_things_floor4_end - data_things_floor4_start);
    ramdisk_data[167].data = data_things_floor5_start;
    ramdisk_data[167].len = (int32_t) (data_things_floor5_end - data_things_floor5_start);
    ramdisk_data[168].data = data_things_floor6_start;
    ramdisk_data[168].len = (int32_t) (data_things_floor6_end - data_things_floor6_start);
    ramdisk_data[169].data = data_things_gem1_start;
    ramdisk_data[169].len = (int32_t) (data_things_gem1_end - data_things_gem1_start);
    ramdisk_data[170].data = data_things_gem2_start;
    ramdisk_data[170].len = (int32_t) (data_things_gem2_end - data_things_gem2_start);
    ramdisk_data[171].data = data_things_gem3_start;
    ramdisk_data[171].len = (int32_t) (data_things_gem3_end - data_things_gem3_start);
    ramdisk_data[172].data = data_things_gem4_start;
    ramdisk_data[172].len = (int32_t) (data_things_gem4_end - data_things_gem4_start);
    ramdisk_data[173].data = data_things_gem5_start;
    ramdisk_data[173].len = (int32_t) (data_things_gem5_end - data_things_gem5_start);
    ramdisk_data[174].data = data_things_gem6_start;
    ramdisk_data[174].len = (int32_t) (data_things_gem6_end - data_things_gem6_start);
    ramdisk_data[175].data = data_things_gem7_start;
    ramdisk_data[175].len = (int32_t) (data_things_gem7_end - data_things_gem7_start);
    ramdisk_data[176].data = data_things_generator1_start;
    ramdisk_data[176].len = (int32_t) (data_things_generator1_end - data_things_generator1_start);
    ramdisk_data[177].data = data_things_generator5_start;
    ramdisk_data[177].len = (int32_t) (data_things_generator5_end - data_things_generator5_start);
    ramdisk_data[178].data = data_things_generator6_start;
    ramdisk_data[178].len = (int32_t) (data_things_generator6_end - data_things_generator6_start);
    ramdisk_data[179].data = data_things_generator7_start;
    ramdisk_data[179].len = (int32_t) (data_things_generator7_end - data_things_generator7_start);
    ramdisk_data[180].data = data_things_ghost1_start;
    ramdisk_data[180].len = (int32_t) (data_things_ghost1_end - data_things_ghost1_start);
    ramdisk_data[181].data = data_things_ghost2_start;
    ramdisk_data[181].len = (int32_t) (data_things_ghost2_end - data_things_ghost2_start);
    ramdisk_data[182].data = data_things_ghost3_start;
    ramdisk_data[182].len = (int32_t) (data_things_ghost3_end - data_things_ghost3_start);
    ramdisk_data[183].data = data_things_hit_miss_start;
    ramdisk_data[183].len = (int32_t) (data_things_hit_miss_end - data_things_hit_miss_start);
    ramdisk_data[184].data = data_things_hit_success_start;
    ramdisk_data[184].len = (int32_t) (data_things_hit_success_end - data_things_hit_success_start);
    ramdisk_data[185].data = data_things_key_start;
    ramdisk_data[185].len = (int32_t) (data_things_key_end - data_things_key_start);
    ramdisk_data[186].data = data_things_keys2_start;
    ramdisk_data[186].len = (int32_t) (data_things_keys2_end - data_things_keys2_start);
    ramdisk_data[187].data = data_things_keys3_start;
    ramdisk_data[187].len = (int32_t) (data_things_keys3_end - data_things_keys3_start);
    ramdisk_data[188].data = data_things_noentry_start;
    ramdisk_data[188].len = (int32_t) (data_things_noentry_end - data_things_noentry_start);
    ramdisk_data[189].data = data_things_pipe_start;
    ramdisk_data[189].len = (int32_t) (data_things_pipe_end - data_things_pipe_start);
    ramdisk_data[190].data = data_things_poison1_start;
    ramdisk_data[190].len = (int32_t) (data_things_poison1_end - data_things_poison1_start);
    ramdisk_data[191].data = data_things_poison2_start;
    ramdisk_data[191].len = (int32_t) (data_things_poison2_end - data_things_poison2_start);
    ramdisk_data[192].data = data_things_poison3_start;
    ramdisk_data[192].len = (int32_t) (data_things_poison3_end - data_things_poison3_start);
    ramdisk_data[193].data = data_things_poison4_start;
    ramdisk_data[193].len = (int32_t) (data_things_poison4_end - data_things_poison4_start);
    ramdisk_data[194].data = data_things_potion_cloudkill_start;
    ramdisk_data[194].len = (int32_t) (data_things_potion_cloudkill_end - data_things_potion_cloudkill_start);
    ramdisk_data[195].data = data_things_potion_fire_start;
    ramdisk_data[195].len = (int32_t) (data_things_potion_fire_end - data_things_potion_fire_start);
    ramdisk_data[196].data = data_things_potion_life_start;
    ramdisk_data[196].len = (int32_t) (data_things_potion_life_end - data_things_potion_life_start);
    ramdisk_data[197].data = data_things_potion_monsticide_start;
    ramdisk_data[197].len = (int32_t) (data_things_potion_monsticide_end - data_things_potion_monsticide_start);
    ramdisk_data[198].data = data_things_potion_shield_start;
    ramdisk_data[198].len = (int32_t) (data_things_potion_shield_end - data_things_potion_shield_start);
    ramdisk_data[199].data = data_things_ring1_start;
    ramdisk_data[199].len = (int32_t) (data_things_ring1_end - data_things_ring1_start);
    ramdisk_data[200].data = data_things_ring2_start;
    ramdisk_data[200].len = (int32_t) (data_things_ring2_end - data_things_ring2_start);
    ramdisk_data[201].data = data_things_ring3_start;
    ramdisk_data[201].len = (int32_t) (data_things_ring3_end - data_things_ring3_start);
    ramdisk_data[202].data = data_things_rock1_start;
    ramdisk_data[202].len = (int32_t) (data_things_rock1_end - data_things_rock1_start);
    ramdisk_data[203].data = data_things_scythe1_start;
    ramdisk_data[203].len = (int32_t) (data_things_scythe1_end - data_things_scythe1_start);
    ramdisk_data[204].data = data_things_scythe1_anim_start;
    ramdisk_data[204].len = (int32_t) (data_things_scythe1_anim_end - data_things_scythe1_anim_start);
    ramdisk_data[205].data = data_things_spam_start;
    ramdisk_data[205].len = (int32_t) (data_things_spam_end - data_things_spam_start);
    ramdisk_data[206].data = data_things_sword1_start;
    ramdisk_data[206].len = (int32_t) (data_things_sword1_end - data_things_sword1_start);
    ramdisk_data[207].data = data_things_sword1_anim_start;
    ramdisk_data[207].len = (int32_t) (data_things_sword1_anim_end - data_things_sword1_anim_start);
    ramdisk_data[208].data = data_things_sword2_start;
    ramdisk_data[208].len = (int32_t) (data_things_sword2_end - data_things_sword2_start);
    ramdisk_data[209].data = data_things_sword2_anim_start;
    ramdisk_data[209].len = (int32_t) (data_things_sword2_anim_end - data_things_sword2_anim_start);
    ramdisk_data[210].data = data_things_sword3_start;
    ramdisk_data[210].len = (int32_t) (data_things_sword3_end - data_things_sword3_start);
    ramdisk_data[211].data = data_things_sword3_anim_start;
    ramdisk_data[211].len = (int32_t) (data_things_sword3_anim_end - data_things_sword3_anim_start);
    ramdisk_data[212].data = data_things_sword4_start;
    ramdisk_data[212].len = (int32_t) (data_things_sword4_end - data_things_sword4_start);
    ramdisk_data[213].data = data_things_sword5_start;
    ramdisk_data[213].len = (int32_t) (data_things_sword5_end - data_things_sword5_start);
    ramdisk_data[214].data = data_things_sword6_start;
    ramdisk_data[214].len = (int32_t) (data_things_sword6_end - data_things_sword6_start);
    ramdisk_data[215].data = data_things_torch_start;
    ramdisk_data[215].len = (int32_t) (data_things_torch_end - data_things_torch_start);
    ramdisk_data[216].data = data_things_torches_start;
    ramdisk_data[216].len = (int32_t) (data_things_torches_end - data_things_torches_start);
    ramdisk_data[217].data = data_things_valkyrie_start;
    ramdisk_data[217].len = (int32_t) (data_things_valkyrie_end - data_things_valkyrie_start);
    ramdisk_data[218].data = data_things_wall1_start;
    ramdisk_data[218].len = (int32_t) (data_things_wall1_end - data_things_wall1_start);
    ramdisk_data[219].data = data_things_wall2_start;
    ramdisk_data[219].len = (int32_t) (data_things_wall2_end - data_things_wall2_start);
    ramdisk_data[220].data = data_things_wall3_start;
    ramdisk_data[220].len = (int32_t) (data_things_wall3_end - data_things_wall3_start);
    ramdisk_data[221].data = data_things_wall4_start;
    ramdisk_data[221].len = (int32_t) (data_things_wall4_end - data_things_wall4_start);
    ramdisk_data[222].data = data_things_wall5_start;
    ramdisk_data[222].len = (int32_t) (data_things_wall5_end - data_things_wall5_start);
    ramdisk_data[223].data = data_things_wall6_start;
    ramdisk_data[223].len = (int32_t) (data_things_wall6_end - data_things_wall6_start);
    ramdisk_data[224].data = data_things_wand1_anim_start;
    ramdisk_data[224].len = (int32_t) (data_things_wand1_anim_end - data_things_wand1_anim_start);
    ramdisk_data[225].data = data_things_wand_fire_start;
    ramdisk_data[225].len = (int32_t) (data_things_wand_fire_end - data_things_wand_fire_start);
    ramdisk_data[226].data = data_things_warrior_start;
    ramdisk_data[226].len = (int32_t) (data_things_warrior_end - data_things_warrior_start);
    ramdisk_data[227].data = data_things_water_start;
    ramdisk_data[227].len = (int32_t) (data_things_water_end - data_things_water_start);
    ramdisk_data[228].data = data_things_water_poison_start;
    ramdisk_data[228].len = (int32_t) (data_things_water_poison_end - data_things_water_poison_start);
    ramdisk_data[229].data = data_things_weapon_swing1_start;
    ramdisk_data[229].len = (int32_t) (data_things_weapon_swing1_end - data_things_weapon_swing1_start);
    ramdisk_data[230].data = data_things_wizard_start;
    ramdisk_data[230].len = (int32_t) (data_things_wizard_end - data_things_wizard_start);
    ramdisk_data[231].data = data_ttf_emulogic_gif_start;
    ramdisk_data[231].len = (int32_t) (data_ttf_emulogic_gif_end - data_ttf_emulogic_gif_start);
    ramdisk_data[232].data = data_ttf_emulogic_ttf_pointsize10_data_start;
    ramdisk_data[232].len = (int32_t) (data_ttf_emulogic_ttf_pointsize10_data_end - data_ttf_emulogic_ttf_pointsize10_data_start);
    ramdisk_data[233].data = data_ttf_emulogic_ttf_pointsize10_tga_start;
    ramdisk_data[233].len = (int32_t) (data_ttf_emulogic_ttf_pointsize10_tga_end - data_ttf_emulogic_ttf_pointsize10_tga_start);
    ramdisk_data[234].data = data_ttf_emulogic_ttf_pointsize11_data_start;
    ramdisk_data[234].len = (int32_t) (data_ttf_emulogic_ttf_pointsize11_data_end - data_ttf_emulogic_ttf_pointsize11_data_start);
    ramdisk_data[235].data = data_ttf_emulogic_ttf_pointsize11_tga_start;
    ramdisk_data[235].len = (int32_t) (data_ttf_emulogic_ttf_pointsize11_tga_end - data_ttf_emulogic_ttf_pointsize11_tga_start);
    ramdisk_data[236].data = data_ttf_emulogic_ttf_pointsize12_data_start;
    ramdisk_data[236].len = (int32_t) (data_ttf_emulogic_ttf_pointsize12_data_end - data_ttf_emulogic_ttf_pointsize12_data_start);
    ramdisk_data[237].data = data_ttf_emulogic_ttf_pointsize12_tga_start;
    ramdisk_data[237].len = (int32_t) (data_ttf_emulogic_ttf_pointsize12_tga_end - data_ttf_emulogic_ttf_pointsize12_tga_start);
    ramdisk_data[238].data = data_ttf_emulogic_ttf_pointsize14_data_start;
    ramdisk_data[238].len = (int32_t) (data_ttf_emulogic_ttf_pointsize14_data_end - data_ttf_emulogic_ttf_pointsize14_data_start);
    ramdisk_data[239].data = data_ttf_emulogic_ttf_pointsize14_tga_start;
    ramdisk_data[239].len = (int32_t) (data_ttf_emulogic_ttf_pointsize14_tga_end - data_ttf_emulogic_ttf_pointsize14_tga_start);
    ramdisk_data[240].data = data_ttf_emulogic_ttf_pointsize15_data_start;
    ramdisk_data[240].len = (int32_t) (data_ttf_emulogic_ttf_pointsize15_data_end - data_ttf_emulogic_ttf_pointsize15_data_start);
    ramdisk_data[241].data = data_ttf_emulogic_ttf_pointsize15_tga_start;
    ramdisk_data[241].len = (int32_t) (data_ttf_emulogic_ttf_pointsize15_tga_end - data_ttf_emulogic_ttf_pointsize15_tga_start);
    ramdisk_data[242].data = data_ttf_emulogic_ttf_pointsize16_data_start;
    ramdisk_data[242].len = (int32_t) (data_ttf_emulogic_ttf_pointsize16_data_end - data_ttf_emulogic_ttf_pointsize16_data_start);
    ramdisk_data[243].data = data_ttf_emulogic_ttf_pointsize16_tga_start;
    ramdisk_data[243].len = (int32_t) (data_ttf_emulogic_ttf_pointsize16_tga_end - data_ttf_emulogic_ttf_pointsize16_tga_start);
    ramdisk_data[244].data = data_ttf_emulogic_ttf_pointsize17_data_start;
    ramdisk_data[244].len = (int32_t) (data_ttf_emulogic_ttf_pointsize17_data_end - data_ttf_emulogic_ttf_pointsize17_data_start);
    ramdisk_data[245].data = data_ttf_emulogic_ttf_pointsize17_tga_start;
    ramdisk_data[245].len = (int32_t) (data_ttf_emulogic_ttf_pointsize17_tga_end - data_ttf_emulogic_ttf_pointsize17_tga_start);
    ramdisk_data[246].data = data_ttf_emulogic_ttf_pointsize18_data_start;
    ramdisk_data[246].len = (int32_t) (data_ttf_emulogic_ttf_pointsize18_data_end - data_ttf_emulogic_ttf_pointsize18_data_start);
    ramdisk_data[247].data = data_ttf_emulogic_ttf_pointsize18_tga_start;
    ramdisk_data[247].len = (int32_t) (data_ttf_emulogic_ttf_pointsize18_tga_end - data_ttf_emulogic_ttf_pointsize18_tga_start);
    ramdisk_data[248].data = data_ttf_emulogic_ttf_pointsize19_data_start;
    ramdisk_data[248].len = (int32_t) (data_ttf_emulogic_ttf_pointsize19_data_end - data_ttf_emulogic_ttf_pointsize19_data_start);
    ramdisk_data[249].data = data_ttf_emulogic_ttf_pointsize19_tga_start;
    ramdisk_data[249].len = (int32_t) (data_ttf_emulogic_ttf_pointsize19_tga_end - data_ttf_emulogic_ttf_pointsize19_tga_start);
    ramdisk_data[250].data = data_ttf_emulogic_ttf_pointsize20_data_start;
    ramdisk_data[250].len = (int32_t) (data_ttf_emulogic_ttf_pointsize20_data_end - data_ttf_emulogic_ttf_pointsize20_data_start);
    ramdisk_data[251].data = data_ttf_emulogic_ttf_pointsize20_tga_start;
    ramdisk_data[251].len = (int32_t) (data_ttf_emulogic_ttf_pointsize20_tga_end - data_ttf_emulogic_ttf_pointsize20_tga_start);
    ramdisk_data[252].data = data_ttf_emulogic_ttf_pointsize21_data_start;
    ramdisk_data[252].len = (int32_t) (data_ttf_emulogic_ttf_pointsize21_data_end - data_ttf_emulogic_ttf_pointsize21_data_start);
    ramdisk_data[253].data = data_ttf_emulogic_ttf_pointsize21_tga_start;
    ramdisk_data[253].len = (int32_t) (data_ttf_emulogic_ttf_pointsize21_tga_end - data_ttf_emulogic_ttf_pointsize21_tga_start);
    ramdisk_data[254].data = data_ttf_emulogic_ttf_pointsize22_data_start;
    ramdisk_data[254].len = (int32_t) (data_ttf_emulogic_ttf_pointsize22_data_end - data_ttf_emulogic_ttf_pointsize22_data_start);
    ramdisk_data[255].data = data_ttf_emulogic_ttf_pointsize22_tga_start;
    ramdisk_data[255].len = (int32_t) (data_ttf_emulogic_ttf_pointsize22_tga_end - data_ttf_emulogic_ttf_pointsize22_tga_start);
    ramdisk_data[256].data = data_ttf_emulogic_ttf_pointsize23_data_start;
    ramdisk_data[256].len = (int32_t) (data_ttf_emulogic_ttf_pointsize23_data_end - data_ttf_emulogic_ttf_pointsize23_data_start);
    ramdisk_data[257].data = data_ttf_emulogic_ttf_pointsize23_tga_start;
    ramdisk_data[257].len = (int32_t) (data_ttf_emulogic_ttf_pointsize23_tga_end - data_ttf_emulogic_ttf_pointsize23_tga_start);
    ramdisk_data[258].data = data_ttf_emulogic_ttf_pointsize24_data_start;
    ramdisk_data[258].len = (int32_t) (data_ttf_emulogic_ttf_pointsize24_data_end - data_ttf_emulogic_ttf_pointsize24_data_start);
    ramdisk_data[259].data = data_ttf_emulogic_ttf_pointsize24_tga_start;
    ramdisk_data[259].len = (int32_t) (data_ttf_emulogic_ttf_pointsize24_tga_end - data_ttf_emulogic_ttf_pointsize24_tga_start);
    ramdisk_data[260].data = data_ttf_emulogic_ttf_pointsize25_data_start;
    ramdisk_data[260].len = (int32_t) (data_ttf_emulogic_ttf_pointsize25_data_end - data_ttf_emulogic_ttf_pointsize25_data_start);
    ramdisk_data[261].data = data_ttf_emulogic_ttf_pointsize25_tga_start;
    ramdisk_data[261].len = (int32_t) (data_ttf_emulogic_ttf_pointsize25_tga_end - data_ttf_emulogic_ttf_pointsize25_tga_start);
    ramdisk_data[262].data = data_ttf_emulogic_ttf_pointsize26_data_start;
    ramdisk_data[262].len = (int32_t) (data_ttf_emulogic_ttf_pointsize26_data_end - data_ttf_emulogic_ttf_pointsize26_data_start);
    ramdisk_data[263].data = data_ttf_emulogic_ttf_pointsize26_tga_start;
    ramdisk_data[263].len = (int32_t) (data_ttf_emulogic_ttf_pointsize26_tga_end - data_ttf_emulogic_ttf_pointsize26_tga_start);
    ramdisk_data[264].data = data_ttf_emulogic_ttf_pointsize28_data_start;
    ramdisk_data[264].len = (int32_t) (data_ttf_emulogic_ttf_pointsize28_data_end - data_ttf_emulogic_ttf_pointsize28_data_start);
    ramdisk_data[265].data = data_ttf_emulogic_ttf_pointsize28_tga_start;
    ramdisk_data[265].len = (int32_t) (data_ttf_emulogic_ttf_pointsize28_tga_end - data_ttf_emulogic_ttf_pointsize28_tga_start);
    ramdisk_data[266].data = data_ttf_emulogic_ttf_pointsize30_data_start;
    ramdisk_data[266].len = (int32_t) (data_ttf_emulogic_ttf_pointsize30_data_end - data_ttf_emulogic_ttf_pointsize30_data_start);
    ramdisk_data[267].data = data_ttf_emulogic_ttf_pointsize30_tga_start;
    ramdisk_data[267].len = (int32_t) (data_ttf_emulogic_ttf_pointsize30_tga_end - data_ttf_emulogic_ttf_pointsize30_tga_start);
    ramdisk_data[268].data = data_ttf_emulogic_ttf_pointsize32_data_start;
    ramdisk_data[268].len = (int32_t) (data_ttf_emulogic_ttf_pointsize32_data_end - data_ttf_emulogic_ttf_pointsize32_data_start);
    ramdisk_data[269].data = data_ttf_emulogic_ttf_pointsize32_tga_start;
    ramdisk_data[269].len = (int32_t) (data_ttf_emulogic_ttf_pointsize32_tga_end - data_ttf_emulogic_ttf_pointsize32_tga_start);
    ramdisk_data[270].data = data_ttf_emulogic_ttf_pointsize36_data_start;
    ramdisk_data[270].len = (int32_t) (data_ttf_emulogic_ttf_pointsize36_data_end - data_ttf_emulogic_ttf_pointsize36_data_start);
    ramdisk_data[271].data = data_ttf_emulogic_ttf_pointsize36_tga_start;
    ramdisk_data[271].len = (int32_t) (data_ttf_emulogic_ttf_pointsize36_tga_end - data_ttf_emulogic_ttf_pointsize36_tga_start);
    ramdisk_data[272].data = data_ttf_emulogic_ttf_pointsize6_data_start;
    ramdisk_data[272].len = (int32_t) (data_ttf_emulogic_ttf_pointsize6_data_end - data_ttf_emulogic_ttf_pointsize6_data_start);
    ramdisk_data[273].data = data_ttf_emulogic_ttf_pointsize6_tga_start;
    ramdisk_data[273].len = (int32_t) (data_ttf_emulogic_ttf_pointsize6_tga_end - data_ttf_emulogic_ttf_pointsize6_tga_start);
    ramdisk_data[274].data = data_ttf_emulogic_ttf_pointsize7_data_start;
    ramdisk_data[274].len = (int32_t) (data_ttf_emulogic_ttf_pointsize7_data_end - data_ttf_emulogic_ttf_pointsize7_data_start);
    ramdisk_data[275].data = data_ttf_emulogic_ttf_pointsize7_tga_start;
    ramdisk_data[275].len = (int32_t) (data_ttf_emulogic_ttf_pointsize7_tga_end - data_ttf_emulogic_ttf_pointsize7_tga_start);
    ramdisk_data[276].data = data_ttf_emulogic_ttf_pointsize8_data_start;
    ramdisk_data[276].len = (int32_t) (data_ttf_emulogic_ttf_pointsize8_data_end - data_ttf_emulogic_ttf_pointsize8_data_start);
    ramdisk_data[277].data = data_ttf_emulogic_ttf_pointsize8_tga_start;
    ramdisk_data[277].len = (int32_t) (data_ttf_emulogic_ttf_pointsize8_tga_end - data_ttf_emulogic_ttf_pointsize8_tga_start);
    ramdisk_data[278].data = data_ttf_emulogic_ttf_pointsize9_data_start;
    ramdisk_data[278].len = (int32_t) (data_ttf_emulogic_ttf_pointsize9_data_end - data_ttf_emulogic_ttf_pointsize9_data_start);
    ramdisk_data[279].data = data_ttf_emulogic_ttf_pointsize9_tga_start;
    ramdisk_data[279].len = (int32_t) (data_ttf_emulogic_ttf_pointsize9_tga_end - data_ttf_emulogic_ttf_pointsize9_tga_start);
    ramdisk_data[280].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[280].len = (int32_t) (data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start);
    ramdisk_data[281].data = data_ttf_Metamorphous_Regular_ttf_pointsize10_data_start;
    ramdisk_data[281].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize10_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize10_data_start);
    ramdisk_data[282].data = data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_start;
    ramdisk_data[282].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize10_tga_start);
    ramdisk_data[283].data = data_ttf_Metamorphous_Regular_ttf_pointsize12_data_start;
    ramdisk_data[283].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize12_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize12_data_start);
    ramdisk_data[284].data = data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_start;
    ramdisk_data[284].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize12_tga_start);
    ramdisk_data[285].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start;
    ramdisk_data[285].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize14_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_data_start);
    ramdisk_data[286].data = data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start;
    ramdisk_data[286].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize14_tga_start);
    ramdisk_data[287].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start;
    ramdisk_data[287].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize16_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_data_start);
    ramdisk_data[288].data = data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start;
    ramdisk_data[288].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize16_tga_start);
    ramdisk_data[289].data = data_ttf_Metamorphous_Regular_ttf_pointsize20_data_start;
    ramdisk_data[289].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize20_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize20_data_start);
    ramdisk_data[290].data = data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_start;
    ramdisk_data[290].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize20_tga_start);
    ramdisk_data[291].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start;
    ramdisk_data[291].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize22_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_data_start);
    ramdisk_data[292].data = data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start;
    ramdisk_data[292].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize22_tga_start);
    ramdisk_data[293].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start;
    ramdisk_data[293].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize24_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_data_start);
    ramdisk_data[294].data = data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start;
    ramdisk_data[294].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize24_tga_start);
    ramdisk_data[295].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start;
    ramdisk_data[295].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize28_data_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_data_start);
    ramdisk_data[296].data = data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start;
    ramdisk_data[296].len = (int32_t) (data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_end - data_ttf_Metamorphous_Regular_ttf_pointsize28_tga_start);
    ramdisk_data[297].data = data_ttf_OFL_txt_start;
    ramdisk_data[297].len = (int32_t) (data_ttf_OFL_txt_end - data_ttf_OFL_txt_start);
    ramdisk_data[298].data = data_ttf_Readme_txt_start;
    ramdisk_data[298].len = (int32_t) (data_ttf_Readme_txt_end - data_ttf_Readme_txt_start);
}
