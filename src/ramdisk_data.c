...
void ramdisk_init (void)
{
    ...
    ramdisk_data[38].data = data_things__ghost_session_start;
    ramdisk_data[38].len = data_things__ghost_session_end - data_things__ghost_session_start;
    ramdisk_data[39].data = data_things__ghost2_session_start;
    ramdisk_data[39].len = data_things__ghost2_session_end - data_things__ghost2_session_start;
    ramdisk_data[40].data = data_things__ghost3_session_start;
    ramdisk_data[40].len = data_things__ghost3_session_end - data_things__ghost3_session_start;
    ramdisk_data[41].data = data_things__lizard_session_start;
    ramdisk_data[41].len = data_things__lizard_session_end - data_things__lizard_session_start;
    ramdisk_data[42].data = data_things__monk_session_start;
    ramdisk_data[42].len = data_things__monk_session_end - data_things__monk_session_start;
    ...
    ramdisk_data[44].data = data_things__poison8_session_start;
    ramdisk_data[44].len = data_things__poison8_session_end - data_things__poison8_session_start;
    ramdisk_data[45].data = data_things__valkyrie_session_start;
    ramdisk_data[45].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[46].data = data_things__wizard_session_start;
    ramdisk_data[46].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ramdisk_data[47].data = data_things_amulet1_start;
    ramdisk_data[47].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[48].data = data_things_arrow_start;
    ramdisk_data[48].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[49].data = data_things_bomb_start;
    ramdisk_data[49].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[50].data = data_things_bow1_start;
    ramdisk_data[50].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[51].data = data_things_bow2_start;
    ramdisk_data[51].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[52].data = data_things_bow3_start;
    ramdisk_data[52].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[53].data = data_things_bow4_start;
    ramdisk_data[53].len = data_things_bow4_end - data_things_bow4_start;
    ...
    ramdisk_data[103].data = data_things_keys1_start;
    ramdisk_data[103].len = data_things_keys1_end - data_things_keys1_start;
    ...
    ramdisk_data[107].data = data_things_mask1_start;
    ramdisk_data[107].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[108].data = data_things_mask2_start;
    ramdisk_data[108].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[109].data = data_things_mask3_start;
    ramdisk_data[109].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[110].data = data_things_monk_start;
    ramdisk_data[110].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[111].data = data_things_noentry_start;
    ramdisk_data[111].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[112].data = data_things_pipe_start;
    ramdisk_data[112].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[113].data = data_things_plant_start;
    ramdisk_data[113].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[114].data = data_things_poison1_start;
    ramdisk_data[114].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[115].data = data_things_poison2_start;
    ramdisk_data[115].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[116].data = data_things_poison3_start;
    ramdisk_data[116].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[117].data = data_things_poison4_start;
    ramdisk_data[117].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[118].data = data_things_poison5_start;
    ramdisk_data[118].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[119].data = data_things_poison6_start;
    ramdisk_data[119].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[120].data = data_things_poison7_start;
    ramdisk_data[120].len = data_things_poison7_end - data_things_poison7_start;
    ramdisk_data[121].data = data_things_poison8_start;
    ramdisk_data[121].len = data_things_poison8_end - data_things_poison8_start;
    ramdisk_data[122].data = data_things_potion_death_start;
    ramdisk_data[122].len = data_things_potion_death_end - data_things_potion_death_start;
    ramdisk_data[123].data = data_things_potion_fire_start;
    ramdisk_data[123].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[124].data = data_things_potion_life_start;
    ramdisk_data[124].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[125].data = data_things_potion_monsticide_start;
    ramdisk_data[125].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[126].data = data_things_potion_shield_start;
    ramdisk_data[126].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ...
    ramdisk_data[137].data = data_things_water1_start;
    ramdisk_data[137].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[138].data = data_things_water2_start;
    ramdisk_data[138].len = data_things_water2_end - data_things_water2_start;
