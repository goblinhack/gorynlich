...
extern unsigned char *data_things__player_session_start_ asm("data_things__player_session_start_");
extern unsigned char *data_things__player_session_end_ asm("data_things__player_session_end_");
static const unsigned char *const data_things__player_session_start =
    (const unsigned char *const) (char*)&data_things__player_session_start_;
static const unsigned char *const data_things__player_session_end   =
    (const unsigned char *const) (char*)&data_things__player_session_end_;
...
{
    /* filename */ "data/things/.player.session",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[32].data = data_things__amulet1_session_start;
    ramdisk_data[32].len = data_things__amulet1_session_end - data_things__amulet1_session_start;
    ramdisk_data[33].data = data_things__chest1_session_start;
    ramdisk_data[33].len = data_things__chest1_session_end - data_things__chest1_session_start;
    ramdisk_data[34].data = data_things__door_session_start;
    ramdisk_data[34].len = data_things__door_session_end - data_things__door_session_start;
    ramdisk_data[35].data = data_things__floor_session_start;
    ramdisk_data[35].len = data_things__floor_session_end - data_things__floor_session_start;
    ramdisk_data[36].data = data_things__floor1_session_start;
    ramdisk_data[36].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[37].data = data_things__floor2_session_start;
    ramdisk_data[37].len = data_things__floor2_session_end - data_things__floor2_session_start;
    ramdisk_data[38].data = data_things__floor3_session_start;
    ramdisk_data[38].len = data_things__floor3_session_end - data_things__floor3_session_start;
    ramdisk_data[39].data = data_things__floor4_session_start;
    ramdisk_data[39].len = data_things__floor4_session_end - data_things__floor4_session_start;
    ramdisk_data[40].data = data_things__floor5_session_start;
    ramdisk_data[40].len = data_things__floor5_session_end - data_things__floor5_session_start;
    ...
    ramdisk_data[42].data = data_things__food_session_start;
    ramdisk_data[42].len = data_things__food_session_end - data_things__food_session_start;
    ramdisk_data[43].data = data_things__food2_session_start;
    ramdisk_data[43].len = data_things__food2_session_end - data_things__food2_session_start;
    ramdisk_data[44].data = data_things__gem1_session_start;
    ramdisk_data[44].len = data_things__gem1_session_end - data_things__gem1_session_start;
    ramdisk_data[45].data = data_things__gem7_session_start;
    ramdisk_data[45].len = data_things__gem7_session_end - data_things__gem7_session_start;
    ramdisk_data[46].data = data_things__generator1_session_start;
    ramdisk_data[46].len = data_things__generator1_session_end - data_things__generator1_session_start;
    ramdisk_data[47].data = data_things__generator3_session_start;
    ramdisk_data[47].len = data_things__generator3_session_end - data_things__generator3_session_start;
    ramdisk_data[48].data = data_things__generator7_session_start;
    ramdisk_data[48].len = data_things__generator7_session_end - data_things__generator7_session_start;
    ramdisk_data[49].data = data_things__keys1_session_start;
    ramdisk_data[49].len = data_things__keys1_session_end - data_things__keys1_session_start;
    ramdisk_data[50].data = data_things__keys2_session_start;
    ramdisk_data[50].len = data_things__keys2_session_end - data_things__keys2_session_start;
    ramdisk_data[51].data = data_things__keys3_session_start;
    ramdisk_data[51].len = data_things__keys3_session_end - data_things__keys3_session_start;
    ramdisk_data[52].data = data_things__mask1_session_start;
    ramdisk_data[52].len = data_things__mask1_session_end - data_things__mask1_session_start;
    ramdisk_data[53].data = data_things__mask3_session_start;
    ramdisk_data[53].len = data_things__mask3_session_end - data_things__mask3_session_start;
    ramdisk_data[54].data = data_things__plant_session_start;
    ramdisk_data[54].len = data_things__plant_session_end - data_things__plant_session_start;
    ramdisk_data[55].data = data_things__player_session_start;
    ramdisk_data[55].len = data_things__player_session_end - data_things__player_session_start;
    ramdisk_data[56].data = data_things__potion1_session_start;
    ramdisk_data[56].len = data_things__potion1_session_end - data_things__potion1_session_start;
    ramdisk_data[57].data = data_things__potion5_session_start;
    ramdisk_data[57].len = data_things__potion5_session_end - data_things__potion5_session_start;
    ramdisk_data[58].data = data_things__rock_0_session_start;
    ramdisk_data[58].len = data_things__rock_0_session_end - data_things__rock_0_session_start;
    ramdisk_data[59].data = data_things__rock_1_session_start;
    ramdisk_data[59].len = data_things__rock_1_session_end - data_things__rock_1_session_start;
    ramdisk_data[60].data = data_things__spam_session_start;
    ramdisk_data[60].len = data_things__spam_session_end - data_things__spam_session_start;
    ramdisk_data[61].data = data_things__treasure_session_start;
    ramdisk_data[61].len = data_things__treasure_session_end - data_things__treasure_session_start;
    ramdisk_data[62].data = data_things__wall_session_start;
    ramdisk_data[62].len = data_things__wall_session_end - data_things__wall_session_start;
    ramdisk_data[63].data = data_things__wall2_session_start;
    ramdisk_data[63].len = data_things__wall2_session_end - data_things__wall2_session_start;
    ...
    ramdisk_data[65].data = data_things__water1_session_start;
    ramdisk_data[65].len = data_things__water1_session_end - data_things__water1_session_start;
    ramdisk_data[66].data = data_things__water2_session_start;
    ramdisk_data[66].len = data_things__water2_session_end - data_things__water2_session_start;
    ramdisk_data[67].data = data_things_amulet1_start;
    ramdisk_data[67].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[68].data = data_things_bomb_start;
    ramdisk_data[68].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[69].data = data_things_chest1_start;
    ramdisk_data[69].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[70].data = data_things_coins1_start;
    ramdisk_data[70].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[71].data = data_things_door_start;
    ramdisk_data[71].len = data_things_door_end - data_things_door_start;
    ramdisk_data[72].data = data_things_exit_start;
    ramdisk_data[72].len = data_things_exit_end - data_things_exit_start;
    ...
    ramdisk_data[80].data = data_things_explosion_start;
    ramdisk_data[80].len = data_things_explosion_end - data_things_explosion_start;
    ...
    ramdisk_data[102].data = data_things_keys1_start;
    ramdisk_data[102].len = data_things_keys1_end - data_things_keys1_start;
    ...
    ramdisk_data[105].data = data_things_mask1_start;
    ramdisk_data[105].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[106].data = data_things_mask2_start;
    ramdisk_data[106].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[107].data = data_things_mask3_start;
    ramdisk_data[107].len = data_things_mask3_end - data_things_mask3_start;
    ...
    ramdisk_data[111].data = data_things_player_start;
    ramdisk_data[111].len = data_things_player_end - data_things_player_start;
    ramdisk_data[112].data = data_things_potion1_start;
    ramdisk_data[112].len = data_things_potion1_end - data_things_potion1_start;
    ramdisk_data[113].data = data_things_potion2_start;
    ramdisk_data[113].len = data_things_potion2_end - data_things_potion2_start;
    ramdisk_data[114].data = data_things_potion3_start;
    ramdisk_data[114].len = data_things_potion3_end - data_things_potion3_start;
    ramdisk_data[115].data = data_things_potion4_start;
    ramdisk_data[115].len = data_things_potion4_end - data_things_potion4_start;
    ramdisk_data[116].data = data_things_potion5_start;
    ramdisk_data[116].len = data_things_potion5_end - data_things_potion5_start;
    ...
    ramdisk_data[119].data = data_things_wall_start;
    ramdisk_data[119].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[120].data = data_things_wall2_start;
    ramdisk_data[120].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[121].data = data_things_wall3_start;
    ramdisk_data[121].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[122].data = data_things_wall4_start;
    ramdisk_data[122].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[123].data = data_things_wall5_start;
    ramdisk_data[123].len = data_things_wall5_end - data_things_wall5_start;
    ...
    ramdisk_data[126].data = data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[126].len = data_ttf_large_ttf_pointsize50_data_end - data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[127].data = data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[127].len = data_ttf_large_ttf_pointsize50_tga_end - data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[128].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[128].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[129].data = data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[129].len = data_ttf_med_ttf_pointsize40_data_end - data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[130].data = data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[130].len = data_ttf_med_ttf_pointsize40_tga_end - data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[131].data = data_ttf_Readme_txt_start;
    ramdisk_data[131].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
    ramdisk_data[132].data = data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[132].len = data_ttf_small_ttf_pointsize10_data_end - data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[133].data = data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[133].len = data_ttf_small_ttf_pointsize10_tga_end - data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[134].data = data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[134].len = data_ttf_small_ttf_pointsize15_data_end - data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[135].data = data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[135].len = data_ttf_small_ttf_pointsize15_tga_end - data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[136].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[136].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[137].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[137].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
