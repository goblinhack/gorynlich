...
extern unsigned char *data_gfx_gradient_png_start_ asm("data_gfx_gradient_png_start_");
extern unsigned char *data_gfx_gradient_png_end_ asm("data_gfx_gradient_png_end_");
static const unsigned char *const data_gfx_gradient_png_start =
    (const unsigned char *const) (char*)&data_gfx_gradient_png_start_;
static const unsigned char *const data_gfx_gradient_png_end   =
    (const unsigned char *const) (char*)&data_gfx_gradient_png_end_;
...
{
    /* filename */ "data/gfx/gradient.png",
},
{
...
void ramdisk_init (void)
{
    ...
    ramdisk_data[5].data = data_gfx_gradient_png_start;
    ramdisk_data[5].len = data_gfx_gradient_png_end - data_gfx_gradient_png_start;
    ...
    ramdisk_data[11].data = data_gfx_poison_png_start;
    ramdisk_data[11].len = data_gfx_poison_png_end - data_gfx_poison_png_start;
    ramdisk_data[12].data = data_gfx_rat_png_start;
    ramdisk_data[12].len = data_gfx_rat_png_end - data_gfx_rat_png_start;
    ...
    ramdisk_data[14].data = data_gfx_title_png_start;
    ramdisk_data[14].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[15].data = data_gfx_title2_png_start;
    ramdisk_data[15].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[16].data = data_gfx_title3_png_start;
    ramdisk_data[16].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ...
    ramdisk_data[18].data = data_levels_1_start;
    ramdisk_data[18].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[19].data = data_levels_2_start;
    ramdisk_data[19].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[20].data = data_levels_3_start;
    ramdisk_data[20].len = data_levels_3_end - data_levels_3_start;
    ...
    ramdisk_data[23].data = data_music_charlotte8bit_mp3_start;
    ramdisk_data[23].len = data_music_charlotte8bit_mp3_end - data_music_charlotte8bit_mp3_start;
    ...
    ramdisk_data[41].data = data_things__amulet1_session_start;
    ramdisk_data[41].len = data_things__amulet1_session_end - data_things__amulet1_session_start;
    ramdisk_data[42].data = data_things__axe2_anim_session_start;
    ramdisk_data[42].len = data_things__axe2_anim_session_end - data_things__axe2_anim_session_start;
    ramdisk_data[43].data = data_things__explosion1_session_start;
    ramdisk_data[43].len = data_things__explosion1_session_end - data_things__explosion1_session_start;
