...
void ramdisk_init (void)
{
    ...
    ramdisk_data[54].data = data_things__cloudkill8_session_start;
    ...
    ramdisk_data[140].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[141].data = data_things_floor2_start;
    ramdisk_data[141].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[142].data = data_things_floor3_start;
    ramdisk_data[142].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[143].data = data_things_floor4_start;
    ramdisk_data[143].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[144].data = data_things_floor5_start;
    ramdisk_data[144].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[145].data = data_things_floor6_start;
    ramdisk_data[145].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[146].data = data_things_gem1_start;
    ramdisk_data[146].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[147].data = data_things_gem2_start;
    ramdisk_data[147].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[148].data = data_things_gem3_start;
    ramdisk_data[148].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[149].data = data_things_gem4_start;
    ramdisk_data[149].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[150].data = data_things_gem5_start;
    ramdisk_data[150].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[151].data = data_things_gem6_start;
    ramdisk_data[151].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[152].data = data_things_gem7_start;
    ramdisk_data[152].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[153].data = data_things_generator1_start;
    ramdisk_data[153].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[154].data = data_things_generator5_start;
    ramdisk_data[154].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[155].data = data_things_generator6_start;
    ramdisk_data[155].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[156].data = data_things_generator7_start;
    ramdisk_data[156].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[157].data = data_things_ghost1_start;
    ramdisk_data[157].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[158].data = data_things_ghost2_start;
    ramdisk_data[158].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[159].data = data_things_ghost3_start;
    ramdisk_data[159].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[160].data = data_things_key_start;
    ramdisk_data[160].len = data_things_key_end - data_things_key_start;
    ramdisk_data[161].data = data_things_keys2_start;
    ramdisk_data[161].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[162].data = data_things_keys3_start;
    ramdisk_data[162].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[163].data = data_things_lizard_start;
    ramdisk_data[163].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[164].data = data_things_monk_start;
    ramdisk_data[164].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[165].data = data_things_noentry_start;
    ramdisk_data[165].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[166].data = data_things_pipe_start;
    ramdisk_data[166].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[167].data = data_things_plant_start;
    ramdisk_data[167].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[168].data = data_things_poison1_start;
    ramdisk_data[168].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[169].data = data_things_poison2_start;
    ramdisk_data[169].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[170].data = data_things_poison3_start;
    ramdisk_data[170].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[171].data = data_things_poison4_start;
    ramdisk_data[171].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[172].data = data_things_poison5_start;
    ramdisk_data[172].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[173].data = data_things_poison6_start;
    ramdisk_data[173].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[174].data = data_things_poison7_start;
    ramdisk_data[174].len = data_things_poison7_end - data_things_poison7_start;
    ramdisk_data[175].data = data_things_poison8_start;
    ramdisk_data[175].len = data_things_poison8_end - data_things_poison8_start;
    ...
    ramdisk_data[184].data = data_things_scythe1_start;
    ramdisk_data[184].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[185].data = data_things_scythe1_anim_start;
    ramdisk_data[185].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[186].data = data_things_seedpod_start;
    ramdisk_data[186].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[187].data = data_things_spam_start;
    ramdisk_data[187].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[188].data = data_things_sparks1_start;
    ramdisk_data[188].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[189].data = data_things_sparks2_start;
    ramdisk_data[189].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[190].data = data_things_sparks3_start;
    ramdisk_data[190].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[191].data = data_things_sword1_start;
    ramdisk_data[191].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[192].data = data_things_sword1_anim_start;
    ramdisk_data[192].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[193].data = data_things_sword2_start;
    ramdisk_data[193].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[194].data = data_things_sword2_anim_start;
    ramdisk_data[194].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[195].data = data_things_sword3_start;
    ramdisk_data[195].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[196].data = data_things_sword3_anim_start;
    ramdisk_data[196].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[197].data = data_things_valkyrie_start;
    ramdisk_data[197].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[198].data = data_things_wall_start;
    ramdisk_data[198].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[199].data = data_things_wall2_start;
    ramdisk_data[199].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[200].data = data_things_wall3_start;
    ramdisk_data[200].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[201].data = data_things_wall4_start;
    ramdisk_data[201].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[202].data = data_things_wall5_start;
    ramdisk_data[202].len = data_things_wall5_end - data_things_wall5_start;
