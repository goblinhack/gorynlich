...
void ramdisk_init (void)
{
    ...
    ramdisk_data[7].data = data_gfx_dragon_png_start;
    ramdisk_data[7].len = data_gfx_dragon_png_end - data_gfx_dragon_png_start;
    ramdisk_data[8].data = data_gfx_explosion_png_start;
    ramdisk_data[8].len = data_gfx_explosion_png_end - data_gfx_explosion_png_start;
    ramdisk_data[9].data = data_gfx_giant_rock_png_start;
    ramdisk_data[9].len = data_gfx_giant_rock_png_end - data_gfx_giant_rock_png_start;
    ramdisk_data[10].data = data_gfx_gorynlich_png_start;
    ramdisk_data[10].len = data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start;
    ramdisk_data[11].data = data_gfx_gothic_wide_png_start;
    ramdisk_data[11].len = data_gfx_gothic_wide_png_end - data_gfx_gothic_wide_png_start;
    ramdisk_data[12].data = data_gfx_gravestone_png_start;
    ramdisk_data[12].len = data_gfx_gravestone_png_end - data_gfx_gravestone_png_start;
    ramdisk_data[13].data = data_gfx_gravestone2_png_start;
    ramdisk_data[13].len = data_gfx_gravestone2_png_end - data_gfx_gravestone2_png_start;
    ...
    ramdisk_data[17].data = data_gfx_sprites_small_png_start;
    ramdisk_data[17].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[18].data = data_gfx_title_png_start;
    ramdisk_data[18].len = data_gfx_title_png_end - data_gfx_title_png_start;
    ramdisk_data[19].data = data_gfx_title2_png_start;
    ramdisk_data[19].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[20].data = data_gfx_title3_png_start;
    ramdisk_data[20].len = data_gfx_title3_png_end - data_gfx_title3_png_start;
    ramdisk_data[21].data = data_gfx_title_small_png_start;
    ramdisk_data[21].len = data_gfx_title_small_png_end - data_gfx_title_small_png_start;
    ramdisk_data[22].data = data_gfx_wall_floor_png_start;
    ramdisk_data[22].len = data_gfx_wall_floor_png_end - data_gfx_wall_floor_png_start;
    ramdisk_data[23].data = data_gfx_window_gothic_png_start;
    ramdisk_data[23].len = data_gfx_window_gothic_png_end - data_gfx_window_gothic_png_start;
    ramdisk_data[24].data = data_gfx_window_gothic_wide_png_start;
    ramdisk_data[24].len = data_gfx_window_gothic_wide_png_end - data_gfx_window_gothic_wide_png_start;
    ramdisk_data[25].data = data_gfx_window_rock_png_start;
    ramdisk_data[25].len = data_gfx_window_rock_png_end - data_gfx_window_rock_png_start;
    ...
    ramdisk_data[29].data = data_music__1_session_start;
    ramdisk_data[29].len = data_music__1_session_end - data_music__1_session_start;
    ramdisk_data[30].data = data_music__resample_sh_session_start;
    ramdisk_data[30].len = data_music__resample_sh_session_end - data_music__resample_sh_session_start;
    ramdisk_data[31].data = data_music_charlotte_wav_start;
    ramdisk_data[31].len = data_music_charlotte_wav_end - data_music_charlotte_wav_start;
    ramdisk_data[32].data = data_music_charlotte8bit_wav_start;
    ramdisk_data[32].len = data_music_charlotte8bit_wav_end - data_music_charlotte8bit_wav_start;
    ramdisk_data[33].data = data_music_charlotte_slow_wav_start;
    ramdisk_data[33].len = data_music_charlotte_slow_wav_end - data_music_charlotte_slow_wav_start;
    ramdisk_data[34].data = data_music_DST_Alters_wav_start;
    ramdisk_data[34].len = data_music_DST_Alters_wav_end - data_music_DST_Alters_wav_start;
    ramdisk_data[35].data = data_music_DST_AncientCurse_II_wav_start;
    ramdisk_data[35].len = data_music_DST_AncientCurse_II_wav_end - data_music_DST_AncientCurse_II_wav_start;
    ramdisk_data[36].data = data_music_DST_Arch_Delerium_wav_start;
    ramdisk_data[36].len = data_music_DST_Arch_Delerium_wav_end - data_music_DST_Arch_Delerium_wav_start;
    ramdisk_data[37].data = data_music_DST_Arches_wav_start;
    ramdisk_data[37].len = data_music_DST_Arches_wav_end - data_music_DST_Arches_wav_start;
    ramdisk_data[38].data = data_music_DST_BattleLands_wav_start;
    ramdisk_data[38].len = data_music_DST_BattleLands_wav_end - data_music_DST_BattleLands_wav_start;
    ramdisk_data[39].data = data_music_DST_BlackRiver_wav_start;
    ramdisk_data[39].len = data_music_DST_BlackRiver_wav_end - data_music_DST_BlackRiver_wav_start;
    ramdisk_data[40].data = data_music_DST_BoneTower_wav_start;
    ramdisk_data[40].len = data_music_DST_BoneTower_wav_end - data_music_DST_BoneTower_wav_start;
    ramdisk_data[41].data = data_music_DST_ClockTower_wav_start;
    ramdisk_data[41].len = data_music_DST_ClockTower_wav_end - data_music_DST_ClockTower_wav_start;
    ramdisk_data[42].data = data_music_DST_DarkestKnight_wav_start;
    ramdisk_data[42].len = data_music_DST_DarkestKnight_wav_end - data_music_DST_DarkestKnight_wav_start;
    ramdisk_data[43].data = data_music_DST_DoomCity_wav_start;
    ramdisk_data[43].len = data_music_DST_DoomCity_wav_end - data_music_DST_DoomCity_wav_start;
    ramdisk_data[44].data = data_music_DST_ExInfernus_wav_start;
    ramdisk_data[44].len = data_music_DST_ExInfernus_wav_end - data_music_DST_ExInfernus_wav_start;
    ramdisk_data[45].data = data_music_DST_LeDanse_wav_start;
    ramdisk_data[45].len = data_music_DST_LeDanse_wav_end - data_music_DST_LeDanse_wav_start;
    ramdisk_data[46].data = data_music_DST_Legends_wav_start;
    ramdisk_data[46].len = data_music_DST_Legends_wav_end - data_music_DST_Legends_wav_start;
    ramdisk_data[47].data = data_music_DST_SuperWin_wav_start;
    ramdisk_data[47].len = data_music_DST_SuperWin_wav_end - data_music_DST_SuperWin_wav_start;
    ramdisk_data[48].data = data_music_resample_sh_start;
    ramdisk_data[48].len = data_music_resample_sh_end - data_music_resample_sh_start;
    ramdisk_data[49].data = data_sound_boom_wav_start;
    ramdisk_data[49].len = data_sound_boom_wav_end - data_sound_boom_wav_start;
    ramdisk_data[50].data = data_sound_cash_register_wav_start;
    ramdisk_data[50].len = data_sound_cash_register_wav_end - data_sound_cash_register_wav_start;
    ramdisk_data[51].data = data_sound_click_wav_start;
    ramdisk_data[51].len = data_sound_click_wav_end - data_sound_click_wav_start;
    ramdisk_data[52].data = data_sound_demon_wav_start;
    ramdisk_data[52].len = data_sound_demon_wav_end - data_sound_demon_wav_start;
    ramdisk_data[53].data = data_sound_dinosaur_wav_start;
    ramdisk_data[53].len = data_sound_dinosaur_wav_end - data_sound_dinosaur_wav_start;
    ramdisk_data[54].data = data_sound_drop_wav_start;
    ramdisk_data[54].len = data_sound_drop_wav_end - data_sound_drop_wav_start;
    ramdisk_data[55].data = data_sound_explosion_wav_start;
    ramdisk_data[55].len = data_sound_explosion_wav_end - data_sound_explosion_wav_start;
    ramdisk_data[56].data = data_sound_explosion_big_wav_start;
    ramdisk_data[56].len = data_sound_explosion_big_wav_end - data_sound_explosion_big_wav_start;
    ramdisk_data[57].data = data_sound_kick_wav_start;
    ramdisk_data[57].len = data_sound_kick_wav_end - data_sound_kick_wav_start;
    ramdisk_data[58].data = data_sound_laugh_wav_start;
    ramdisk_data[58].len = data_sound_laugh_wav_end - data_sound_laugh_wav_start;
    ramdisk_data[59].data = data_sound_level_end_wav_start;
    ramdisk_data[59].len = data_sound_level_end_wav_end - data_sound_level_end_wav_start;
    ramdisk_data[60].data = data_sound_magic_tinkle_wav_start;
    ramdisk_data[60].len = data_sound_magic_tinkle_wav_end - data_sound_magic_tinkle_wav_start;
    ramdisk_data[61].data = data_sound_powerup_wav_start;
    ramdisk_data[61].len = data_sound_powerup_wav_end - data_sound_powerup_wav_start;
    ramdisk_data[62].data = data_sound_scream_male_wav_start;
    ramdisk_data[62].len = data_sound_scream_male_wav_end - data_sound_scream_male_wav_start;
    ramdisk_data[63].data = data_sound_shriek_wav_start;
    ramdisk_data[63].len = data_sound_shriek_wav_end - data_sound_shriek_wav_start;
    ramdisk_data[64].data = data_sound_slime_wav_start;
    ramdisk_data[64].len = data_sound_slime_wav_end - data_sound_slime_wav_start;
    ramdisk_data[65].data = data_sound_sword_wav_start;
    ramdisk_data[65].len = data_sound_sword_wav_end - data_sound_sword_wav_start;
    ...
    ramdisk_data[67].data = data_sound_wand_dead_wav_start;
    ramdisk_data[67].len = data_sound_wand_dead_wav_end - data_sound_wand_dead_wav_start;
    ramdisk_data[68].data = data_things_amulet1_start;
    ramdisk_data[68].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[69].data = data_things_anim_eyes_start;
    ramdisk_data[69].len = data_things_anim_eyes_end - data_things_anim_eyes_start;
    ramdisk_data[70].data = data_things_anim_man_start;
    ramdisk_data[70].len = data_things_anim_man_end - data_things_anim_man_start;
    ramdisk_data[71].data = data_things_anim_treasure_chest_start;
    ramdisk_data[71].len = data_things_anim_treasure_chest_end - data_things_anim_treasure_chest_start;
    ...
    ramdisk_data[80].data = data_things_blood1_start;
    ramdisk_data[80].len = data_things_blood1_end - data_things_blood1_start;
    ramdisk_data[81].data = data_things_blood2_start;
    ramdisk_data[81].len = data_things_blood2_end - data_things_blood2_start;
    ramdisk_data[82].data = data_things_bonepile1_start;
    ramdisk_data[82].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[83].data = data_things_bonepile2_start;
    ramdisk_data[83].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[84].data = data_things_bonepile3_start;
    ramdisk_data[84].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[85].data = data_things_bow1_start;
    ramdisk_data[85].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[86].data = data_things_bow1_anim_start;
    ramdisk_data[86].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[87].data = data_things_bow2_start;
    ramdisk_data[87].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[88].data = data_things_bow3_start;
    ramdisk_data[88].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[89].data = data_things_bow4_start;
    ramdisk_data[89].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[90].data = data_things_brazier_start;
    ramdisk_data[90].len = data_things_brazier_end - data_things_brazier_start;
    ramdisk_data[91].data = data_things_bread_start;
    ramdisk_data[91].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[92].data = data_things_cheese_start;
    ramdisk_data[92].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[93].data = data_things_chest1_start;
    ramdisk_data[93].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[94].data = data_things_cloudkill1_start;
    ramdisk_data[94].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[95].data = data_things_cloudkill2_start;
    ramdisk_data[95].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[96].data = data_things_cloudkill3_start;
    ramdisk_data[96].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[97].data = data_things_cloudkill4_start;
    ramdisk_data[97].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[98].data = data_things_coins1_start;
    ramdisk_data[98].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[99].data = data_things_death_start;
    ramdisk_data[99].len = data_things_death_end - data_things_death_start;
    ramdisk_data[100].data = data_things_door1_start;
    ramdisk_data[100].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[101].data = data_things_door2_start;
    ramdisk_data[101].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[102].data = data_things_dwarf_start;
    ramdisk_data[102].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[103].data = data_things_elf_start;
    ramdisk_data[103].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[104].data = data_things_exit1_start;
    ramdisk_data[104].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[105].data = data_things_exit2_start;
    ramdisk_data[105].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[106].data = data_things_exit3_start;
    ramdisk_data[106].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[107].data = data_things_exit4_start;
    ramdisk_data[107].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[108].data = data_things_exit5_start;
    ramdisk_data[108].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[109].data = data_things_exit6_start;
    ramdisk_data[109].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[110].data = data_things_exit7_start;
    ramdisk_data[110].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[111].data = data_things_explosion1_start;
    ramdisk_data[111].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[112].data = data_things_explosion2_start;
    ramdisk_data[112].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[113].data = data_things_explosion3_start;
    ramdisk_data[113].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[114].data = data_things_explosion4_start;
    ramdisk_data[114].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[115].data = data_things_fireball_start;
    ramdisk_data[115].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[116].data = data_things_floor1_start;
    ramdisk_data[116].len = data_things_floor1_end - data_things_floor1_start;
    ramdisk_data[117].data = data_things_floor2_start;
    ramdisk_data[117].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[118].data = data_things_floor3_start;
    ramdisk_data[118].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[119].data = data_things_floor4_start;
    ramdisk_data[119].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[120].data = data_things_floor5_start;
    ramdisk_data[120].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[121].data = data_things_floor6_start;
    ramdisk_data[121].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[122].data = data_things_gem1_start;
    ramdisk_data[122].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[123].data = data_things_gem2_start;
    ramdisk_data[123].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[124].data = data_things_gem3_start;
    ramdisk_data[124].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[125].data = data_things_gem4_start;
    ramdisk_data[125].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[126].data = data_things_gem5_start;
    ramdisk_data[126].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[127].data = data_things_gem6_start;
    ramdisk_data[127].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[128].data = data_things_gem7_start;
    ramdisk_data[128].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[129].data = data_things_generator1_start;
    ramdisk_data[129].len = data_things_generator1_end - data_things_generator1_start;
    ...
    ramdisk_data[136].data = data_things_hit_miss_start;
    ramdisk_data[136].len = data_things_hit_miss_end - data_things_hit_miss_start;
    ramdisk_data[137].data = data_things_hit_success_start;
    ramdisk_data[137].len = data_things_hit_success_end - data_things_hit_success_start;
    ...
    ramdisk_data[143].data = data_things_poison1_start;
    ramdisk_data[143].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[144].data = data_things_poison2_start;
    ramdisk_data[144].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[145].data = data_things_poison3_start;
    ramdisk_data[145].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[146].data = data_things_poison4_start;
    ramdisk_data[146].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[147].data = data_things_potion_cloudkill_start;
    ramdisk_data[147].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[148].data = data_things_potion_fire_start;
    ramdisk_data[148].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[149].data = data_things_potion_life_start;
    ramdisk_data[149].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[150].data = data_things_potion_monsticide_start;
    ramdisk_data[150].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[151].data = data_things_potion_shield_start;
    ramdisk_data[151].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[152].data = data_things_ring1_start;
    ramdisk_data[152].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[153].data = data_things_ring2_start;
    ramdisk_data[153].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[154].data = data_things_ring3_start;
    ramdisk_data[154].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[155].data = data_things_rock1_start;
    ramdisk_data[155].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[156].data = data_things_scythe1_start;
    ramdisk_data[156].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[157].data = data_things_scythe1_anim_start;
    ramdisk_data[157].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[158].data = data_things_spam_start;
    ramdisk_data[158].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[159].data = data_things_sword1_start;
    ramdisk_data[159].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[160].data = data_things_sword1_anim_start;
    ramdisk_data[160].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[161].data = data_things_sword2_start;
    ramdisk_data[161].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[162].data = data_things_sword2_anim_start;
    ramdisk_data[162].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[163].data = data_things_sword3_start;
    ramdisk_data[163].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[164].data = data_things_sword3_anim_start;
    ramdisk_data[164].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
    ramdisk_data[165].data = data_things_torch_start;
    ramdisk_data[165].len = data_things_torch_end - data_things_torch_start;
    ramdisk_data[166].data = data_things_torches_start;
    ramdisk_data[166].len = data_things_torches_end - data_things_torches_start;
    ramdisk_data[167].data = data_things_valkyrie_start;
    ramdisk_data[167].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[168].data = data_things_wall1_start;
    ramdisk_data[168].len = data_things_wall1_end - data_things_wall1_start;
    ramdisk_data[169].data = data_things_wall2_start;
    ramdisk_data[169].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[170].data = data_things_wall3_start;
    ramdisk_data[170].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[171].data = data_things_wall4_start;
    ramdisk_data[171].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[172].data = data_things_wall5_start;
    ramdisk_data[172].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[173].data = data_things_wall6_start;
    ramdisk_data[173].len = data_things_wall6_end - data_things_wall6_start;
    ramdisk_data[174].data = data_things_wand1_anim_start;
    ramdisk_data[174].len = data_things_wand1_anim_end - data_things_wand1_anim_start;
    ramdisk_data[175].data = data_things_wand_fire_start;
    ramdisk_data[175].len = data_things_wand_fire_end - data_things_wand_fire_start;
    ramdisk_data[176].data = data_things_warrior_start;
    ramdisk_data[176].len = data_things_warrior_end - data_things_warrior_start;
    ramdisk_data[177].data = data_things_water_start;
    ramdisk_data[177].len = data_things_water_end - data_things_water_start;
    ramdisk_data[178].data = data_things_water_poison_start;
    ramdisk_data[178].len = data_things_water_poison_end - data_things_water_poison_start;
    ramdisk_data[179].data = data_things_weapon_swing1_start;
    ramdisk_data[179].len = data_things_weapon_swing1_end - data_things_weapon_swing1_start;
