...
void ramdisk_init (void)
{
    ...
    ramdisk_data[36].data = data_things__death_session_start;
    ramdisk_data[36].len = data_things__death_session_end - data_things__death_session_start;
    ramdisk_data[37].data = data_things__elf_session_start;
    ramdisk_data[37].len = data_things__elf_session_end - data_things__elf_session_start;
    ...
    ramdisk_data[39].data = data_things__ghost_session_start;
    ramdisk_data[39].len = data_things__ghost_session_end - data_things__ghost_session_start;
    ramdisk_data[40].data = data_things__ghost2_session_start;
    ramdisk_data[40].len = data_things__ghost2_session_end - data_things__ghost2_session_start;
    ramdisk_data[41].data = data_things__ghost3_session_start;
    ramdisk_data[41].len = data_things__ghost3_session_end - data_things__ghost3_session_start;
    ramdisk_data[42].data = data_things__keys2_session_start;
    ramdisk_data[42].len = data_things__keys2_session_end - data_things__keys2_session_start;
    ramdisk_data[43].data = data_things__lizard_session_start;
    ramdisk_data[43].len = data_things__lizard_session_end - data_things__lizard_session_start;
    ramdisk_data[44].data = data_things__monk_session_start;
    ramdisk_data[44].len = data_things__monk_session_end - data_things__monk_session_start;
    ...
    ramdisk_data[46].data = data_things__poison8_session_start;
    ramdisk_data[46].len = data_things__poison8_session_end - data_things__poison8_session_start;
    ...
    ramdisk_data[50].data = data_things_arrow_start;
    ramdisk_data[50].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[51].data = data_things_bomb_start;
    ramdisk_data[51].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[52].data = data_things_bow1_start;
    ramdisk_data[52].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[53].data = data_things_bow2_start;
    ramdisk_data[53].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[54].data = data_things_bow3_start;
    ramdisk_data[54].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[55].data = data_things_bow4_start;
    ramdisk_data[55].len = data_things_bow4_end - data_things_bow4_start;
    ...
    ramdisk_data[72].data = data_things_explosion1_start;
    ramdisk_data[72].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[73].data = data_things_explosion2_start;
    ramdisk_data[73].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[74].data = data_things_explosion3_start;
    ramdisk_data[74].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[75].data = data_things_explosion4_start;
    ramdisk_data[75].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[76].data = data_things_explosion5_start;
    ramdisk_data[76].len = data_things_explosion5_end - data_things_explosion5_start;
    ramdisk_data[77].data = data_things_explosion6_start;
    ramdisk_data[77].len = data_things_explosion6_end - data_things_explosion6_start;
    ramdisk_data[78].data = data_things_explosion7_start;
    ramdisk_data[78].len = data_things_explosion7_end - data_things_explosion7_start;
    ramdisk_data[79].data = data_things_explosion8_start;
    ramdisk_data[79].len = data_things_explosion8_end - data_things_explosion8_start;
    ramdisk_data[80].data = data_things_fireball_start;
    ramdisk_data[80].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[81].data = data_things_floor_start;
    ramdisk_data[81].len = data_things_floor_end - data_things_floor_start;
    ramdisk_data[82].data = data_things_floor2_start;
    ramdisk_data[82].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[83].data = data_things_floor3_start;
    ramdisk_data[83].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[84].data = data_things_floor4_start;
    ramdisk_data[84].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[85].data = data_things_floor5_start;
    ramdisk_data[85].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[86].data = data_things_floor6_start;
    ramdisk_data[86].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[87].data = data_things_food_start;
    ramdisk_data[87].len = data_things_food_end - data_things_food_start;
    ramdisk_data[88].data = data_things_gem1_start;
    ramdisk_data[88].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[89].data = data_things_gem2_start;
    ramdisk_data[89].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[90].data = data_things_gem3_start;
    ramdisk_data[90].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[91].data = data_things_gem4_start;
    ramdisk_data[91].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[92].data = data_things_gem5_start;
    ramdisk_data[92].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[93].data = data_things_gem6_start;
    ramdisk_data[93].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[94].data = data_things_gem7_start;
    ramdisk_data[94].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[95].data = data_things_generator1_start;
    ramdisk_data[95].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[96].data = data_things_generator2_start;
    ramdisk_data[96].len = data_things_generator2_end - data_things_generator2_start;
    ramdisk_data[97].data = data_things_generator3_start;
    ramdisk_data[97].len = data_things_generator3_end - data_things_generator3_start;
    ramdisk_data[98].data = data_things_generator4_start;
    ramdisk_data[98].len = data_things_generator4_end - data_things_generator4_start;
    ramdisk_data[99].data = data_things_generator5_start;
    ramdisk_data[99].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[100].data = data_things_generator6_start;
    ramdisk_data[100].len = data_things_generator6_end - data_things_generator6_start;
    ...
    ramdisk_data[102].data = data_things_ghost1_start;
    ramdisk_data[102].len = data_things_ghost1_end - data_things_ghost1_start;
    ramdisk_data[103].data = data_things_ghost2_start;
    ramdisk_data[103].len = data_things_ghost2_end - data_things_ghost2_start;
    ramdisk_data[104].data = data_things_ghost3_start;
    ramdisk_data[104].len = data_things_ghost3_end - data_things_ghost3_start;
    ramdisk_data[105].data = data_things_key_start;
    ramdisk_data[105].len = data_things_key_end - data_things_key_start;
    ramdisk_data[106].data = data_things_keys2_start;
    ramdisk_data[106].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[107].data = data_things_keys3_start;
    ramdisk_data[107].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[108].data = data_things_lizard_start;
    ramdisk_data[108].len = data_things_lizard_end - data_things_lizard_start;
    ramdisk_data[109].data = data_things_mask1_start;
    ramdisk_data[109].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[110].data = data_things_mask2_start;
    ramdisk_data[110].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[111].data = data_things_mask3_start;
    ramdisk_data[111].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[112].data = data_things_monk_start;
    ramdisk_data[112].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[113].data = data_things_noentry_start;
    ramdisk_data[113].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[114].data = data_things_pipe_start;
    ramdisk_data[114].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[115].data = data_things_plant_start;
    ramdisk_data[115].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[116].data = data_things_poison1_start;
    ramdisk_data[116].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[117].data = data_things_poison2_start;
    ramdisk_data[117].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[118].data = data_things_poison3_start;
    ramdisk_data[118].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[119].data = data_things_poison4_start;
    ramdisk_data[119].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[120].data = data_things_poison5_start;
    ramdisk_data[120].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[121].data = data_things_poison6_start;
    ramdisk_data[121].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[122].data = data_things_poison7_start;
    ramdisk_data[122].len = data_things_poison7_end - data_things_poison7_start;
    ramdisk_data[123].data = data_things_poison8_start;
    ramdisk_data[123].len = data_things_poison8_end - data_things_poison8_start;
    ramdisk_data[124].data = data_things_potion_death_start;
    ramdisk_data[124].len = data_things_potion_death_end - data_things_potion_death_start;
    ramdisk_data[125].data = data_things_potion_fire_start;
    ramdisk_data[125].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[126].data = data_things_potion_life_start;
    ramdisk_data[126].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[127].data = data_things_potion_monsticide_start;
    ramdisk_data[127].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[128].data = data_things_potion_shield_start;
    ramdisk_data[128].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[129].data = data_things_seedpod_start;
    ramdisk_data[129].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[130].data = data_things_spam_start;
    ramdisk_data[130].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[131].data = data_things_valkyrie_start;
    ramdisk_data[131].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[132].data = data_things_wall_start;
    ramdisk_data[132].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[133].data = data_things_wall2_start;
    ramdisk_data[133].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[134].data = data_things_wall3_start;
    ramdisk_data[134].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[135].data = data_things_wall4_start;
    ramdisk_data[135].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[136].data = data_things_wall5_start;
    ramdisk_data[136].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[137].data = data_things_wand_fire_start;
    ramdisk_data[137].len = data_things_wand_fire_end - data_things_wand_fire_start;
