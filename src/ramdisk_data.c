...
void ramdisk_init (void)
{
    ...
    ramdisk_data[40].data = data_things__valkyrie_session_start;
    ramdisk_data[40].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[41].data = data_things__warrior_session_start;
    ramdisk_data[41].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ...
    ramdisk_data[49].data = data_things_dwarf_start;
    ramdisk_data[49].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[50].data = data_things_elf_start;
    ramdisk_data[50].len = data_things_elf_end - data_things_elf_start;
