...
void ramdisk_init (void)
{
    ...
    ramdisk_data[38].data = data_things__cheese_session_start;
    ramdisk_data[38].len = data_things__cheese_session_end - data_things__cheese_session_start;
    ramdisk_data[39].data = data_things__explosion_session_start;
    ramdisk_data[39].len = data_things__explosion_session_end - data_things__explosion_session_start;
    ramdisk_data[40].data = data_things__explosion1_session_start;
    ramdisk_data[40].len = data_things__explosion1_session_end - data_things__explosion1_session_start;
    ...
    ramdisk_data[42].data = data_things__poison8_session_start;
    ramdisk_data[42].len = data_things__poison8_session_end - data_things__poison8_session_start;
    ramdisk_data[43].data = data_things__water_poison_session_start;
    ramdisk_data[43].len = data_things__water_poison_session_end - data_things__water_poison_session_start;
    ramdisk_data[44].data = data_things_amulet1_start;
    ramdisk_data[44].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[45].data = data_things_apple_start;
    ramdisk_data[45].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[46].data = data_things_apple_poison_start;
    ramdisk_data[46].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[47].data = data_things_arrow_start;
    ramdisk_data[47].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[48].data = data_things_banana_start;
    ramdisk_data[48].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[49].data = data_things_bow1_start;
    ramdisk_data[49].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[50].data = data_things_bow2_start;
    ramdisk_data[50].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[51].data = data_things_bow3_start;
    ramdisk_data[51].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[52].data = data_things_bow4_start;
    ramdisk_data[52].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[53].data = data_things_bread_start;
    ramdisk_data[53].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[54].data = data_things_cheese_start;
    ramdisk_data[54].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[55].data = data_things_chest1_start;
    ramdisk_data[55].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[56].data = data_things_cloudkill1_start;
    ramdisk_data[56].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[57].data = data_things_cloudkill2_start;
    ramdisk_data[57].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[58].data = data_things_cloudkill3_start;
    ramdisk_data[58].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[59].data = data_things_cloudkill4_start;
    ramdisk_data[59].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[60].data = data_things_cloudkill5_start;
    ramdisk_data[60].len = data_things_cloudkill5_end - data_things_cloudkill5_start;
    ramdisk_data[61].data = data_things_cloudkill6_start;
    ramdisk_data[61].len = data_things_cloudkill6_end - data_things_cloudkill6_start;
    ramdisk_data[62].data = data_things_cloudkill7_start;
    ramdisk_data[62].len = data_things_cloudkill7_end - data_things_cloudkill7_start;
    ramdisk_data[63].data = data_things_cloudkill8_start;
    ramdisk_data[63].len = data_things_cloudkill8_end - data_things_cloudkill8_start;
    ...
    ramdisk_data[113].data = data_things_monk_start;
    ramdisk_data[113].len = data_things_monk_end - data_things_monk_start;
    ramdisk_data[114].data = data_things_noentry_start;
    ramdisk_data[114].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[115].data = data_things_pipe_start;
    ramdisk_data[115].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[116].data = data_things_plant_start;
    ramdisk_data[116].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[117].data = data_things_poison1_start;
    ramdisk_data[117].len = data_things_poison1_end - data_things_poison1_start;
    ramdisk_data[118].data = data_things_poison2_start;
    ramdisk_data[118].len = data_things_poison2_end - data_things_poison2_start;
    ramdisk_data[119].data = data_things_poison3_start;
    ramdisk_data[119].len = data_things_poison3_end - data_things_poison3_start;
    ramdisk_data[120].data = data_things_poison4_start;
    ramdisk_data[120].len = data_things_poison4_end - data_things_poison4_start;
    ramdisk_data[121].data = data_things_poison5_start;
    ramdisk_data[121].len = data_things_poison5_end - data_things_poison5_start;
    ramdisk_data[122].data = data_things_poison6_start;
    ramdisk_data[122].len = data_things_poison6_end - data_things_poison6_start;
    ramdisk_data[123].data = data_things_poison7_start;
    ramdisk_data[123].len = data_things_poison7_end - data_things_poison7_start;
    ramdisk_data[124].data = data_things_poison8_start;
    ramdisk_data[124].len = data_things_poison8_end - data_things_poison8_start;
    ...
    ramdisk_data[126].data = data_things_potion_fire_start;
    ramdisk_data[126].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[127].data = data_things_potion_life_start;
    ramdisk_data[127].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[128].data = data_things_potion_monsticide_start;
    ramdisk_data[128].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[129].data = data_things_potion_shield_start;
    ramdisk_data[129].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[130].data = data_things_ring1_start;
    ramdisk_data[130].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[131].data = data_things_ring2_start;
    ramdisk_data[131].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[132].data = data_things_ring3_start;
    ramdisk_data[132].len = data_things_ring3_end - data_things_ring3_start;
    ...
    ramdisk_data[143].data = data_things_water_start;
    ramdisk_data[143].len = data_things_water_end - data_things_water_start;
    ramdisk_data[144].data = data_things_water_poison_start;
    ramdisk_data[144].len = data_things_water_poison_end - data_things_water_poison_start;
