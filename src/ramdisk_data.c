...
void ramdisk_init (void)
{
    ...
    ramdisk_data[42].data = data_things__explosion1_session_start;
    ramdisk_data[42].len = data_things__explosion1_session_end - data_things__explosion1_session_start;
    ramdisk_data[43].data = data_things__explosion3_session_start;
    ramdisk_data[43].len = data_things__explosion3_session_end - data_things__explosion3_session_start;
    ramdisk_data[44].data = data_things__explosion4_session_start;
    ramdisk_data[44].len = data_things__explosion4_session_end - data_things__explosion4_session_start;
    ramdisk_data[45].data = data_things__floor1_session_start;
    ramdisk_data[45].len = data_things__floor1_session_end - data_things__floor1_session_start;
    ramdisk_data[46].data = data_things__floor6_session_start;
    ramdisk_data[46].len = data_things__floor6_session_end - data_things__floor6_session_start;
    ramdisk_data[47].data = data_things__key1_session_start;
    ramdisk_data[47].len = data_things__key1_session_end - data_things__key1_session_start;
    ...
    ramdisk_data[50].data = data_things__poison1_session_start;
    ramdisk_data[50].len = data_things__poison1_session_end - data_things__poison1_session_start;
    ramdisk_data[51].data = data_things__poison4_session_start;
    ramdisk_data[51].len = data_things__poison4_session_end - data_things__poison4_session_start;
    ramdisk_data[52].data = data_things__rock1_session_start;
    ramdisk_data[52].len = data_things__rock1_session_end - data_things__rock1_session_start;
    ...
    ramdisk_data[54].data = data_things__wall6_session_start;
    ramdisk_data[54].len = data_things__wall6_session_end - data_things__wall6_session_start;
    ramdisk_data[55].data = data_things__weapon_swing1_session_start;
    ramdisk_data[55].len = data_things__weapon_swing1_session_end - data_things__weapon_swing1_session_start;
    ...
    ramdisk_data[58].data = data_things_apple_start;
    ramdisk_data[58].len = data_things_apple_end - data_things_apple_start;
    ramdisk_data[59].data = data_things_apple_poison_start;
    ramdisk_data[59].len = data_things_apple_poison_end - data_things_apple_poison_start;
    ramdisk_data[60].data = data_things_arrow_start;
    ramdisk_data[60].len = data_things_arrow_end - data_things_arrow_start;
    ramdisk_data[61].data = data_things_axe1_start;
    ramdisk_data[61].len = data_things_axe1_end - data_things_axe1_start;
    ramdisk_data[62].data = data_things_axe1_anim_start;
    ramdisk_data[62].len = data_things_axe1_anim_end - data_things_axe1_anim_start;
    ramdisk_data[63].data = data_things_axe2_start;
    ramdisk_data[63].len = data_things_axe2_end - data_things_axe2_start;
    ramdisk_data[64].data = data_things_axe2_anim_start;
    ramdisk_data[64].len = data_things_axe2_anim_end - data_things_axe2_anim_start;
    ramdisk_data[65].data = data_things_banana_start;
    ramdisk_data[65].len = data_things_banana_end - data_things_banana_start;
    ramdisk_data[66].data = data_things_bonepile1_start;
    ramdisk_data[66].len = data_things_bonepile1_end - data_things_bonepile1_start;
    ramdisk_data[67].data = data_things_bonepile2_start;
    ramdisk_data[67].len = data_things_bonepile2_end - data_things_bonepile2_start;
    ramdisk_data[68].data = data_things_bonepile3_start;
    ramdisk_data[68].len = data_things_bonepile3_end - data_things_bonepile3_start;
    ramdisk_data[69].data = data_things_bow1_start;
    ramdisk_data[69].len = data_things_bow1_end - data_things_bow1_start;
    ramdisk_data[70].data = data_things_bow1_anim_start;
    ramdisk_data[70].len = data_things_bow1_anim_end - data_things_bow1_anim_start;
    ramdisk_data[71].data = data_things_bow2_start;
    ramdisk_data[71].len = data_things_bow2_end - data_things_bow2_start;
    ramdisk_data[72].data = data_things_bow3_start;
    ramdisk_data[72].len = data_things_bow3_end - data_things_bow3_start;
    ramdisk_data[73].data = data_things_bow4_start;
    ramdisk_data[73].len = data_things_bow4_end - data_things_bow4_start;
    ramdisk_data[74].data = data_things_bread_start;
    ramdisk_data[74].len = data_things_bread_end - data_things_bread_start;
    ramdisk_data[75].data = data_things_cheese_start;
    ramdisk_data[75].len = data_things_cheese_end - data_things_cheese_start;
    ramdisk_data[76].data = data_things_chest1_start;
    ramdisk_data[76].len = data_things_chest1_end - data_things_chest1_start;
    ramdisk_data[77].data = data_things_cloudkill1_start;
    ramdisk_data[77].len = data_things_cloudkill1_end - data_things_cloudkill1_start;
    ramdisk_data[78].data = data_things_cloudkill2_start;
    ramdisk_data[78].len = data_things_cloudkill2_end - data_things_cloudkill2_start;
    ramdisk_data[79].data = data_things_cloudkill3_start;
    ramdisk_data[79].len = data_things_cloudkill3_end - data_things_cloudkill3_start;
    ramdisk_data[80].data = data_things_cloudkill4_start;
    ramdisk_data[80].len = data_things_cloudkill4_end - data_things_cloudkill4_start;
    ramdisk_data[81].data = data_things_coins1_start;
    ramdisk_data[81].len = data_things_coins1_end - data_things_coins1_start;
    ramdisk_data[82].data = data_things_death_start;
    ramdisk_data[82].len = data_things_death_end - data_things_death_start;
    ramdisk_data[83].data = data_things_demon_start;
    ramdisk_data[83].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[84].data = data_things_door1_start;
    ramdisk_data[84].len = data_things_door1_end - data_things_door1_start;
    ramdisk_data[85].data = data_things_door2_start;
    ramdisk_data[85].len = data_things_door2_end - data_things_door2_start;
    ramdisk_data[86].data = data_things_dwarf_start;
    ramdisk_data[86].len = data_things_dwarf_end - data_things_dwarf_start;
    ramdisk_data[87].data = data_things_elf_start;
    ramdisk_data[87].len = data_things_elf_end - data_things_elf_start;
    ramdisk_data[88].data = data_things_exit1_start;
    ramdisk_data[88].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[89].data = data_things_exit2_start;
    ramdisk_data[89].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[90].data = data_things_exit3_start;
    ramdisk_data[90].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[91].data = data_things_exit4_start;
    ramdisk_data[91].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[92].data = data_things_exit5_start;
    ramdisk_data[92].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[93].data = data_things_exit6_start;
    ramdisk_data[93].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[94].data = data_things_exit7_start;
    ramdisk_data[94].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[95].data = data_things_explosion1_start;
    ramdisk_data[95].len = data_things_explosion1_end - data_things_explosion1_start;
    ramdisk_data[96].data = data_things_explosion2_start;
    ramdisk_data[96].len = data_things_explosion2_end - data_things_explosion2_start;
    ramdisk_data[97].data = data_things_explosion3_start;
    ramdisk_data[97].len = data_things_explosion3_end - data_things_explosion3_start;
    ramdisk_data[98].data = data_things_explosion4_start;
    ramdisk_data[98].len = data_things_explosion4_end - data_things_explosion4_start;
    ramdisk_data[99].data = data_things_fireball_start;
    ramdisk_data[99].len = data_things_fireball_end - data_things_fireball_start;
    ramdisk_data[100].data = data_things_floor1_start;
    ramdisk_data[100].len = data_things_floor1_end - data_things_floor1_start;
    ...
    ramdisk_data[132].data = data_things_potion_cloudkill_start;
    ramdisk_data[132].len = data_things_potion_cloudkill_end - data_things_potion_cloudkill_start;
    ramdisk_data[133].data = data_things_potion_fire_start;
    ramdisk_data[133].len = data_things_potion_fire_end - data_things_potion_fire_start;
    ramdisk_data[134].data = data_things_potion_life_start;
    ramdisk_data[134].len = data_things_potion_life_end - data_things_potion_life_start;
    ramdisk_data[135].data = data_things_potion_monsticide_start;
    ramdisk_data[135].len = data_things_potion_monsticide_end - data_things_potion_monsticide_start;
    ramdisk_data[136].data = data_things_potion_shield_start;
    ramdisk_data[136].len = data_things_potion_shield_end - data_things_potion_shield_start;
    ramdisk_data[137].data = data_things_ring1_start;
    ramdisk_data[137].len = data_things_ring1_end - data_things_ring1_start;
    ramdisk_data[138].data = data_things_ring2_start;
    ramdisk_data[138].len = data_things_ring2_end - data_things_ring2_start;
    ramdisk_data[139].data = data_things_ring3_start;
    ramdisk_data[139].len = data_things_ring3_end - data_things_ring3_start;
    ramdisk_data[140].data = data_things_rock1_start;
    ramdisk_data[140].len = data_things_rock1_end - data_things_rock1_start;
    ramdisk_data[141].data = data_things_scythe1_start;
    ramdisk_data[141].len = data_things_scythe1_end - data_things_scythe1_start;
    ramdisk_data[142].data = data_things_scythe1_anim_start;
    ramdisk_data[142].len = data_things_scythe1_anim_end - data_things_scythe1_anim_start;
    ramdisk_data[143].data = data_things_seedpod_start;
    ramdisk_data[143].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[144].data = data_things_spam_start;
    ramdisk_data[144].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[145].data = data_things_sparks1_start;
    ramdisk_data[145].len = data_things_sparks1_end - data_things_sparks1_start;
    ramdisk_data[146].data = data_things_sparks2_start;
    ramdisk_data[146].len = data_things_sparks2_end - data_things_sparks2_start;
    ramdisk_data[147].data = data_things_sparks3_start;
    ramdisk_data[147].len = data_things_sparks3_end - data_things_sparks3_start;
    ramdisk_data[148].data = data_things_sword1_start;
    ramdisk_data[148].len = data_things_sword1_end - data_things_sword1_start;
    ramdisk_data[149].data = data_things_sword1_anim_start;
    ramdisk_data[149].len = data_things_sword1_anim_end - data_things_sword1_anim_start;
    ramdisk_data[150].data = data_things_sword2_start;
    ramdisk_data[150].len = data_things_sword2_end - data_things_sword2_start;
    ramdisk_data[151].data = data_things_sword2_anim_start;
    ramdisk_data[151].len = data_things_sword2_anim_end - data_things_sword2_anim_start;
    ramdisk_data[152].data = data_things_sword3_start;
    ramdisk_data[152].len = data_things_sword3_end - data_things_sword3_start;
    ramdisk_data[153].data = data_things_sword3_anim_start;
    ramdisk_data[153].len = data_things_sword3_anim_end - data_things_sword3_anim_start;
