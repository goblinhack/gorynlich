...
void ramdisk_init (void)
{
    ...
    ramdisk_data[6].data = data_gfx_shell_png_start;
    ramdisk_data[6].len = data_gfx_shell_png_end - data_gfx_shell_png_start;
    ...
    ramdisk_data[35].data = data_things_door_start;
    ramdisk_data[35].len = data_things_door_end - data_things_door_start;
    ramdisk_data[36].data = data_things_exit_start;
    ramdisk_data[36].len = data_things_exit_end - data_things_exit_start;
    ramdisk_data[37].data = data_things_exit1_start;
    ramdisk_data[37].len = data_things_exit1_end - data_things_exit1_start;
    ramdisk_data[38].data = data_things_exit2_start;
    ramdisk_data[38].len = data_things_exit2_end - data_things_exit2_start;
    ramdisk_data[39].data = data_things_exit3_start;
    ramdisk_data[39].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[40].data = data_things_exit4_start;
    ramdisk_data[40].len = data_things_exit4_end - data_things_exit4_start;
    ramdisk_data[41].data = data_things_exit5_start;
    ramdisk_data[41].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[42].data = data_things_exit6_start;
    ramdisk_data[42].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[43].data = data_things_exit7_start;
    ramdisk_data[43].len = data_things_exit7_end - data_things_exit7_start;
    ramdisk_data[44].data = data_things_explosion_start;
    ramdisk_data[44].len = data_things_explosion_end - data_things_explosion_start;
    ramdisk_data[45].data = data_things_floor_start;
    ramdisk_data[45].len = data_things_floor_end - data_things_floor_start;
    ramdisk_data[46].data = data_things_floor2_start;
    ramdisk_data[46].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[47].data = data_things_floor3_start;
    ramdisk_data[47].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[48].data = data_things_floor4_start;
    ramdisk_data[48].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[49].data = data_things_floor5_start;
    ramdisk_data[49].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[50].data = data_things_floor6_start;
    ramdisk_data[50].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[51].data = data_things_food_start;
    ramdisk_data[51].len = data_things_food_end - data_things_food_start;
    ramdisk_data[52].data = data_things_gem1_start;
    ramdisk_data[52].len = data_things_gem1_end - data_things_gem1_start;
    ramdisk_data[53].data = data_things_gem2_start;
    ramdisk_data[53].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[54].data = data_things_gem3_start;
    ramdisk_data[54].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[55].data = data_things_gem4_start;
    ramdisk_data[55].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[56].data = data_things_gem5_start;
    ramdisk_data[56].len = data_things_gem5_end - data_things_gem5_start;
    ramdisk_data[57].data = data_things_gem6_start;
    ramdisk_data[57].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[58].data = data_things_gem7_start;
    ramdisk_data[58].len = data_things_gem7_end - data_things_gem7_start;
    ramdisk_data[59].data = data_things_generator1_start;
    ramdisk_data[59].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[60].data = data_things_generator2_start;
    ramdisk_data[60].len = data_things_generator2_end - data_things_generator2_start;
    ramdisk_data[61].data = data_things_generator3_start;
    ramdisk_data[61].len = data_things_generator3_end - data_things_generator3_start;
    ramdisk_data[62].data = data_things_generator4_start;
    ramdisk_data[62].len = data_things_generator4_end - data_things_generator4_start;
    ramdisk_data[63].data = data_things_generator5_start;
    ramdisk_data[63].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[64].data = data_things_generator6_start;
    ramdisk_data[64].len = data_things_generator6_end - data_things_generator6_start;
    ramdisk_data[65].data = data_things_generator7_start;
    ramdisk_data[65].len = data_things_generator7_end - data_things_generator7_start;
    ramdisk_data[66].data = data_things_keys1_start;
    ramdisk_data[66].len = data_things_keys1_end - data_things_keys1_start;
    ramdisk_data[67].data = data_things_keys2_start;
    ramdisk_data[67].len = data_things_keys2_end - data_things_keys2_start;
    ramdisk_data[68].data = data_things_keys3_start;
    ramdisk_data[68].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[69].data = data_things_mask1_start;
    ramdisk_data[69].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[70].data = data_things_mask2_start;
    ramdisk_data[70].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[71].data = data_things_mask3_start;
    ramdisk_data[71].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[72].data = data_things_noentry_start;
    ramdisk_data[72].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[73].data = data_things_pipe_start;
    ramdisk_data[73].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[74].data = data_things_plant_start;
    ramdisk_data[74].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[75].data = data_things_player_start;
    ramdisk_data[75].len = data_things_player_end - data_things_player_start;
    ramdisk_data[76].data = data_things_potion1_start;
    ramdisk_data[76].len = data_things_potion1_end - data_things_potion1_start;
    ramdisk_data[77].data = data_things_potion2_start;
    ramdisk_data[77].len = data_things_potion2_end - data_things_potion2_start;
    ramdisk_data[78].data = data_things_potion3_start;
    ramdisk_data[78].len = data_things_potion3_end - data_things_potion3_start;
    ramdisk_data[79].data = data_things_potion4_start;
    ramdisk_data[79].len = data_things_potion4_end - data_things_potion4_start;
    ramdisk_data[80].data = data_things_potion5_start;
    ramdisk_data[80].len = data_things_potion5_end - data_things_potion5_start;
    ramdisk_data[81].data = data_things_seedpod_start;
    ramdisk_data[81].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[82].data = data_things_spam_start;
    ramdisk_data[82].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[83].data = data_things_wall_start;
    ramdisk_data[83].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[84].data = data_things_wall2_start;
    ramdisk_data[84].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[85].data = data_things_wall3_start;
    ramdisk_data[85].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[86].data = data_things_wall4_start;
    ramdisk_data[86].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[87].data = data_things_wall5_start;
    ramdisk_data[87].len = data_things_wall5_end - data_things_wall5_start;
    ramdisk_data[88].data = data_things_water1_start;
    ramdisk_data[88].len = data_things_water1_end - data_things_water1_start;
    ramdisk_data[89].data = data_things_water2_start;
    ramdisk_data[89].len = data_things_water2_end - data_things_water2_start;
    ramdisk_data[90].data = data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[90].len = data_ttf_large_ttf_pointsize50_data_end - data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[91].data = data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[91].len = data_ttf_large_ttf_pointsize50_tga_end - data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[92].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[92].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[93].data = data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[93].len = data_ttf_med_ttf_pointsize40_data_end - data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[94].data = data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[94].len = data_ttf_med_ttf_pointsize40_tga_end - data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[95].data = data_ttf_Readme_txt_start;
    ramdisk_data[95].len = data_ttf_Readme_txt_end - data_ttf_Readme_txt_start;
    ramdisk_data[96].data = data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[96].len = data_ttf_small_ttf_pointsize10_data_end - data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[97].data = data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[97].len = data_ttf_small_ttf_pointsize10_tga_end - data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[98].data = data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[98].len = data_ttf_small_ttf_pointsize15_data_end - data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[99].data = data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[99].len = data_ttf_small_ttf_pointsize15_tga_end - data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[100].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[100].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[101].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[101].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
