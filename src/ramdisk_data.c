...
void ramdisk_init (void)
{
    ...
    ramdisk_data[51].data = data_things__floor2_session_start;
    ramdisk_data[51].len = data_things__floor2_session_end - data_things__floor2_session_start;
    ramdisk_data[52].data = data_things__floor3_session_start;
    ramdisk_data[52].len = data_things__floor3_session_end - data_things__floor3_session_start;
    ramdisk_data[53].data = data_things__floor4_session_start;
    ramdisk_data[53].len = data_things__floor4_session_end - data_things__floor4_session_start;
    ramdisk_data[54].data = data_things__food_session_start;
    ramdisk_data[54].len = data_things__food_session_end - data_things__food_session_start;
    ramdisk_data[55].data = data_things__rock_0_session_start;
    ramdisk_data[55].len = data_things__rock_0_session_end - data_things__rock_0_session_start;
    ramdisk_data[56].data = data_things__rock_1_session_start;
    ramdisk_data[56].len = data_things__rock_1_session_end - data_things__rock_1_session_start;
    ...
    ramdisk_data[62].data = data_things_explosion_start;
    ramdisk_data[62].len = data_things_explosion_end - data_things_explosion_start;
    ramdisk_data[63].data = data_things_floor_start;
    ramdisk_data[63].len = data_things_floor_end - data_things_floor_start;
    ramdisk_data[64].data = data_things_floor2_start;
    ramdisk_data[64].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[65].data = data_things_floor3_start;
    ramdisk_data[65].len = data_things_floor3_end - data_things_floor3_start;
    ramdisk_data[66].data = data_things_floor4_start;
    ramdisk_data[66].len = data_things_floor4_end - data_things_floor4_start;
    ramdisk_data[67].data = data_things_food_start;
    ramdisk_data[67].len = data_things_food_end - data_things_food_start;
    ramdisk_data[68].data = data_things_noentry_start;
    ramdisk_data[68].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[69].data = data_things_pipe_start;
    ramdisk_data[69].len = data_things_pipe_end - data_things_pipe_start;
    ramdisk_data[70].data = data_things_plant_start;
    ramdisk_data[70].len = data_things_plant_end - data_things_plant_start;
    ramdisk_data[71].data = data_things_player_start;
    ramdisk_data[71].len = data_things_player_end - data_things_player_start;
    ramdisk_data[72].data = data_things_seedpod_start;
    ramdisk_data[72].len = data_things_seedpod_end - data_things_seedpod_start;
    ramdisk_data[73].data = data_things_spam_start;
    ramdisk_data[73].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[74].data = data_things_wall_start;
    ramdisk_data[74].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[75].data = data_things_wall2_start;
    ramdisk_data[75].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[76].data = data_ttf_large_ttf_pointsize20_data_start;
    ramdisk_data[76].len = data_ttf_large_ttf_pointsize20_data_end - data_ttf_large_ttf_pointsize20_data_start;
    ramdisk_data[77].data = data_ttf_large_ttf_pointsize20_tga_start;
    ramdisk_data[77].len = data_ttf_large_ttf_pointsize20_tga_end - data_ttf_large_ttf_pointsize20_tga_start;
    ramdisk_data[78].data = data_ttf_large_ttf_pointsize30_data_start;
    ramdisk_data[78].len = data_ttf_large_ttf_pointsize30_data_end - data_ttf_large_ttf_pointsize30_data_start;
    ramdisk_data[79].data = data_ttf_large_ttf_pointsize30_tga_start;
    ramdisk_data[79].len = data_ttf_large_ttf_pointsize30_tga_end - data_ttf_large_ttf_pointsize30_tga_start;
    ramdisk_data[80].data = data_ttf_large_ttf_pointsize40_data_start;
    ramdisk_data[80].len = data_ttf_large_ttf_pointsize40_data_end - data_ttf_large_ttf_pointsize40_data_start;
    ramdisk_data[81].data = data_ttf_large_ttf_pointsize40_tga_start;
    ramdisk_data[81].len = data_ttf_large_ttf_pointsize40_tga_end - data_ttf_large_ttf_pointsize40_tga_start;
    ramdisk_data[82].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[82].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[83].data = data_ttf_med_ttf_pointsize12_data_start;
    ramdisk_data[83].len = data_ttf_med_ttf_pointsize12_data_end - data_ttf_med_ttf_pointsize12_data_start;
    ramdisk_data[84].data = data_ttf_med_ttf_pointsize12_tga_start;
    ramdisk_data[84].len = data_ttf_med_ttf_pointsize12_tga_end - data_ttf_med_ttf_pointsize12_tga_start;
    ramdisk_data[85].data = data_ttf_med_ttf_pointsize20_data_start;
    ramdisk_data[85].len = data_ttf_med_ttf_pointsize20_data_end - data_ttf_med_ttf_pointsize20_data_start;
    ramdisk_data[86].data = data_ttf_med_ttf_pointsize20_tga_start;
    ramdisk_data[86].len = data_ttf_med_ttf_pointsize20_tga_end - data_ttf_med_ttf_pointsize20_tga_start;
    ramdisk_data[87].data = data_ttf_med_ttf_pointsize30_data_start;
    ramdisk_data[87].len = data_ttf_med_ttf_pointsize30_data_end - data_ttf_med_ttf_pointsize30_data_start;
    ramdisk_data[88].data = data_ttf_med_ttf_pointsize30_tga_start;
    ramdisk_data[88].len = data_ttf_med_ttf_pointsize30_tga_end - data_ttf_med_ttf_pointsize30_tga_start;
    ramdisk_data[89].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[89].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[90].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[90].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
