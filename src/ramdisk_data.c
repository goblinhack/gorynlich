...
void ramdisk_init (void)
{
    ...
    ramdisk_data[84].data = data_gfx_sprites_small_xcf_start;
    ramdisk_data[84].len = data_gfx_sprites_small_xcf_end - data_gfx_sprites_small_xcf_start;
    ramdisk_data[85].data = data_gfx_help3_png_start;
    ramdisk_data[85].len = data_gfx_help3_png_end - data_gfx_help3_png_start;
    ramdisk_data[86].data = data_gfx_gorynlich_png_start;
    ramdisk_data[86].len = data_gfx_gorynlich_png_end - data_gfx_gorynlich_png_start;
    ramdisk_data[87].data = data_gfx_sprites_small_png_start;
    ramdisk_data[87].len = data_gfx_sprites_small_png_end - data_gfx_sprites_small_png_start;
    ramdisk_data[88].data = data_gfx_title2_png_start;
    ramdisk_data[88].len = data_gfx_title2_png_end - data_gfx_title2_png_start;
    ramdisk_data[89].data = data_gfx_help2_png_start;
    ramdisk_data[89].len = data_gfx_help2_png_end - data_gfx_help2_png_start;
    ...
    ramdisk_data[93].data = data_levels_1_start;
    ramdisk_data[93].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[94].data = data_things_exit5_start;
    ramdisk_data[94].len = data_things_exit5_end - data_things_exit5_start;
    ramdisk_data[95].data = data_things_plant_start;
    ramdisk_data[95].len = data_things_plant_end - data_things_plant_start;
    ...
    ramdisk_data[98].data = data_things_gem3_start;
    ramdisk_data[98].len = data_things_gem3_end - data_things_gem3_start;
    ramdisk_data[99].data = data_things_water2_start;
    ramdisk_data[99].len = data_things_water2_end - data_things_water2_start;
    ramdisk_data[100].data = data_things_wall2_start;
    ramdisk_data[100].len = data_things_wall2_end - data_things_wall2_start;
    ramdisk_data[101].data = data_things_gem6_start;
    ramdisk_data[101].len = data_things_gem6_end - data_things_gem6_start;
    ramdisk_data[102].data = data_things_amulet1_start;
    ramdisk_data[102].len = data_things_amulet1_end - data_things_amulet1_start;
    ramdisk_data[103].data = data_things_exit6_start;
    ramdisk_data[103].len = data_things_exit6_end - data_things_exit6_start;
    ramdisk_data[104].data = data_things_keys1_start;
    ramdisk_data[104].len = data_things_keys1_end - data_things_keys1_start;
    ramdisk_data[105].data = data_things_dwarve_start;
    ramdisk_data[105].len = data_things_dwarve_end - data_things_dwarve_start;
    ramdisk_data[106].data = data_things_wall5_start;
    ramdisk_data[106].len = data_things_wall5_end - data_things_wall5_start;
    ...
    ramdisk_data[111].data = data_things_generator1_start;
    ramdisk_data[111].len = data_things_generator1_end - data_things_generator1_start;
    ramdisk_data[112].data = data_things_potion4_start;
    ramdisk_data[112].len = data_things_potion4_end - data_things_potion4_start;
    ramdisk_data[113].data = data_things_floor3_start;
    ramdisk_data[113].len = data_things_floor3_end - data_things_floor3_start;
    ...
    ramdisk_data[117].data = data_things_gem1_start;
    ramdisk_data[117].len = data_things_gem1_end - data_things_gem1_start;
    ...
    ramdisk_data[121].data = data_things_elve_start;
    ramdisk_data[121].len = data_things_elve_end - data_things_elve_start;
    ...
    ramdisk_data[124].data = data_things_generator5_start;
    ramdisk_data[124].len = data_things_generator5_end - data_things_generator5_start;
    ramdisk_data[125].data = data_things_floor2_start;
    ramdisk_data[125].len = data_things_floor2_end - data_things_floor2_start;
    ramdisk_data[126].data = data_things_valkyrie_start;
    ramdisk_data[126].len = data_things_valkyrie_end - data_things_valkyrie_start;
    ramdisk_data[127].data = data_things_mask2_start;
    ramdisk_data[127].len = data_things_mask2_end - data_things_mask2_start;
    ramdisk_data[128].data = data_things_wall4_start;
    ramdisk_data[128].len = data_things_wall4_end - data_things_wall4_start;
    ramdisk_data[129].data = data_things_floor6_start;
    ramdisk_data[129].len = data_things_floor6_end - data_things_floor6_start;
    ramdisk_data[130].data = data_things_wizard_start;
    ramdisk_data[130].len = data_things_wizard_end - data_things_wizard_start;
    ramdisk_data[131].data = data_things_potion2_start;
    ramdisk_data[131].len = data_things_potion2_end - data_things_potion2_start;
    ramdisk_data[132].data = data_things_bomb_start;
    ramdisk_data[132].len = data_things_bomb_end - data_things_bomb_start;
    ramdisk_data[133].data = data_things_exit3_start;
    ramdisk_data[133].len = data_things_exit3_end - data_things_exit3_start;
    ramdisk_data[134].data = data_things_exit_start;
    ramdisk_data[134].len = data_things_exit_end - data_things_exit_start;
    ramdisk_data[135].data = data_things_coins1_start;
    ramdisk_data[135].len = data_things_coins1_end - data_things_coins1_start;
    ...
    ramdisk_data[138].data = data_things_potion1_start;
    ramdisk_data[138].len = data_things_potion1_end - data_things_potion1_start;
    ramdisk_data[139].data = data_things_demon_start;
    ramdisk_data[139].len = data_things_demon_end - data_things_demon_start;
    ramdisk_data[140].data = data_things_generator2_start;
    ramdisk_data[140].len = data_things_generator2_end - data_things_generator2_start;
    ramdisk_data[141].data = data_things_floor5_start;
    ramdisk_data[141].len = data_things_floor5_end - data_things_floor5_start;
    ramdisk_data[142].data = data_things_generator4_start;
    ramdisk_data[142].len = data_things_generator4_end - data_things_generator4_start;
    ramdisk_data[143].data = data_things_wall_start;
    ramdisk_data[143].len = data_things_wall_end - data_things_wall_start;
    ramdisk_data[144].data = data_things_ghost_start;
    ramdisk_data[144].len = data_things_ghost_end - data_things_ghost_start;
    ...
    ramdisk_data[146].data = data_things_mask3_start;
    ramdisk_data[146].len = data_things_mask3_end - data_things_mask3_start;
    ramdisk_data[147].data = data_things_spam_start;
    ramdisk_data[147].len = data_things_spam_end - data_things_spam_start;
    ramdisk_data[148].data = data_things_explosion_start;
    ramdisk_data[148].len = data_things_explosion_end - data_things_explosion_start;
    ...
    ramdisk_data[151].data = data_things_potion3_start;
    ramdisk_data[151].len = data_things_potion3_end - data_things_potion3_start;
    ramdisk_data[152].data = data_things_noentry_start;
    ramdisk_data[152].len = data_things_noentry_end - data_things_noentry_start;
    ramdisk_data[153].data = data_things_food_start;
    ramdisk_data[153].len = data_things_food_end - data_things_food_start;
    ramdisk_data[154].data = data_things_gem2_start;
    ramdisk_data[154].len = data_things_gem2_end - data_things_gem2_start;
    ramdisk_data[155].data = data_things_mask1_start;
    ramdisk_data[155].len = data_things_mask1_end - data_things_mask1_start;
    ramdisk_data[156].data = data_things_gem4_start;
    ramdisk_data[156].len = data_things_gem4_end - data_things_gem4_start;
    ramdisk_data[157].data = data_things_potion5_start;
    ramdisk_data[157].len = data_things_potion5_end - data_things_potion5_start;
    ramdisk_data[158].data = data_things_generator3_start;
    ramdisk_data[158].len = data_things_generator3_end - data_things_generator3_start;
    ramdisk_data[159].data = data_things_floor_start;
    ramdisk_data[159].len = data_things_floor_end - data_things_floor_start;
    ramdisk_data[160].data = data_things_keys3_start;
    ramdisk_data[160].len = data_things_keys3_end - data_things_keys3_start;
    ramdisk_data[161].data = data_things_wall3_start;
    ramdisk_data[161].len = data_things_wall3_end - data_things_wall3_start;
    ramdisk_data[162].data = data_map_jigsaw_map_start;
    ramdisk_data[162].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[163].data = data_map_map_light_data_start;
    ramdisk_data[163].len = data_map_map_light_data_end - data_map_map_light_data_start;
    ramdisk_data[164].data = data_music_hiscore_wav_start;
    ramdisk_data[164].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[165].data = data_music_music_wav_start;
    ramdisk_data[165].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[166].data = data_music_intro_wav_start;
    ramdisk_data[166].len = data_music_intro_wav_end - data_music_intro_wav_start;
}
