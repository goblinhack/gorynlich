...
void ramdisk_init (void)
{
    ...
    ramdisk_data[9].data = data_levels_1_start;
    ramdisk_data[9].len = data_levels_1_end - data_levels_1_start;
    ramdisk_data[10].data = data_levels_2_start;
    ramdisk_data[10].len = data_levels_2_end - data_levels_2_start;
    ramdisk_data[11].data = data_map_jigsaw_map_start;
    ramdisk_data[11].len = data_map_jigsaw_map_end - data_map_jigsaw_map_start;
    ramdisk_data[12].data = data_map_map_light_data_start;
    ramdisk_data[12].len = data_map_map_light_data_end - data_map_map_light_data_start;
    ramdisk_data[13].data = data_music_hiscore_wav_start;
    ramdisk_data[13].len = data_music_hiscore_wav_end - data_music_hiscore_wav_start;
    ramdisk_data[14].data = data_music_intro_wav_start;
    ramdisk_data[14].len = data_music_intro_wav_end - data_music_intro_wav_start;
    ramdisk_data[15].data = data_music_music_wav_start;
    ramdisk_data[15].len = data_music_music_wav_end - data_music_music_wav_start;
    ramdisk_data[16].data = data_sound_chomp_wav_start;
    ramdisk_data[16].len = data_sound_chomp_wav_end - data_sound_chomp_wav_start;
    ramdisk_data[17].data = data_sound_chomp2_wav_start;
    ramdisk_data[17].len = data_sound_chomp2_wav_end - data_sound_chomp2_wav_start;
    ramdisk_data[18].data = data_sound_click_wav_start;
    ramdisk_data[18].len = data_sound_click_wav_end - data_sound_click_wav_start;
    ramdisk_data[19].data = data_sound_doorbell_wav_start;
    ramdisk_data[19].len = data_sound_doorbell_wav_end - data_sound_doorbell_wav_start;
    ramdisk_data[20].data = data_sound_explosion_wav_start;
    ramdisk_data[20].len = data_sound_explosion_wav_end - data_sound_explosion_wav_start;
    ramdisk_data[21].data = data_sound_letter_wav_start;
    ramdisk_data[21].len = data_sound_letter_wav_end - data_sound_letter_wav_start;
    ramdisk_data[22].data = data_sound_level_end_wav_start;
    ramdisk_data[22].len = data_sound_level_end_wav_end - data_sound_level_end_wav_start;
    ramdisk_data[23].data = data_sound_paper_wav_start;
    ramdisk_data[23].len = data_sound_paper_wav_end - data_sound_paper_wav_start;
    ramdisk_data[24].data = data_sound_powerup_wav_start;
    ramdisk_data[24].len = data_sound_powerup_wav_end - data_sound_powerup_wav_start;
    ramdisk_data[25].data = data_sound_ratdeath_wav_start;
    ramdisk_data[25].len = data_sound_ratdeath_wav_end - data_sound_ratdeath_wav_start;
    ramdisk_data[26].data = data_sound_rocket_wav_start;
    ramdisk_data[26].len = data_sound_rocket_wav_end - data_sound_rocket_wav_start;
    ramdisk_data[27].data = data_sound_slime_wav_start;
    ramdisk_data[27].len = data_sound_slime_wav_end - data_sound_slime_wav_start;
    ramdisk_data[28].data = data_sound_spam_wav_start;
    ramdisk_data[28].len = data_sound_spam_wav_end - data_sound_spam_wav_start;
    ramdisk_data[29].data = data_sound_thief_wav_start;
    ramdisk_data[29].len = data_sound_thief_wav_end - data_sound_thief_wav_start;
    ramdisk_data[30].data = data_things__death_session_start;
    ramdisk_data[30].len = data_things__death_session_end - data_things__death_session_start;
    ramdisk_data[31].data = data_things__demon_session_start;
    ramdisk_data[31].len = data_things__demon_session_end - data_things__demon_session_start;
    ramdisk_data[32].data = data_things__dwarve_session_start;
    ramdisk_data[32].len = data_things__dwarve_session_end - data_things__dwarve_session_start;
    ramdisk_data[33].data = data_things__elve_session_start;
    ramdisk_data[33].len = data_things__elve_session_end - data_things__elve_session_start;
    ramdisk_data[34].data = data_things__ghost_session_start;
    ramdisk_data[34].len = data_things__ghost_session_end - data_things__ghost_session_start;
    ramdisk_data[35].data = data_things__lizard_session_start;
    ramdisk_data[35].len = data_things__lizard_session_end - data_things__lizard_session_start;
    ramdisk_data[36].data = data_things__monk_session_start;
    ramdisk_data[36].len = data_things__monk_session_end - data_things__monk_session_start;
    ramdisk_data[37].data = data_things__valkyrie_session_start;
    ramdisk_data[37].len = data_things__valkyrie_session_end - data_things__valkyrie_session_start;
    ramdisk_data[38].data = data_things__warrior_session_start;
    ramdisk_data[38].len = data_things__warrior_session_end - data_things__warrior_session_start;
    ramdisk_data[39].data = data_things__wizard_session_start;
    ramdisk_data[39].len = data_things__wizard_session_end - data_things__wizard_session_start;
    ...
    ramdisk_data[47].data = data_things_dwarve_start;
    ramdisk_data[47].len = data_things_dwarve_end - data_things_dwarve_start;
    ...
    ramdisk_data[109].data = data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[109].len = data_ttf_large_ttf_pointsize50_data_end - data_ttf_large_ttf_pointsize50_data_start;
    ramdisk_data[110].data = data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[110].len = data_ttf_large_ttf_pointsize50_tga_end - data_ttf_large_ttf_pointsize50_tga_start;
    ramdisk_data[111].data = data_ttf_LICENSE_txt_start;
    ramdisk_data[111].len = data_ttf_LICENSE_txt_end - data_ttf_LICENSE_txt_start;
    ramdisk_data[112].data = data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[112].len = data_ttf_med_ttf_pointsize40_data_end - data_ttf_med_ttf_pointsize40_data_start;
    ramdisk_data[113].data = data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[113].len = data_ttf_med_ttf_pointsize40_tga_end - data_ttf_med_ttf_pointsize40_tga_start;
    ramdisk_data[114].data = data_ttf_readme_txt_start;
    ramdisk_data[114].len = data_ttf_readme_txt_end - data_ttf_readme_txt_start;
    ramdisk_data[115].data = data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[115].len = data_ttf_small_ttf_pointsize10_data_end - data_ttf_small_ttf_pointsize10_data_start;
    ramdisk_data[116].data = data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[116].len = data_ttf_small_ttf_pointsize10_tga_end - data_ttf_small_ttf_pointsize10_tga_start;
    ramdisk_data[117].data = data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[117].len = data_ttf_small_ttf_pointsize15_data_end - data_ttf_small_ttf_pointsize15_data_start;
    ramdisk_data[118].data = data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[118].len = data_ttf_small_ttf_pointsize15_tga_end - data_ttf_small_ttf_pointsize15_tga_start;
    ramdisk_data[119].data = data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[119].len = data_ttf_small_ttf_pointsize20_data_end - data_ttf_small_ttf_pointsize20_data_start;
    ramdisk_data[120].data = data_ttf_small_ttf_pointsize20_tga_start;
    ramdisk_data[120].len = data_ttf_small_ttf_pointsize20_tga_end - data_ttf_small_ttf_pointsize20_tga_start;
}
