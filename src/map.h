...
uint8_t map_is_armour_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_armour_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_armour(levelp);
...
tree_rootp map_all_things_is_armour_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_armour(levelp);
