...
uint8_t map_is_centered_on_owner_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_centered_on_owner_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_centered_on_owner(levelp);
...
tree_rootp map_all_things_is_centered_on_owner_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_centered_on_owner(levelp);
