...
uint8_t map_is_item_hidden_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key1_at(levelp, int32_t x, int32_t y);
...
uint8_t map_explode_on_death_at(levelp, int32_t x, int32_t y);
...
uint8_t map_is_item_wearable_at(levelp, int32_t x, int32_t y);
uint8_t map_is_destroyed_on_hitting_at(levelp, int32_t x, int32_t y);
uint8_t map_is_star_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key0_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key1_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key2_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key3_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key4_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key5_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key6_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key7_at(levelp, int32_t x, int32_t y);
uint8_t map_is_key8_at(levelp, int32_t x, int32_t y);
uint8_t map_is_item_unusable_at(levelp, int32_t x, int32_t y);
uint8_t map_is_item_unusable_at(levelp, int32_t x, int32_t y);
uint8_t map_is_shortcut_at(levelp, int32_t x, int32_t y);
...
thing_templatep map_find_is_destroyed_on_hitting_at(levelp, int32_t x, int32_t y, widp *);
...
thing_templatep map_find_is_item_unusable_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_is_shortcut_at(levelp, int32_t x, int32_t y, widp *);
...
thingp map_thing_explode_on_death_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_item_wearable_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_destroyed_on_hitting_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_item_unusable_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_shortcut_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_explode_on_death(levelp);
tree_rootp map_all_things_explode_on_death_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_item_wearable(levelp);
tree_rootp map_all_things_is_item_wearable_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_destroyed_on_hitting(levelp);
tree_rootp map_all_things_is_destroyed_on_hitting_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_item_unusable(levelp);
tree_rootp map_all_things_is_item_unusable_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_shortcut(levelp);
tree_rootp map_all_things_is_shortcut_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_explode_on_death(levelp);
...
uint32_t level_count_is_item_wearable(levelp);
uint32_t level_count_is_destroyed_on_hitting(levelp);
...
uint32_t level_count_is_item_unusable(levelp);
uint32_t level_count_is_shortcut(levelp);
