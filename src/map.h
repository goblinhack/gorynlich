...
uint8_t map_is_rock_at(levelp, int32_t x, int32_t y);
uint8_t map_is_blocks_light_at(levelp, int32_t x, int32_t y);
...
uint8_t map_has_eyes_in_the_darkness_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_rock_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_blocks_light_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_has_eyes_in_the_darkness_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_blocks_light(levelp);
tree_rootp map_all_things_is_blocks_light_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_has_eyes_in_the_darkness(levelp);
tree_rootp map_all_things_has_eyes_in_the_darkness_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_blocks_light(levelp);
...
uint32_t level_count_has_eyes_in_the_darkness(levelp);
