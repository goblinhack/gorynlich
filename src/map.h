...
thing_templatep map_find_rrr13_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_rrr14_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_rrr15_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_rrr16_at(levelp, int32_t x, int32_t y, widp *);
