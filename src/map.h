...
boolean map_is_rock1_at(levelp, int32_t x, int32_t y);
...
thing_templatep map_find_rock1_at(levelp, int32_t x, int32_t y, widp *);
...
thingp map_thing_is_rock1_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_rock1(levelp);
tree_rootp map_all_things_is_rock1_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_rock1(levelp);
