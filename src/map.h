...
uint8_t map_is_gas_cloud_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_animation_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_gas_cloud_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_animation(levelp);
tree_rootp map_all_things_is_animation_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_gas_cloud(levelp);
tree_rootp map_all_things_is_gas_cloud_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_animation(levelp);
uint32_t level_count_is_gas_cloud(levelp);
