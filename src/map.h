...
uint8_t map_is_saw_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_bomb_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_saw_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_bomb(levelp);
tree_rootp map_all_things_is_saw(levelp);
...
tree_rootp map_all_things_is_bomb_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_saw_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_bomb(levelp);
uint32_t level_count_is_saw(levelp);
