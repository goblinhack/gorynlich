...
uint8_t map_is_action_spawn_at(levelp, int32_t x, int32_t y);
...
tpp map_find_action_spawn_at(levelp, int32_t x, int32_t y, widp *);
...
thingp map_thing_is_action_spawn_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_action_spawn(levelp);
...
tree_rootp map_all_things_is_action_spawn_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_action_spawn(levelp);
