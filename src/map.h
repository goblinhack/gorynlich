...
uint8_t map_is_rrr13_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr14_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr15_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr16_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr17_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr18_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr19_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr20_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr21_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr22_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr23_at(levelp, int32_t x, int32_t y);
uint8_t map_is_rrr24_at(levelp, int32_t x, int32_t y);
uint8_t map_is_action_bridge_at(levelp, int32_t x, int32_t y);
...
tpp map_find_seedpod_at(levelp, int32_t x, int32_t y, widp *);
...
tpp map_find_xxx28_at(levelp, int32_t x, int32_t y, widp *);
...
tpp map_find_rrr1_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr2_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr3_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr4_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr5_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr6_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr7_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr8_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr9_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr10_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr11_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr12_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr13_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr14_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr15_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr16_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr17_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr18_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr19_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr20_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr21_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr22_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr23_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_rrr24_at(levelp, int32_t x, int32_t y, widp *);
tpp map_find_action_bridge_at(levelp, int32_t x, int32_t y, widp *);
...
thingp map_thing_is_rrr13_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr14_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr15_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr16_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr17_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr18_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr19_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr20_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr21_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr22_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr23_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_rrr24_at(levelp, int32_t x, int32_t y);
thingp map_thing_is_action_bridge_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_rrr13(levelp);
tree_rootp map_all_things_is_rrr14(levelp);
tree_rootp map_all_things_is_rrr15(levelp);
tree_rootp map_all_things_is_rrr16(levelp);
tree_rootp map_all_things_is_rrr17(levelp);
tree_rootp map_all_things_is_rrr18(levelp);
tree_rootp map_all_things_is_rrr19(levelp);
tree_rootp map_all_things_is_rrr20(levelp);
tree_rootp map_all_things_is_rrr21(levelp);
tree_rootp map_all_things_is_rrr22(levelp);
tree_rootp map_all_things_is_rrr23(levelp);
tree_rootp map_all_things_is_rrr24(levelp);
tree_rootp map_all_things_is_action_bridge(levelp);
...
tree_rootp map_all_things_is_rrr13_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr14_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr15_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr16_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr17_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr18_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr19_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr20_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr21_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr22_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr23_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_rrr24_at(levelp, int32_t x, int32_t y);
tree_rootp map_all_things_is_action_bridge_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_rrr13(levelp);
uint32_t level_count_is_rrr14(levelp);
uint32_t level_count_is_rrr15(levelp);
uint32_t level_count_is_rrr16(levelp);
uint32_t level_count_is_rrr17(levelp);
uint32_t level_count_is_rrr18(levelp);
uint32_t level_count_is_rrr19(levelp);
uint32_t level_count_is_rrr20(levelp);
uint32_t level_count_is_rrr21(levelp);
uint32_t level_count_is_rrr22(levelp);
uint32_t level_count_is_rrr23(levelp);
uint32_t level_count_is_rrr24(levelp);
uint32_t level_count_is_rrr25(levelp);
uint32_t level_count_is_rrr26(levelp);
