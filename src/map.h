...
thing_templatep map_find_given_randomly_at_start_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_magical_at(levelp, int32_t x, int32_t y, widp *);
thing_templatep map_find_degradable_at(levelp, int32_t x, int32_t y, widp *);
