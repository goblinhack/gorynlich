...
uint8_t map_is_killed_on_hitting_player_at(levelp, int32_t x, int32_t y);
...
uint8_t map_is_xxx20_at(levelp, int32_t x, int32_t y);
uint8_t map_is_xxx21_at(levelp, int32_t x, int32_t y);
...
thing_templatep map_find_is_killed_on_hitting_player_at(levelp, int32_t x, int32_t y, widp *);
...
thingp map_thing_is_killed_on_hitting_player_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_killed_on_hitting_player(levelp);
tree_rootp map_all_things_is_killed_on_hitting_player_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_killed_on_hitting_player(levelp);
