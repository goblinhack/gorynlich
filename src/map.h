...
boolean map_is_collision_map_vsmall_at(levelp, int32_t x, int32_t y);
boolean map_is_xxx33_at(levelp, int32_t x, int32_t y);
boolean map_is_key_at(levelp, int32_t x, int32_t y);
boolean map_is_collision_map_small_at(levelp, int32_t x, int32_t y);
...
thingp map_thing_is_collision_map_vsmall_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_collision_map_vsmall(levelp);
tree_rootp map_all_things_is_collision_map_vsmall_at(levelp, int32_t x, int32_t y);
...
tree_rootp map_all_things_is_collision_map_small(levelp);
tree_rootp map_all_things_is_collision_map_small_at(levelp, int32_t x, int32_t y);
...
uint32_t level_count_is_collision_map_vsmall(levelp);
uint32_t level_count_is_xxx33(levelp);
uint32_t level_count_is_key(levelp);
uint32_t level_count_is_collision_map_small(levelp);
