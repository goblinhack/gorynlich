...
boolean map_is_xxx34_at (levelp level, int32_t x, int32_t y)
{
    return (map_is_x_at(level, x, y, thing_template_is_xxx34));
}
...
thingp map_thing_is_xxx34_at (levelp level, int32_t x, int32_t y)
{
    return (map_thing_is_x_at(level, x, y, thing_template_is_xxx34));
}
...
tree_rootp map_all_things_is_xxx34_at (levelp level, int32_t x, int32_t y)
{
    return (map_all_things_is_x_at(level, x, y, thing_template_is_xxx34));
}
...
thing_templatep map_find_is_xxx34_at (levelp level,
                                   int32_t x, int32_t y, widp *w)
{
    return (map_find_x_at(level, x, y, thing_template_is_xxx34, w));
}
...
uint32_t level_count_is_xxx34 (levelp level)
{
    return (level_count_is_x(level, thing_template_is_xxx34));
}
...
tree_rootp map_all_things_is_xxx34 (levelp level)
{
    return (map_all_things_is_x(level, thing_template_is_xxx34));
}
