...
itemp thing_item_collect(thingp thing, thingp item);
itemp thing_item_collect_no_auto_use(thingp thing, thingp item);
boolean thing_item_drop(thingp thing, thingp item, boolean destroy_on_drop,
                        const char *why);
...
boolean thing_item_use(thingp thing, thingp item);
...
tree_rootp *thing_carried_itemsp(thingp);
tree_rootp thing_carried_items(thingp);
tree_rootp *thing_powerup_itemsp(thingp);
tree_rootp *thing_start_itemsp(thingp);
tree_rootp thing_start_items(thingp);
...
void thing_set_item_owner(thingp t, thingp i);
boolean thing_item_steal(thingp owner, thingp thief, thing_template_is_callback loot);
...
int16_t thing_path_cost_is_ladder(thingp t);
...
int16_t thing_path_cost_is_gem_0(thingp t);
int16_t thing_path_cost_is_rock(thingp t);
int16_t thing_path_cost_is_water(thingp t);
int16_t thing_path_cost_is_lava(thingp t);
int16_t thing_path_cost_is_gem_6(thingp t);
int16_t thing_path_cost_is_gem_7(thingp t);
int16_t thing_path_cost_is_boulder(thingp t);
...
int16_t thing_path_cost_is_rock_0(thingp t);
int16_t thing_path_cost_is_car(thingp t);
int16_t thing_path_cost_is_transparent(thingp t);
int16_t thing_path_cost_is_radiant(thingp t);
int16_t thing_path_cost_is_gem_1(thingp t);
int16_t thing_path_cost_is_gem_2(thingp t);
int16_t thing_path_cost_is_explosion(thingp t);
int16_t thing_path_cost_is_spikes(thingp t);
int16_t thing_path_cost_is_gem_4(thingp t);
int16_t thing_path_cost_is_gem_4(thingp t);
int16_t thing_path_cost_is_gem_5(thingp t);
...
int16_t thing_path_cost_is_road(thingp t);
int16_t thing_path_cost_is_pipe(thingp t);
int16_t thing_path_cost_is_item_removed_at_level_end(thingp t);
