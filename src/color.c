...
{
    color_set("alice_blue", &ALICE_BLUE, 240, 248, 255, 255);
    ...
    color_set("antique_white", &ANTIQUE_WHITE, 250, 235, 215, 255);
    ...
    color_set("blanched_almond", &BLANCHED_ALMOND, 255, 235, 205, 255);
    ...
    color_set("blue_violet", &BLUE_VIOLET, 138, 43, 226, 255);
    ...
    color_set("cadet_blue", &CADET_BLUE, 95, 158, 160, 255);
    ...
    color_set("cornflower_blue", &CORNFLOWER_BLUE, 100, 149, 237, 255);
    ...
    color_set("dark_blue", &DARK_BLUE, 0, 0, 139, 255);
    color_set("darkblue", &DARKBLUE, 0, 0, 139, 255);
    color_set("dark_cyan", &DARK_CYAN, 0, 139, 139, 255);
    ...
    color_set("dark_goldenrod", &DARK_GOLDENROD, 184, 134, 11, 255);
    color_set("darkgoldenrod", &DARKGOLDENROD, 184, 134, 11, 255);
    color_set("dark_gray", &DARK_GRAY, 169, 169, 169, 255);
    color_set("darkgray", &DARKGRAY, 169, 169, 169, 255);
    color_set("dark_green", &DARK_GREEN, 0, 100, 0, 255);
    color_set("darkgreen", &DARKGREEN, 0, 100, 0, 255);
    color_set("dark_grey", &DARK_GREY, 169, 169, 169, 255);
    color_set("darkgrey", &DARKGREY, 169, 169, 169, 255);
    color_set("dark_khaki", &DARK_KHAKI, 189, 183, 107, 255);
    color_set("darkkhaki", &DARKKHAKI, 189, 183, 107, 255);
    color_set("dark_magenta", &DARK_MAGENTA, 139, 0, 139, 255);
    ...
    color_set("dark_olive_green", &DARK_OLIVE_GREEN, 85, 107, 47, 255);
    ...
    color_set("dark_orange", &DARK_ORANGE, 255, 140, 0, 255);
    ...
    color_set("dark_orchid", &DARK_ORCHID, 153, 50, 204, 255);
    color_set("darkorchid", &DARKORCHID, 153, 50, 204, 255);
    color_set("dark_red", &DARK_RED, 139, 0, 0, 255);
    color_set("darkred", &DARKRED, 139, 0, 0, 255);
    color_set("dark_salmon", &DARK_SALMON, 233, 150, 122, 255);
    ...
    color_set("dark_sea_green", &DARK_SEA_GREEN, 143, 188, 143, 255);
    color_set("darkseagreen", &DARKSEAGREEN, 143, 188, 143, 255);
    color_set("dark_slate_blue", &DARK_SLATE_BLUE, 72, 61, 139, 255);
    ...
    color_set("dark_slate_gray", &DARK_SLATE_GRAY, 47, 79, 79, 255);
    color_set("darkslategray", &DARKSLATEGRAY, 47, 79, 79, 255);
    color_set("dark_slate_grey", &DARK_SLATE_GREY, 47, 79, 79, 255);
    color_set("darkslategrey", &DARKSLATEGREY, 47, 79, 79, 255);
    color_set("dark_turquoise", &DARK_TURQUOISE, 0, 206, 209, 255);
    color_set("darkturquoise", &DARKTURQUOISE, 0, 206, 209, 255);
    color_set("dark_violet", &DARK_VIOLET, 148, 0, 211, 255);
    ...
    color_set("deep_pink", &DEEP_PINK, 255, 20, 147, 255);
    ...
    color_set("deep_sky_blue", &DEEP_SKY_BLUE, 0, 191, 255, 255);
    color_set("deepskyblue", &DEEPSKYBLUE, 0, 191, 255, 255);
    color_set("dim_gray", &DIM_GRAY, 105, 105, 105, 255);
    color_set("dimgray", &DIMGRAY, 105, 105, 105, 255);
    color_set("dim_grey", &DIM_GREY, 105, 105, 105, 255);
    ...
    color_set("dodger_blue", &DODGER_BLUE, 30, 144, 255, 255);
    ...
    color_set("floral_white", &FLORAL_WHITE, 255, 250, 240, 255);
    color_set("floralwhite", &FLORALWHITE, 255, 250, 240, 255);
    color_set("forest_green", &FOREST_GREEN, 34, 139, 34, 255);
    color_set("forestgreen", &FORESTGREEN, 34, 139, 34, 255);
    color_set("gainsboro", &GAINSBORO, 220, 220, 220, 255);
    color_set("ghost_white", &GHOST_WHITE, 248, 248, 255, 255);
    ...
    color_set("green_yellow", &GREEN_YELLOW, 173, 255, 47, 255);
    ...
    color_set("hot_pink", &HOT_PINK, 255, 105, 180, 255);
    ...
    color_set("indian_red", &INDIAN_RED, 205, 92, 92, 255);
