...
thing_tilep thing_tile_find (thing_templatep t,
            ...
            boolean is_join_t270_3)
{
    ...
    TREE_WALK_UNSAFE(t->tiles, tile) {
        thing_tilep possible;

        possible = 0;

        if (is_join_block) {
            if (tile->is_join_block) {
                possible = tile;
            }
        } else if (is_join_t_1) {
            if (tile->is_join_t_1) {
            ...
            if (tile->is_join_t90_1) {
                possible = tile;
            }
        } else if (is_join_t90_2) {
            if (tile->is_join_t90_2) {
                possible = tile;
            }
        } else if (is_join_t90_3) {
            if (tile->is_join_t90_3) {
                possible = tile;
            }
        } else if (is_join_t180_1) {
            if (tile->is_join_t180_1) {
                possible = tile;
            }
        } else if (is_join_t180_2) {
            if (tile->is_join_t180_2) {
                possible = tile;
            }
        } else if (is_join_t180_3) {
            if (tile->is_join_t180_3) {
                possible = tile;
            }
        } else if (is_join_t270_1) {
            if (tile->is_join_t270_1) {
                possible = tile;
            }
        } else if (is_join_t270_2) {
            if (tile->is_join_t270_2) {
                possible = tile;
            }
        } else if (is_join_t270_3) {
            if (tile->is_join_t270_3) {
                possible = tile;
            }
            ...
            if (tile->is_join_horiz) {
                possible = tile;
            }
        } else if (is_join_vert) {
            if (tile->is_join_vert) {
                possible = tile;
            }
        } else if (is_join_node) {
            if (tile->is_join_node) {
                possible = tile;
            }
        } else if (is_join_left) {
            if (tile->is_join_left) {
                possible = tile;
            }
        } else if (is_join_right) {
            if (tile->is_join_right) {
                possible = tile;
            }
        } else if (is_join_top) {
            if (tile->is_join_top) {
            ...
            if (tile->is_join_t180) {
                possible = tile;
            }
        } else if (is_join_t270) {
            if (tile->is_join_t270) {
                possible = tile;
            }
        } else if (is_join_x) {
            if (tile->is_join_x) {
        ...
        if (possible) {
            if (candidate_cnt < max_candidates) {
                candidates[candidate_cnt++] = possible;
            }
        }
    }

    if (candidate_cnt) {
        return (candidates[rand() % candidate_cnt]);
    }
