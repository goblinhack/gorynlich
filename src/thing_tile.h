...
boolean thing_tile_is_dir_tl(thing_tilep);
boolean thing_tile_is_dir_bl(thing_tilep);
boolean thing_tile_is_dir_tr(thing_tilep);
boolean thing_tile_is_dir_br(thing_tilep);
