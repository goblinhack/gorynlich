...
void demarshal_thing_template (demarshal_p ctx, thing_templatep t)
{
    ...
    do {
        ...
        GET_OPT_NAMED_BITFIELD(ctx, "is_blocks_light", t->is_blocks_light);
        GET_OPT_NAMED_BITFIELD(ctx, "is_blocks_light_soft", t->is_blocks_light_soft);
        ...
        GET_OPT_NAMED_BITFIELD(ctx, "has_eyes_in_the_darkness", t->has_eyes_in_the_darkness);
...
void marshal_thing_template (marshal_p ctx, thing_templatep t)
{
    ...
    PUT_NAMED_BITFIELD(ctx, "is_blocks_light", t->is_blocks_light);
    PUT_NAMED_BITFIELD(ctx, "is_blocks_light_soft", t->is_blocks_light_soft);
    ...
    PUT_NAMED_BITFIELD(ctx, "has_eyes_in_the_darkness", t->has_eyes_in_the_darkness);
