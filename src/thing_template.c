...
void demarshal_thing_template (demarshal_p ctx, tpp t)
{
    ...
    do {
        ...
        GET_OPT_NAMED_BITFIELD(ctx, "is_ability_burst_shot", t->is_ability_burst_shot);
        GET_OPT_NAMED_BITFIELD(ctx, "is_rrr6", t->is_rrr6);
        GET_OPT_NAMED_BITFIELD(ctx, "is_ability_triple_shot", t->is_ability_triple_shot);
        GET_OPT_NAMED_BITFIELD(ctx, "is_ability_double_shot", t->is_ability_double_shot);
        GET_OPT_NAMED_BITFIELD(ctx, "is_ability_reverse_shot", t->is_ability_reverse_shot);
...
void marshal_thing_template (marshal_p ctx, tpp t)
{
    ...
    PUT_NAMED_BITFIELD(ctx, "is_ability_burst_shot", t->is_ability_burst_shot);
    PUT_NAMED_BITFIELD(ctx, "is_rrr6", t->is_rrr6);
    PUT_NAMED_BITFIELD(ctx, "is_ability_triple_shot", t->is_ability_triple_shot);
    PUT_NAMED_BITFIELD(ctx, "is_ability_double_shot", t->is_ability_double_shot);
    PUT_NAMED_BITFIELD(ctx, "is_ability_reverse_shot", t->is_ability_reverse_shot);
