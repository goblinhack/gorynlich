...
boolean wid_get_text_pos(widp, float *x, float *y);
...
float wid_get_bevel(widp);
float wid_get_br_x(widp);
float wid_get_br_y(widp);
float wid_get_height(widp);
void wid_get_mxy(widp w, float *x, float *y);
float wid_get_mode_bevel(widp);
float wid_get_scaling_w(widp);
float wid_get_scaling_h(widp);
float wid_get_rotate(widp);
float wid_get_text_advance(widp);
float wid_get_text_scaling(widp);
float wid_get_tl_x(widp);
float wid_get_tl_y(widp);
float wid_get_width(widp);
...
void wid_get_children_size(widp, float *width, float *height);
void wid_get_offset(widp, fpoint *offset);
void wid_get_tl_br(widp, fpoint *tl, fpoint *br);
void wid_move_end(widp);
void wid_move_delta(widp, float dx, float dy);
void wid_move_to_abs(widp, float dx, float dy);
void wid_move_to_abs_centered(widp, float dx, float dy);
void wid_move_to_abs_centered_in(widp, float dx, float dy, uint32_t delay);
void wid_move_delta_pct_in(widp, float dx, float dy, uint32_t delay);
void wid_move_to_abs_in(widp, float dx, float dy, uint32_t delay);
void wid_move_to_bottom(widp);
void wid_move_to_left(widp);
void wid_move_to_pct(widp, float dx, float dy);
void wid_move_to_pct_centered(widp, float dx, float dy);
void wid_move_to_pct_centered_in(widp, float dx, float dy, uint32_t delay);
void wid_move_to_pct_in(widp, float dx, float dy, uint32_t delay);
void wid_move_to_right(widp);
void wid_move_to_top(widp);
void wid_scale_immediate(widp, float val);
void wid_scale_w_immediate(widp, float val);
void wid_scale_h_immediate(widp, float val);
void wid_scaling_to_pct_in(widp, float start, float end, uint32_t ms, uint32_t bounce_count);
void wid_rotate_to_pct_in(widp, float start, float end, uint32_t ms, uint32_t bounce_count);
void wid_rotate_immediate(widp, float val);
...
void wid_set_bevel(widp, float val);
...
void wid_set_text_advance(widp, float val);
...
void wid_set_text_pos(widp, boolean val, float x, float y);
void wid_set_text_rhs(widp, boolean val);
void wid_set_text_scaling(widp, float val);
